...
; Command line was: -dis C:\wlua_dump\path\Lotus\Types\Sentinels\SentinelAbilities\ShieldVampire.lua 
...
; Max Stack Size:  9
 ...
 42 [-]: GETGLOBAL R7 K5        ; R7 := 0x400E7765
 43 [-]: GETGLOBAL R8 K6        ; R8 := _T
 44 [-]: GETTABLE  R8 R8 R6     ; R8 := R8[R6]
 45 [-]: CALL      R7 2 2       ; R7 := R7(R8)
 46 [-]: TEST      R7 1         ; if R7 then PC := 54
 47 [-]: JMP       54           ; PC := 54
 48 [-]: GETGLOBAL R7 K6        ; R7 := _T
 49 [-]: GETTABLE  R7 R7 R6     ; R7 := R7[R6]
 50 [-]: SELF      R7 R7 K7     ; R8 := R7; R7 := R7["0xD4C2743F"]
 51 [-]: CALL      R7 2 1       ; R7(R8)
 52 [-]: GETGLOBAL R7 K6        ; R7 := _T
 53 [-]: SETTABLE  R7 R6 K8     ; R7[R6] := nil
