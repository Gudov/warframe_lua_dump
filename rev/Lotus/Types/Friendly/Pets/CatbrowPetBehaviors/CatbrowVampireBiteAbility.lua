...
; Command line was: -dis C:\wlua_dump\path\Lotus\Types\Friendly\Pets\CatbrowPetBehaviors\CatbrowVampireBiteAbility.lua 
...
; Max Stack Size:  19
 ...
 58 [-]: TEST      R9 0         ; if not R9 then PC := 125
 59 [-]: JMP       125          ; PC := 125
 ...
 75 [-]: TEST      R9 0         ; if not R9 then PC := 125
 76 [-]: JMP       125          ; PC := 125
 77 [-]: GETGLOBAL R9 K22       ; R9 := dmg
 78 [-]: GETGLOBAL R10 K23      ; R10 := math
 79 [-]: GETTABLE  R10 R10 K24  ; R10 := R10["0x65F9712A"]
 80 [-]: GETGLOBAL R11 K22      ; R11 := dmg
 81 [-]: LEN       R11 R11      ; R11 := # R11
 82 [-]: MOVE      R12 R3       ; R12 := R3
 83 [-]: CALL      R10 3 2      ; R10 := R10(R11,R12)
 84 [-]: GETTABLE  R9 R9 R10    ; R9 := R9[R10]
 85 [-]: GETGLOBAL R10 K19      ; R10 := Engine
 86 [-]: GETTABLE  R10 R10 K25  ; R10 := R10["0xFA1ED226"]
 87 [-]: CALL      R10 1 2      ; R10 := R10()
 88 [-]: SETTABLE  R10 K26 R9   ; R10["baseAmount"] := R9
 89 [-]: SELF      R11 R10 K27  ; R12 := R10; R11 := R10["0xC4A45AF8"]
 90 [-]: GETGLOBAL R13 K19      ; R13 := Engine
 91 [-]: GETTABLE  R13 R13 K28  ; R13 := R13["DT_SLASH"]
 92 [-]: LOADK     R14 K29      ; R14 := 1
 93 [-]: CALL      R11 4 1      ; R11(R12,R13,R14)
 94 [-]: SELF      R11 R10 K30  ; R12 := R10; R11 := R10["0xE6EDB183"]
 95 [-]: MOVE      R13 R1       ; R13 := R1
 96 [-]: CALL      R11 3 1      ; R11(R12,R13)
 97 [-]: SELF      R11 R10 K31  ; R12 := R10; R11 := R10["0x85DAD235"]
 98 [-]: MOVE      R13 R0       ; R13 := R0
 99 [-]: CALL      R11 3 1      ; R11(R12,R13)
100 [-]: SELF      R11 R2 K32   ; R12 := R2; R11 := R2["0x4722B671"]
101 [-]: MOVE      R13 R10      ; R13 := R10
102 [-]: CALL      R11 3 1      ; R11(R12,R13)
103 [-]: SELF      R11 R1 K33   ; R12 := R1; R11 := R1["0x5A115A02"]
104 [-]: CALL      R11 2 2      ; R11 := R11(R12)
105 [-]: TEST      R11 1        ; if R11 then PC := 125
106 [-]: JMP       125          ; PC := 125
107 [-]: SELF      R11 R1 K34   ; R12 := R1; R11 := R1["0xA56CD0BB"]
108 [-]: CALL      R11 2 2      ; R11 := R11(R12)
109 [-]: TEST      R11 1        ; if R11 then PC := 125
110 [-]: JMP       125          ; PC := 125
111 [-]: SELF      R11 R1 K35   ; R12 := R1; R11 := R1["0xD53BF424"]
112 [-]: MOVE      R13 R1       ; R13 := R1
113 [-]: SELF      R14 R1 K36   ; R15 := R1; R14 := R1["0x385BD2FE"]
114 [-]: CALL      R14 2 2      ; R14 := R14(R15)
115 [-]: GETGLOBAL R15 K37      ; R15 := healPct
116 [-]: GETGLOBAL R16 K23      ; R16 := math
117 [-]: GETTABLE  R16 R16 K24  ; R16 := R16["0x65F9712A"]
118 [-]: GETGLOBAL R17 K37      ; R17 := healPct
