...
; Command line was: -dis C:\wlua_dump\path\Lotus\Interface\VignetteConsole.lua 
...
; Max Stack Size:  19
 ...
 12 [-]: EQ        1 R3 R4      ; if R3 == R4 then PC := 32
 13 [-]: JMP       32           ; PC := 32
 ...
 33 [-]: GETTABLE  R3 R3 K11    ; R3 := R3["Vignette"]
 34 [-]: GETUPVAL  R4 U2        ; R4 := U2
 35 [-]: GETTABLE  R4 R4 K12    ; R4 := R4["mVignette"]
 36 [-]: EQ        1 R3 R4      ; if R3 == R4 then PC := 54
 37 [-]: JMP       54           ; PC := 54
 38 [-]: GETUPVAL  R3 U3        ; R3 := U3
 39 [-]: SETTABLE  R3 K13 K5    ; R3["ResetVignette"] := "0x1"
 40 [-]: GETGLOBAL R3 K6        ; R3 := 0x400E7765
 41 [-]: GETUPVAL  R4 U2        ; R4 := U2
 42 [-]: GETTABLE  R4 R4 K12    ; R4 := R4["mVignette"]
 43 [-]: CALL      R3 2 2       ; R3 := R3(R4)
 44 [-]: TEST      R3 1         ; if R3 then PC := 54
 45 [-]: JMP       54           ; PC := 54
 46 [-]: GETGLOBAL R3 K7        ; R3 := table
 47 [-]: GETTABLE  R3 R3 K8     ; R3 := R3["0xE6450C9D"]
 48 [-]: MOVE      R4 R2        ; R4 := R2
 49 [-]: GETUPVAL  R5 U2        ; R5 := U2
 50 [-]: GETTABLE  R5 R5 K12    ; R5 := R5["mVignette"]
 51 [-]: SELF      R5 R5 K14    ; R6 := R5; R5 := R5["0x1B252E3C"]
 52 [-]: CALL      R5 2 0       ; R5,... := R5(R6)
 53 [-]: CALL      R3 0 1       ; R3(R4,...)
 54 [-]: MOVE      R3 R0        ; R3 := R0
 55 [-]: GETUPVAL  R4 U5        ; R4 := U5
 56 [-]: GETUPVAL  R5 U6        ; R5 := U6
 57 [-]: MUL       R4 R4 R5     ; R4 := R4 * R5
 58 [-]: LOADK     R5 K15       ; R5 := 1
 59 [-]: MOVE      R6 R4        ; R6 := R4
 60 [-]: LOADK     R7 K15       ; R7 := 1
 61 [-]: FORPREP   R5 71        ; R5 -= R7; PC := 71
 62 [-]: GETUPVAL  R9 U7        ; R9 := U7
 63 [-]: GETTABLE  R9 R9 R8     ; R9 := R9[R8]
 64 [-]: GETUPVAL  R10 U8       ; R10 := U8
 65 [-]: GETTABLE  R10 R10 K16  ; R10 := R10["Fishes"]
 66 [-]: GETTABLE  R10 R10 R8   ; R10 := R10[R8]
 67 [-]: EQ        1 R9 R10     ; if R9 == R10 then PC := 71
 68 [-]: JMP       71           ; PC := 71
 69 [-]: MOVE      R3 R1        ; R3 := R1
 70 [-]: JMP       72           ; PC := 72
 71 [-]: FORLOOP   R5 62        ; R5 += R7; if R5 <= R6 then begin PC := 62; R8 := R5 end
 72 [-]: GETUPVAL  R9 U3        ; R9 := U3
 73 [-]: SETTABLE  R9 K17 R3    ; R9["ResetFish"] := R3
 74 [-]: TEST      R3 0         ; if not R3 then PC := 103
 75 [-]: JMP       103          ; PC := 103
 76 [-]: LOADK     R9 K15       ; R9 := 1
 77 [-]: GETUPVAL  R10 U7       ; R10 := U7
 78 [-]: LEN       R10 R10      ; R10 := # R10
 79 [-]: LOADK     R11 K15      ; R11 := 1
 80 [-]: FORPREP   R9 102       ; R9 -= R11; PC := 102
 81 [-]: GETUPVAL  R13 U7       ; R13 := U7
 82 [-]: GETTABLE  R13 R13 R12  ; R13 := R13[R12]
 83 [-]: EQ        1 R13 K18    ; if R13 == "" then PC := 102
 84 [-]: JMP       102          ; PC := 102
 85 [-]: GETUPVAL  R13 U9       ; R13 := U9
 86 [-]: GETTABLE  R13 R13 K19  ; R13 := R13["0x2AA39D4A"]
 87 [-]: GETUPVAL  R14 U7       ; R14 := U7
 88 [-]: GETTABLE  R14 R14 R12  ; R14 := R14[R12]
 89 [-]: GETGLOBAL R15 K20      ; R15 := fishInfoManifest
 ...
 95 [-]: JMP       102          ; PC := 102
 96 [-]: GETGLOBAL R14 K7       ; R14 := table
 97 [-]: GETTABLE  R14 R14 K8   ; R14 := R14["0xE6450C9D"]
 98 [-]: MOVE      R15 R2       ; R15 := R2
 99 [-]: SELF      R16 R13 K14  ; R17 := R13; R16 := R13["0x1B252E3C"]
100 [-]: CALL      R16 2 0      ; R16,... := R16(R17)
101 [-]: CALL      R14 0 1      ; R14(R15,...)
102 [-]: FORLOOP   R9 81        ; R9 += R11; if R9 <= R10 then begin PC := 81; R12 := R9 end
103 [-]: LEN       R14 R2       ; R14 := # R2
104 [-]: LT        0 K21 R14    ; if 0 >= R14 then PC := 143
105 [-]: JMP       143          ; PC := 143
106 [-]: GETUPVAL  R14 U3       ; R14 := U3
107 [-]: GETGLOBAL R15 K23      ; R15 := UISys
108 [-]: GETTABLE  R15 R15 K24  ; R15 := R15["0x449B53E0"]
109 [-]: MOVE      R16 R2       ; R16 := R2
110 [-]: CALL      R15 2 2      ; R15 := R15(R16)
111 [-]: SETTABLE  R14 K22 R15  ; R14["Loader"] := R15
112 [-]: GETUPVAL  R14 U3       ; R14 := U3
113 [-]: SETTABLE  R14 K25 K5   ; R14["IsLoading"] := "0x1"
114 [-]: GETUPVAL  R14 U10      ; R14 := U10
115 [-]: SELF      R14 R14 K26  ; R15 := R14; R14 := R14["0xE2A2E3AC"]
...
121 [-]: JMP       143          ; PC := 143
122 [-]: GETGLOBAL R14 K27      ; R14 := string
123 [-]: GETTABLE  R14 R14 K28  ; R14 := R14["0xDE44F664"]
124 [-]: MOVE      R15 R1       ; R15 := R1
125 [-]: LOADK     R16 K29      ; R16 := "RemovedDecos"
126 [-]: CALL      R14 3 2      ; R14 := R14(R15,R16)
127 [-]: EQ        1 R14 K30    ; if R14 == nil then PC := 143
128 [-]: JMP       143          ; PC := 143
...
133 [-]: TEST      R14 1        ; if R14 then PC := 143
134 [-]: JMP       143          ; PC := 143
135 [-]: GETGLOBAL R14 K31      ; R14 := _T
136 [-]: GETTABLE  R14 R14 K32  ; R14 := R14["BackgroundMovie"]
137 [-]: SELF      R14 R14 K33  ; R15 := R14; R14 := R14["0xB9C96BA0"]
138 [-]: LOADK     R16 K34      ; R16 := "RefreshShipDecos"
139 [-]: NEWTABLE  R17 1 0      ; R17 := {}
140 [-]: MOVE      R18 R1       ; R18 := R1
141 [-]: SETLIST   R17 1 1      ; R17[(1-1)*FPF+i] := R(17+i), 1 <= i <= 1
...
146 [-]: TEST      R6 0         ; if not R6 then PC := 199
147 [-]: JMP       199          ; PC := 199
...
192 [-]: TEST      R8 0         ; if not R8 then PC := 199
193 [-]: JMP       199          ; PC := 199
