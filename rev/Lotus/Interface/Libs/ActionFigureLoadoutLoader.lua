...
; Command line was: -dis C:\wlua_dump\path\Lotus\Interface\Libs\ActionFigureLoadoutLoader.lua 
...
; Max Stack Size:  13
 ...
 38 [-]: EQ        0 R1 K3      ; if R1 ~= 0 then PC := 253
 39 [-]: JMP       253          ; PC := 253
...
148 [-]: TEST      R2 1         ; if R2 then PC := 253
149 [-]: JMP       253          ; PC := 253
150 [-]: GETTABLE  R2 R0 K23    ; R2 := R0["mPendingLoadOuts"]
151 [-]: LEN       R2 R2        ; R2 := # R2
152 [-]: EQ        1 R2 K3      ; if R2 == 0 then PC := 253
153 [-]: JMP       253          ; PC := 253
154 [-]: GETGLOBAL R2 K34       ; R2 := gGameData
155 [-]: TEST      R2 0         ; if not R2 then PC := 253
156 [-]: JMP       253          ; PC := 253
157 [-]: GETTABLE  R2 R0 K24    ; R2 := R0["mPendingActionFigures"]
158 [-]: LEN       R2 R2        ; R2 := # R2
159 [-]: EQ        0 R2 K3      ; if R2 ~= 0 then PC := 166
160 [-]: JMP       166          ; PC := 166
161 [-]: GETGLOBAL R2 K35       ; R2 := table
162 [-]: GETTABLE  R2 R2 K36    ; R2 := R2["0xCDB1FD5E"]
163 [-]: GETTABLE  R3 R0 K23    ; R3 := R0["mPendingLoadOuts"]
164 [-]: CALL      R2 2 1       ; R2(R3)
165 [-]: JMP       253          ; PC := 253
166 [-]: GETUPVAL  R2 U2        ; R2 := U2
167 [-]: MOVE      R3 R0        ; R3 := R0
168 [-]: GETTABLE  R4 R0 K23    ; R4 := R0["mPendingLoadOuts"]
169 [-]: GETTABLE  R5 R0 K23    ; R5 := R0["mPendingLoadOuts"]
170 [-]: LEN       R5 R5        ; R5 := # R5
171 [-]: GETTABLE  R4 R4 R5     ; R4 := R4[R5]
172 [-]: CALL      R2 3 2       ; R2 := R2(R3,R4)
173 [-]: TEST      R2 1         ; if R2 then PC := 180
174 [-]: JMP       180          ; PC := 180
175 [-]: GETGLOBAL R2 K35       ; R2 := table
176 [-]: GETTABLE  R2 R2 K36    ; R2 := R2["0xCDB1FD5E"]
177 [-]: GETTABLE  R3 R0 K23    ; R3 := R0["mPendingLoadOuts"]
178 [-]: CALL      R2 2 1       ; R2(R3)
179 [-]: RETURN    R0 1         ; return 
180 [-]: GETTABLE  R2 R0 K37    ; R2 := R0["mCurrentLoadOutId"]
181 [-]: EQ        1 R2 K38     ; if R2 == "" then PC := 206
182 [-]: JMP       206          ; PC := 206
183 [-]: GETGLOBAL R2 K4        ; R2 := 0x400E7765
184 [-]: GETTABLE  R3 R0 K5     ; R3 := R0["mPreviewAvatar"]
185 [-]: CALL      R2 2 2       ; R2 := R2(R3)
186 [-]: TEST      R2 1         ; if R2 then PC := 206
187 [-]: JMP       206          ; PC := 206
188 [-]: GETTABLE  R2 R0 K5     ; R2 := R0["mPreviewAvatar"]
189 [-]: SELF      R2 R2 K6     ; R3 := R2; R2 := R2["0x8DB5D01F"]
190 [-]: CALL      R2 2 2       ; R2 := R2(R3)
191 [-]: SELF      R3 R2 K39    ; R4 := R2; R3 := R2["0x50C6C426"]
192 [-]: GETGLOBAL R5 K8        ; R5 := Engine
193 [-]: GETTABLE  R5 R5 K40    ; R5 := R5["SLOT_1"]
194 [-]: MOVE      R6 R1        ; R6 := R1
195 [-]: CALL      R3 4 1       ; R3(R4,R5,R6)
196 [-]: SELF      R3 R2 K39    ; R4 := R2; R3 := R2["0x50C6C426"]
197 [-]: GETGLOBAL R5 K8        ; R5 := Engine
198 [-]: GETTABLE  R5 R5 K41    ; R5 := R5["SLOT_2"]
199 [-]: MOVE      R6 R1        ; R6 := R1
200 [-]: CALL      R3 4 1       ; R3(R4,R5,R6)
201 [-]: SELF      R3 R2 K39    ; R4 := R2; R3 := R2["0x50C6C426"]
202 [-]: GETGLOBAL R5 K8        ; R5 := Engine
203 [-]: GETTABLE  R5 R5 K42    ; R5 := R5["SLOT_6"]
204 [-]: MOVE      R6 R1        ; R6 := R1
205 [-]: CALL      R3 4 1       ; R3(R4,R5,R6)
206 [-]: GETGLOBAL R3 K44       ; R3 := Lotus_Game
207 [-]: GETTABLE  R3 R3 K45    ; R3 := R3["SUIT_SLOT"]
208 [-]: SETTABLE  R0 K43 R3    ; R0["mLastEquipSlot"] := R3
209 [-]: GETGLOBAL R3 K46       ; R3 := gRegion
210 [-]: SELF      R3 R3 K47    ; R4 := R3; R3 := R3["0xA559F558"]
211 [-]: CALL      R3 2 2       ; R3 := R3(R4)
212 [-]: MOVE      R3 R3        ; R3 := R3
213 [-]: GETTABLE  R4 R0 K20    ; R4 := R0["mLoadOut"]
214 [-]: GETGLOBAL R5 K34       ; R5 := gGameData
215 [-]: SELF      R5 R5 K49    ; R6 := R5; R5 := R5["0x30BDE7F"]
216 [-]: CALL      R5 2 2       ; R5 := R5(R6)
217 [-]: GETTABLE  R5 R5 K48    ; R5 := R5["mOperatorCustomization"]
218 [-]: SETTABLE  R4 K48 R5    ; R4["mOperatorCustomization"] := R5
219 [-]: GETGLOBAL R4 K34       ; R4 := gGameData
220 [-]: SELF      R4 R4 K50    ; R5 := R4; R4 := R4["0xD3B1FF70"]
221 [-]: GETTABLE  R6 R0 K20    ; R6 := R0["mLoadOut"]
222 [-]: GETGLOBAL R7 K44       ; R7 := Lotus_Game
223 [-]: GETTABLE  R7 R7 K51    ; R7 := R7["LOT_NORMAL"]
224 [-]: GETTABLE  R8 R0 K23    ; R8 := R0["mPendingLoadOuts"]
225 [-]: GETTABLE  R9 R0 K23    ; R9 := R0["mPendingLoadOuts"]
226 [-]: LEN       R9 R9        ; R9 := # R9
227 [-]: GETTABLE  R8 R8 R9     ; R8 := R8[R9]
228 [-]: MOVE      R9 R3        ; R9 := R3
229 [-]: CALL      R4 6 1       ; R4(R5,R6,R7,R8,R9)
230 [-]: GETTABLE  R4 R0 K23    ; R4 := R0["mPendingLoadOuts"]
231 [-]: GETTABLE  R5 R0 K23    ; R5 := R0["mPendingLoadOuts"]
232 [-]: LEN       R5 R5        ; R5 := # R5
233 [-]: GETTABLE  R4 R4 R5     ; R4 := R4[R5]
234 [-]: GETTABLE  R4 R4 K52    ; R4 := R4["mItemId"]
235 [-]: GETTABLE  R4 R4 K53    ; R4 := R4["mId"]
236 [-]: SETTABLE  R0 K37 R4    ; R0["mCurrentLoadOutId"] := R4
237 [-]: GETTABLE  R4 R0 K1     ; R4 := R0["mLoadOutLoader"]
238 [-]: GETGLOBAL R5 K34       ; R5 := gGameData
239 [-]: SELF      R5 R5 K54    ; R6 := R5; R5 := R5["0x65CD7C82"]
240 [-]: CALL      R5 2 2       ; R5 := R5(R6)
241 [-]: SETTABLE  R4 K16 R5    ; R4["Loader"] := R5
242 [-]: GETTABLE  R4 R0 K1     ; R4 := R0["mLoadOutLoader"]
243 [-]: SETTABLE  R4 K15 K55   ; R4["IsLoading"] := "0x1"
244 [-]: GETGLOBAL R4 K4        ; R4 := 0x400E7765
245 [-]: GETTABLE  R5 R0 K13    ; R5 := R0["mSpinner"]
246 [-]: CALL      R4 2 2       ; R4 := R4(R5)
247 [-]: TEST      R4 1         ; if R4 then PC := 253
248 [-]: JMP       253          ; PC := 253
249 [-]: GETTABLE  R4 R0 K13    ; R4 := R0["mSpinner"]
250 [-]: SELF      R4 R4 K14    ; R5 := R4; R4 := R4["0xE2A2E3AC"]
251 [-]: MOVE      R6 R1        ; R6 := R1
252 [-]: CALL      R4 3 1       ; R4(R5,R6)
253 [-]: GETTABLE  R4 R0 K28    ; R4 := R0["mEnemyLoader"]
254 [-]: GETTABLE  R4 R4 K56    ; R4 := R4["AvatarCopyPending"]
255 [-]: LT        0 K3 R4      ; if 0 >= R4 then PC := 287
256 [-]: JMP       287          ; PC := 287
257 [-]: GETTABLE  R4 R0 K28    ; R4 := R0["mEnemyLoader"]
258 [-]: GETTABLE  R5 R0 K28    ; R5 := R0["mEnemyLoader"]
259 [-]: GETTABLE  R5 R5 K56    ; R5 := R5["AvatarCopyPending"]
260 [-]: SUB       R5 R5 K11    ; R5 := R5 - 1
261 [-]: SETTABLE  R4 K56 R5    ; R4["AvatarCopyPending"] := R5
262 [-]: GETTABLE  R4 R0 K28    ; R4 := R0["mEnemyLoader"]
263 [-]: GETTABLE  R4 R4 K56    ; R4 := R4["AvatarCopyPending"]
264 [-]: EQ        0 R4 K3      ; if R4 ~= 0 then PC := 460
265 [-]: JMP       460          ; PC := 460
266 [-]: GETUPVAL  R4 U3        ; R4 := U3
267 [-]: MOVE      R5 R0        ; R5 := R0
268 [-]: CALL      R4 2 1       ; R4(R5)
269 [-]: GETTABLE  R4 R0 K28    ; R4 := R0["mEnemyLoader"]
270 [-]: GETTABLE  R4 R4 K16    ; R4 := R4["Loader"]
271 [-]: SELF      R4 R4 K57    ; R5 := R4; R4 := R4["0x703514BD"]
272 [-]: CALL      R4 2 1       ; R4(R5)
273 [-]: GETTABLE  R4 R0 K28    ; R4 := R0["mEnemyLoader"]
274 [-]: SETTABLE  R4 K16 K27   ; R4["Loader"] := nil
275 [-]: GETTABLE  R4 R0 K28    ; R4 := R0["mEnemyLoader"]
276 [-]: SETTABLE  R4 K15 K18   ; R4["IsLoading"] := "0x0"
277 [-]: GETGLOBAL R4 K4        ; R4 := 0x400E7765
278 [-]: GETTABLE  R5 R0 K13    ; R5 := R0["mSpinner"]
279 [-]: CALL      R4 2 2       ; R4 := R4(R5)
280 [-]: TEST      R4 1         ; if R4 then PC := 460
281 [-]: JMP       460          ; PC := 460
282 [-]: GETTABLE  R4 R0 K13    ; R4 := R0["mSpinner"]
283 [-]: SELF      R4 R4 K14    ; R5 := R4; R4 := R4["0xE2A2E3AC"]
284 [-]: MOVE      R6 R0        ; R6 := R0
285 [-]: CALL      R4 3 1       ; R4(R5,R6)
286 [-]: JMP       460          ; PC := 460
287 [-]: GETGLOBAL R4 K4        ; R4 := 0x400E7765
288 [-]: GETTABLE  R5 R0 K28    ; R5 := R0["mEnemyLoader"]
289 [-]: GETTABLE  R5 R5 K16    ; R5 := R5["Loader"]
290 [-]: CALL      R4 2 2       ; R4 := R4(R5)
291 [-]: TEST      R4 0         ; if not R4 then PC := 306
292 [-]: JMP       306          ; PC := 306
293 [-]: GETTABLE  R4 R0 K26    ; R4 := R0["mPendingEnemyTypes"]
294 [-]: LEN       R4 R4        ; R4 := # R4
295 [-]: EQ        0 R4 K3      ; if R4 ~= 0 then PC := 306
296 [-]: JMP       306          ; PC := 306
297 [-]: GETTABLE  R4 R0 K25    ; R4 := R0["mPendingEnemyFigures"]
298 [-]: LEN       R4 R4        ; R4 := # R4
299 [-]: EQ        1 R4 K3      ; if R4 == 0 then PC := 306
300 [-]: JMP       306          ; PC := 306
301 [-]: GETUPVAL  R4 U1        ; R4 := U1
302 [-]: MOVE      R5 R0        ; R5 := R0
303 [-]: GETTABLE  R6 R0 K25    ; R6 := R0["mPendingEnemyFigures"]
304 [-]: CALL      R4 3 1       ; R4(R5,R6)
305 [-]: JMP       460          ; PC := 460
306 [-]: GETTABLE  R4 R0 K26    ; R4 := R0["mPendingEnemyTypes"]
307 [-]: LEN       R4 R4        ; R4 := # R4
308 [-]: EQ        1 R4 K3      ; if R4 == 0 then PC := 374
309 [-]: JMP       374          ; PC := 374
310 [-]: GETGLOBAL R4 K4        ; R4 := 0x400E7765
311 [-]: GETTABLE  R5 R0 K28    ; R5 := R0["mEnemyLoader"]
312 [-]: GETTABLE  R5 R5 K16    ; R5 := R5["Loader"]
313 [-]: CALL      R4 2 2       ; R4 := R4(R5)
314 [-]: TEST      R4 0         ; if not R4 then PC := 374
315 [-]: JMP       374          ; PC := 374
316 [-]: NEWTABLE  R4 0 0       ; R4 := {}
317 [-]: GETTABLE  R5 R0 K26    ; R5 := R0["mPendingEnemyTypes"]
318 [-]: GETTABLE  R5 R5 K11    ; R5 := R5[1]
319 [-]: SELF      R5 R5 K58    ; R6 := R5; R5 := R5["0x1B252E3C"]
320 [-]: CALL      R5 2 0       ; R5,... := R5(R6)
321 [-]: SETLIST   R4 0 1       ; R4[(1-1)*FPF+i] := R(4+i), 1 <= i <= 0
322 [-]: GETGLOBAL R5 K4        ; R5 := 0x400E7765
323 [-]: GETTABLE  R6 R0 K59    ; R6 := R0["mCodexManifest"]
324 [-]: CALL      R5 2 2       ; R5 := R5(R6)
325 [-]: TEST      R5 0         ; if not R5 then PC := 331
326 [-]: JMP       331          ; PC := 331
327 [-]: GETGLOBAL R5 K60       ; R5 := 0x7C282057
328 [-]: GETTABLE  R6 R0 K61    ; R6 := R0["mCodexManifestType"]
329 [-]: CALL      R5 2 2       ; R5 := R5(R6)
330 [-]: SETTABLE  R0 K59 R5    ; R0["mCodexManifest"] := R5
331 [-]: GETTABLE  R5 R0 K59    ; R5 := R0["mCodexManifest"]
332 [-]: SELF      R5 R5 K62    ; R6 := R5; R5 := R5["0x4145EAE4"]
333 [-]: GETTABLE  R7 R0 K26    ; R7 := R0["mPendingEnemyTypes"]
334 [-]: GETTABLE  R7 R7 K11    ; R7 := R7[1]
335 [-]: CALL      R5 3 2       ; R5 := R5(R6,R7)
336 [-]: GETGLOBAL R6 K4        ; R6 := 0x400E7765
337 [-]: MOVE      R7 R5        ; R7 := R5
338 [-]: CALL      R6 2 2       ; R6 := R6(R7)
339 [-]: TEST      R6 1         ; if R6 then PC := 356
340 [-]: JMP       356          ; PC := 356
341 [-]: GETGLOBAL R6 K4        ; R6 := 0x400E7765
342 [-]: GETTABLE  R7 R5 K63    ; R7 := R5["equipType"]
343 [-]: CALL      R6 2 2       ; R6 := R6(R7)
344 [-]: TEST      R6 1         ; if R6 then PC := 353
345 [-]: JMP       353          ; PC := 353
346 [-]: GETGLOBAL R6 K35       ; R6 := table
347 [-]: GETTABLE  R6 R6 K64    ; R6 := R6["0xE6450C9D"]
348 [-]: MOVE      R7 R4        ; R7 := R4
349 [-]: GETTABLE  R8 R5 K63    ; R8 := R5["equipType"]
350 [-]: SELF      R8 R8 K58    ; R9 := R8; R8 := R8["0x1B252E3C"]
351 [-]: CALL      R8 2 0       ; R8,... := R8(R9)
352 [-]: CALL      R6 0 1       ; R6(R7,...)
353 [-]: GETTABLE  R6 R0 K28    ; R6 := R0["mEnemyLoader"]
354 [-]: GETTABLE  R7 R5 K63    ; R7 := R5["equipType"]
355 [-]: SETTABLE  R6 K65 R7    ; R6["Weapon"] := R7
356 [-]: GETTABLE  R6 R0 K28    ; R6 := R0["mEnemyLoader"]
357 [-]: GETGLOBAL R7 K66       ; R7 := UISys
358 [-]: GETTABLE  R7 R7 K67    ; R7 := R7["0x449B53E0"]
359 [-]: MOVE      R8 R4        ; R8 := R4
360 [-]: CALL      R7 2 2       ; R7 := R7(R8)
361 [-]: SETTABLE  R6 K16 R7    ; R6["Loader"] := R7
362 [-]: GETTABLE  R6 R0 K28    ; R6 := R0["mEnemyLoader"]
363 [-]: SETTABLE  R6 K15 K55   ; R6["IsLoading"] := "0x1"
364 [-]: GETGLOBAL R6 K4        ; R6 := 0x400E7765
365 [-]: GETTABLE  R7 R0 K13    ; R7 := R0["mSpinner"]
366 [-]: CALL      R6 2 2       ; R6 := R6(R7)
367 [-]: TEST      R6 1         ; if R6 then PC := 460
368 [-]: JMP       460          ; PC := 460
369 [-]: GETTABLE  R6 R0 K13    ; R6 := R0["mSpinner"]
370 [-]: SELF      R6 R6 K14    ; R7 := R6; R6 := R6["0xE2A2E3AC"]
371 [-]: MOVE      R8 R1        ; R8 := R1
372 [-]: CALL      R6 3 1       ; R6(R7,R8)
373 [-]: JMP       460          ; PC := 460
374 [-]: GETTABLE  R6 R0 K28    ; R6 := R0["mEnemyLoader"]
375 [-]: GETTABLE  R6 R6 K15    ; R6 := R6["IsLoading"]
376 [-]: TEST      R6 0         ; if not R6 then PC := 460
377 [-]: JMP       460          ; PC := 460
378 [-]: GETGLOBAL R6 K4        ; R6 := 0x400E7765
379 [-]: GETTABLE  R7 R0 K28    ; R7 := R0["mEnemyLoader"]
380 [-]: GETTABLE  R7 R7 K16    ; R7 := R7["Loader"]
381 [-]: CALL      R6 2 2       ; R6 := R6(R7)
382 [-]: TEST      R6 1         ; if R6 then PC := 460
383 [-]: JMP       460          ; PC := 460
384 [-]: GETTABLE  R6 R0 K28    ; R6 := R0["mEnemyLoader"]
385 [-]: GETTABLE  R6 R6 K16    ; R6 := R6["Loader"]
386 [-]: SELF      R6 R6 K17    ; R7 := R6; R6 := R6["0xAFDDC504"]
387 [-]: CALL      R6 2 2       ; R6 := R6(R7)
388 [-]: TEST      R6 0         ; if not R6 then PC := 460
389 [-]: JMP       460          ; PC := 460
390 [-]: GETGLOBAL R6 K4        ; R6 := 0x400E7765
391 [-]: GETTABLE  R7 R0 K28    ; R7 := R0["mEnemyLoader"]
392 [-]: GETTABLE  R7 R7 K29    ; R7 := R7["Avatar"]
393 [-]: CALL      R6 2 2       ; R6 := R6(R7)
394 [-]: TEST      R6 1         ; if R6 then PC := 400
395 [-]: JMP       400          ; PC := 400
396 [-]: GETTABLE  R6 R0 K28    ; R6 := R0["mEnemyLoader"]
397 [-]: GETTABLE  R6 R6 K29    ; R6 := R6["Avatar"]
398 [-]: SELF      R6 R6 K30    ; R7 := R6; R6 := R6["0xD4C2743F"]
399 [-]: CALL      R6 2 1       ; R6(R7)
400 [-]: GETGLOBAL R6 K46       ; R6 := gRegion
401 [-]: SELF      R6 R6 K68    ; R7 := R6; R6 := R6["0x3E2F6BF"]
402 [-]: CALL      R6 2 2       ; R6 := R6(R7)
403 [-]: GETGLOBAL R7 K31       ; R7 := _T
404 [-]: SETTABLE  R7 K32 K11   ; R7["AvatarRandomizerOverrideIndex"] := 1
405 [-]: GETTABLE  R7 R0 K28    ; R7 := R0["mEnemyLoader"]
406 [-]: GETUPVAL  R8 U4        ; R8 := U4
407 [-]: GETGLOBAL R9 K69       ; R9 := 0xCAA43ABB
408 [-]: GETTABLE  R10 R0 K26   ; R10 := R0["mPendingEnemyTypes"]
409 [-]: GETTABLE  R10 R10 K11  ; R10 := R10[1]
410 [-]: CALL      R9 2 2       ; R9 := R9(R10)
411 [-]: MOVE      R10 R6       ; R10 := R6
412 [-]: MOVE      R11 R0       ; R11 := R0
413 [-]: CALL      R8 4 2       ; R8 := R8(R9,R10,R11)
414 [-]: SETTABLE  R7 K29 R8    ; R7["Avatar"] := R8
415 [-]: GETGLOBAL R7 K4        ; R7 := 0x400E7765
416 [-]: GETTABLE  R8 R0 K28    ; R8 := R0["mEnemyLoader"]
417 [-]: GETTABLE  R8 R8 K29    ; R8 := R8["Avatar"]
418 [-]: CALL      R7 2 2       ; R7 := R7(R8)
419 [-]: TEST      R7 1         ; if R7 then PC := 460
420 [-]: JMP       460          ; PC := 460
421 [-]: GETGLOBAL R7 K4        ; R7 := 0x400E7765
422 [-]: GETTABLE  R8 R0 K28    ; R8 := R0["mEnemyLoader"]
423 [-]: GETTABLE  R8 R8 K65    ; R8 := R8["Weapon"]
424 [-]: CALL      R7 2 2       ; R7 := R7(R8)
425 [-]: TEST      R7 1         ; if R7 then PC := 458
426 [-]: JMP       458          ; PC := 458
427 [-]: GETTABLE  R7 R0 K28    ; R7 := R0["mEnemyLoader"]
428 [-]: GETTABLE  R7 R7 K29    ; R7 := R7["Avatar"]
429 [-]: SELF      R7 R7 K70    ; R8 := R7; R7 := R7["0x58347F07"]
430 [-]: GETGLOBAL R9 K69       ; R9 := 0xCAA43ABB
431 [-]: GETTABLE  R10 R0 K28   ; R10 := R0["mEnemyLoader"]
432 [-]: GETTABLE  R10 R10 K65  ; R10 := R10["Weapon"]
433 [-]: CALL      R9 2 2       ; R9 := R9(R10)
434 [-]: MOVE      R10 R0       ; R10 := R0
435 [-]: CALL      R7 4 2       ; R7 := R7(R8,R9,R10)
436 [-]: GETGLOBAL R8 K4        ; R8 := 0x400E7765
437 [-]: MOVE      R9 R7        ; R9 := R7
438 [-]: CALL      R8 2 2       ; R8 := R8(R9)
439 [-]: TEST      R8 1         ; if R8 then PC := 458
440 [-]: JMP       458          ; PC := 458
441 [-]: GETTABLE  R8 R0 K28    ; R8 := R0["mEnemyLoader"]
442 [-]: GETTABLE  R8 R8 K29    ; R8 := R8["Avatar"]
443 [-]: SELF      R8 R8 K6     ; R9 := R8; R8 := R8["0x8DB5D01F"]
444 [-]: CALL      R8 2 2       ; R8 := R8(R9)
445 [-]: SELF      R8 R8 K71    ; R9 := R8; R8 := R8["0x290DDD35"]
446 [-]: SELF      R10 R7 K72   ; R11 := R7; R10 := R7["0x35CC2E54"]
447 [-]: CALL      R10 2 2      ; R10 := R10(R11)
448 [-]: GETGLOBAL R11 K8       ; R11 := Engine
449 [-]: GETTABLE  R11 R11 K9   ; R11 := R11["MAIN_HAND"]
450 [-]: GETGLOBAL R12 K8       ; R12 := Engine
451 [-]: GETTABLE  R12 R12 K73  ; R12 := R12["InventoryControllerBase_ES_INSTANT_EQUIP"]
452 [-]: CALL      R8 5 2       ; R8 := R8(R9,R10,R11,R12)
453 [-]: TEST      R8 1         ; if R8 then PC := 458
454 [-]: JMP       458          ; PC := 458
455 [-]: GETGLOBAL R9 K74       ; R9 := 0x93B1256B
456 [-]: LOADK     R10 K75      ; R10 := "Error equipping Enemy ActionFigure Weapon"
457 [-]: CALL      R9 2 1       ; R9(R10)
458 [-]: GETTABLE  R9 R0 K28    ; R9 := R0["mEnemyLoader"]
459 [-]: SETTABLE  R9 K56 K76   ; R9["AvatarCopyPending"] := 3
