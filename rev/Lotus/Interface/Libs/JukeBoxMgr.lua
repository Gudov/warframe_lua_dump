...
; Command line was: -dis C:\wlua_dump\path\Lotus\Interface\Libs\JukeBoxMgr.lua 
...
222 [-]: SETGLOBAL R54 K54      ; StopCurrentSong := R54
223 [-]: SETGLOBAL R54 K55      ; 0xC35F9525 := R54
224 [-]: CLOSURE   R54 25       ; R54 := closure(Function #26)
225 [-]: MOVE      R0 R10       ; R0 := R10
226 [-]: SETGLOBAL R54 K56      ; GetPlayingSongIndex := R54
227 [-]: SETGLOBAL R54 K57      ; 0xC38F6559 := R54
228 [-]: CLOSURE   R54 26       ; R54 := closure(Function #27)
229 [-]: MOVE      R0 R8        ; R0 := R8
230 [-]: SETGLOBAL R54 K58      ; GetPlayingSongInstance := R54
231 [-]: SETGLOBAL R54 K59      ; 0x956526F6 := R54
232 [-]: CLOSURE   R54 27       ; R54 := closure(Function #28)
233 [-]: MOVE      R0 R9        ; R0 := R9
234 [-]: SETGLOBAL R54 K60      ; IsSongPaused := R54
235 [-]: SETGLOBAL R54 K61      ; 0xD6FBE870 := R54
236 [-]: CLOSURE   R54 28       ; R54 := closure(Function #29)
237 [-]: MOVE      R0 R3        ; R0 := R3
238 [-]: SETGLOBAL R54 K62      ; IsSongLocked := R54
239 [-]: SETGLOBAL R54 K63      ; 0x8BCB2EA2 := R54
240 [-]: CLOSURE   R54 29       ; R54 := closure(Function #30)
241 [-]: MOVE      R0 R28       ; R0 := R28
242 [-]: SETGLOBAL R54 K64      ; SetSongStartCallback := R54
243 [-]: SETGLOBAL R54 K65      ; 0x5BE03F95 := R54
244 [-]: CLOSURE   R54 30       ; R54 := closure(Function #31)
245 [-]: MOVE      R0 R29       ; R0 := R29
246 [-]: SETGLOBAL R54 K66      ; SetSongEndCallback := R54
247 [-]: SETGLOBAL R54 K67      ; 0x9423E624 := R54
248 [-]: CLOSURE   R54 31       ; R54 := closure(Function #32)
...
256 [-]: SETGLOBAL R54 K68      ; SetVolume := R54
257 [-]: SETGLOBAL R54 K69      ; 0xD63A0E1 := R54
258 [-]: CLOSURE   R54 32       ; R54 := closure(Function #33)
259 [-]: MOVE      R0 R25       ; R0 := R25
260 [-]: MOVE      R0 R24       ; R0 := R24
261 [-]: SETGLOBAL R54 K70      ; GetVolume := R54
262 [-]: SETGLOBAL R54 K71      ; 0xC4D8E48D := R54
263 [-]: CLOSURE   R54 33       ; R54 := closure(Function #34)
...
276 [-]: CLOSURE   R55 34       ; R55 := closure(Function #35)
...
306 [-]: MOVE      R0 R47       ; R0 := R47
307 [-]: MOVE      R0 R54       ; R0 := R54
308 [-]: SETGLOBAL R55 K72      ; UpdateJukeBox := R55
309 [-]: SETGLOBAL R55 K73      ; 0xC40A9DEF := R55
310 [-]: CLOSURE   R55 35       ; R55 := closure(Function #36)
311 [-]: MOVE      R0 R3        ; R0 := R3
312 [-]: MOVE      R0 R13       ; R0 := R13
313 [-]: SETGLOBAL R55 K74      ; ToggleAutoplaySong := R55
314 [-]: SETGLOBAL R55 K75      ; 0x3B3B4BE5 := R55
315 [-]: CLOSURE   R55 36       ; R55 := closure(Function #37)
316 [-]: MOVE      R0 R3        ; R0 := R3
317 [-]: MOVE      R0 R30       ; R0 := R30
318 [-]: SETGLOBAL R55 K76      ; SaveAutoplaySettings := R55
319 [-]: SETGLOBAL R55 K77      ; 0x9B4A49E7 := R55
320 [-]: CLOSURE   R55 37       ; R55 := closure(Function #38)
...
329 [-]: SETGLOBAL R55 K78      ; RefreshStepSequencers := R55
330 [-]: SETGLOBAL R55 K79      ; 0x30872D22 := R55
331 [-]: CLOSURE   R55 38       ; R55 := closure(Function #39)
...
340 [-]: MOVE      R0 R43       ; R0 := R43
341 [-]: SETGLOBAL R55 K80      ; Initialize := R55
342 [-]: SETGLOBAL R55 K81      ; 0x62648036 := R55
343 [-]: CLOSURE   R55 39       ; R55 := closure(Function #40)
344 [-]: MOVE      R0 R3        ; R0 := R3
345 [-]: SETGLOBAL R55 K82      ; OnIconCacheFlushed := R55
346 [-]: SETGLOBAL R55 K83      ; 0x316AEC8D := R55
...
352 [-]: SETGLOBAL R55 K84      ; OnProfileSaved := R55
353 [-]: SETGLOBAL R55 K85      ; 0xF048D49D := R55
354 [-]: CLOSURE   R55 41       ; R55 := closure(Function #42)
355 [-]: MOVE      R0 R33       ; R0 := R33
356 [-]: SETGLOBAL R55 K86      ; SetSequencerFxEntity := R55
357 [-]: SETGLOBAL R55 K87      ; 0x8E77719C := R55
358 [-]: CLOSURE   R55 42       ; R55 := closure(Function #43)
359 [-]: MOVE      R0 R33       ; R0 := R33
360 [-]: MOVE      R0 R1        ; R0 := R1
361 [-]: SETGLOBAL R55 K88      ; UpdateSequencerColor := R55
362 [-]: SETGLOBAL R55 K89      ; 0xB39E05C0 := R55
363 [-]: CLOSURE   R55 43       ; R55 := closure(Function #44)
364 [-]: MOVE      R0 R12       ; R0 := R12
365 [-]: MOVE      R0 R8        ; R0 := R8
366 [-]: MOVE      R0 R45       ; R0 := R45
367 [-]: MOVE      R0 R9        ; R0 := R9
368 [-]: MOVE      R0 R47       ; R0 := R47
369 [-]: SETGLOBAL R55 K90      ; SetSuppressed := R55
370 [-]: SETGLOBAL R55 K91      ; 0x6935E9 := R55
371 [-]: CLOSURE   R55 44       ; R55 := closure(Function #45)
...
383 [-]: MOVE      R0 R46       ; R0 := R46
384 [-]: MOVE      R0 R14       ; R0 := R14
385 [-]: MOVE      R0 R13       ; R0 := R13
386 [-]: MOVE      R0 R28       ; R0 := R28
387 [-]: MOVE      R0 R29       ; R0 := R29
388 [-]: SETGLOBAL R55 K92      ; Reset := R55
389 [-]: SETGLOBAL R55 K93      ; 0x240B3CAB := R55
...
; Max Stack Size:  9
 ...
 25 [-]: CLOSURE   R4 0         ; R4 := closure(Function #36.1)
...
; Max Stack Size:  4
 ...
 28 [-]: JMP       32           ; PC := 32
 29 [-]: SELF      R1 R0 K2     ; R2 := R0; R1 := R0["0x3DE5CD9B"]
 30 [-]: MOVE      R3 R1        ; R3 := R1
 31 [-]: CALL      R1 3 1       ; R1(R2,R3)
 32 [-]: MOVE      R1 R0        ; R1 := R0
 33 [-]: MOVE      R1 R12       ; R1 := R12
 34 [-]: NEWTABLE  R1 0 0       ; R1 := {}
 35 [-]: MOVE      R1 R13       ; R1 := R13
 36 [-]: LOADNIL   R1 R1        ; R1 := nil
 37 [-]: MOVE      R1 R14       ; R1 := R14
 38 [-]: LOADNIL   R1 R1        ; R1 := nil
 39 [-]: MOVE      R1 R15       ; R1 := R15
