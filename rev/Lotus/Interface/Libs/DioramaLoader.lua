...
; Command line was: -dis C:\wlua_dump\path\Lotus\Interface\Libs\DioramaLoader.lua 
...
; Max Stack Size:  51
 ...
 12 [-]: TEST      R2 0         ; if not R2 then PC := 259
 13 [-]: JMP       259          ; PC := 259
 ...
 52 [-]: TEST      R13 1        ; if R13 then PC := 259
 53 [-]: JMP       259          ; PC := 259
 ...
 61 [-]: TEST      R15 1        ; if R15 then PC := 259
 62 [-]: JMP       259          ; PC := 259
 ...
 69 [-]: TEST      R17 1        ; if R17 then PC := 259
 70 [-]: JMP       259          ; PC := 259
 ...
 91 [-]: TEST      R21 1        ; if R21 then PC := 259
 92 [-]: JMP       259          ; PC := 259
...
137 [-]: JMP       141          ; PC := 141
138 [-]: SELF      R23 R22 K31  ; R24 := R22; R23 := R22["0x8DD95738"]
139 [-]: MOVE      R25 R0       ; R25 := R0
140 [-]: CALL      R23 3 1      ; R23(R24,R25)
141 [-]: SELF      R23 R0 K32   ; R24 := R0; R23 := R0["0xB2A01B19"]
142 [-]: CALL      R23 2 2      ; R23 := R23(R24)
143 [-]: SELF      R24 R1 K32   ; R25 := R1; R24 := R1["0xB2A01B19"]
144 [-]: CALL      R24 2 2      ; R24 := R24(R25)
145 [-]: EQ        1 R23 R24    ; if R23 == R24 then PC := 165
146 [-]: JMP       165          ; PC := 165
147 [-]: SELF      R23 R0 K5    ; R24 := R0; R23 := R0["0x36CFF5F1"]
148 [-]: SELF      R25 R1 K32   ; R26 := R1; R25 := R1["0xB2A01B19"]
149 [-]: CALL      R25 2 2      ; R25 := R25(R26)
150 [-]: MOVE      R26 R1       ; R26 := R1
151 [-]: MOVE      R27 R0       ; R27 := R0
152 [-]: CALL      R23 5 1      ; R23(R24,R25,R26,R27)
153 [-]: SELF      R23 R0 K33   ; R24 := R0; R23 := R0["0xA9C8E50E"]
154 [-]: CALL      R23 2 2      ; R23 := R23(R24)
155 [-]: LOADK     R24 K10      ; R24 := 0
156 [-]: SUB       R25 R23 K4   ; R25 := R23 - 1
157 [-]: LOADK     R26 K4       ; R26 := 1
158 [-]: FORPREP   R24 164      ; R24 -= R26; PC := 164
159 [-]: SELF      R28 R0 K34   ; R29 := R0; R28 := R0["0x670C945E"]
160 [-]: MOVE      R30 R27      ; R30 := R27
161 [-]: LOADNIL   R31 R31      ; R31 := nil
162 [-]: MOVE      R32 R0       ; R32 := R0
163 [-]: CALL      R28 5 1      ; R28(R29,R30,R31,R32)
164 [-]: FORLOOP   R24 159      ; R24 += R26; if R24 <= R25 then begin PC := 159; R27 := R24 end
165 [-]: GETUPVAL  R28 U3       ; R28 := U3
166 [-]: MOVE      R29 R0       ; R29 := R0
167 [-]: MOVE      R30 R1       ; R30 := R1
168 [-]: CALL      R28 3 1      ; R28(R29,R30)
169 [-]: SELF      R28 R0 K2    ; R29 := R0; R28 := R0["0x15D4DAEE"]
170 [-]: GETGLOBAL R30 K3       ; R30 := gEntityType
171 [-]: CALL      R28 3 2      ; R28 := R28(R29,R30)
172 [-]: LOADK     R29 K4       ; R29 := 1
173 [-]: LEN       R30 R28      ; R30 := # R28
174 [-]: LOADK     R31 K4       ; R31 := 1
175 [-]: FORPREP   R29 184      ; R29 -= R31; PC := 184
176 [-]: GETTABLE  R33 R28 R32  ; R33 := R28[R32]
177 [-]: EQ        1 R33 R0     ; if R33 == R0 then PC := 184
178 [-]: JMP       184          ; PC := 184
179 [-]: GETTABLE  R33 R28 R32  ; R33 := R28[R32]
180 [-]: SELF      R33 R33 K1   ; R34 := R33; R33 := R33["0x7DBDDA0B"]
181 [-]: MOVE      R35 R0       ; R35 := R0
182 [-]: MOVE      R36 R1       ; R36 := R1
183 [-]: CALL      R33 4 1      ; R33(R34,R35,R36)
184 [-]: FORLOOP   R29 176      ; R29 += R31; if R29 <= R30 then begin PC := 176; R32 := R29 end
185 [-]: NEWTABLE  R33 0 0      ; R33 := {}
186 [-]: LOADK     R34 K4       ; R34 := 1
187 [-]: LEN       R35 R6       ; R35 := # R6
188 [-]: LOADK     R36 K4       ; R36 := 1
189 [-]: FORPREP   R34 195      ; R34 -= R36; PC := 195
190 [-]: GETGLOBAL R38 K35      ; R38 := table
191 [-]: GETTABLE  R38 R38 K36  ; R38 := R38["0xE6450C9D"]
192 [-]: MOVE      R39 R33      ; R39 := R33
193 [-]: GETTABLE  R40 R6 R37   ; R40 := R6[R37]
194 [-]: CALL      R38 3 1      ; R38(R39,R40)
195 [-]: FORLOOP   R34 190      ; R34 += R36; if R34 <= R35 then begin PC := 190; R37 := R34 end
196 [-]: GETGLOBAL R38 K35      ; R38 := table
197 [-]: GETTABLE  R38 R38 K36  ; R38 := R38["0xE6450C9D"]
198 [-]: MOVE      R39 R33      ; R39 := R33
199 [-]: GETGLOBAL R40 K37      ; R40 := gBaseAvatarType
200 [-]: CALL      R38 3 1      ; R38(R39,R40)
201 [-]: GETGLOBAL R38 K35      ; R38 := table
202 [-]: GETTABLE  R38 R38 K36  ; R38 := R38["0xE6450C9D"]
203 [-]: MOVE      R39 R33      ; R39 := R33
204 [-]: GETGLOBAL R40 K38      ; R40 := gEffectType
205 [-]: CALL      R38 3 1      ; R38(R39,R40)
206 [-]: GETGLOBAL R38 K35      ; R38 := table
207 [-]: GETTABLE  R38 R38 K36  ; R38 := R38["0xE6450C9D"]
208 [-]: MOVE      R39 R33      ; R39 := R33
209 [-]: GETGLOBAL R40 K39      ; R40 := gTriggerType
210 [-]: CALL      R38 3 1      ; R38(R39,R40)
211 [-]: GETGLOBAL R38 K35      ; R38 := table
212 [-]: GETTABLE  R38 R38 K36  ; R38 := R38["0xE6450C9D"]
213 [-]: MOVE      R39 R33      ; R39 := R33
214 [-]: GETUPVAL  R40 U4       ; R40 := U4
215 [-]: CALL      R38 3 1      ; R38(R39,R40)
216 [-]: TEST      R4 1         ; if R4 then PC := 221
217 [-]: JMP       221          ; PC := 221
218 [-]: LEN       R38 R33      ; R38 := # R33
219 [-]: GETGLOBAL R39 K40      ; R39 := gWeaponAttachmentType
220 [-]: SETTABLE  R33 R38 R39  ; R33[R38] := R39
221 [-]: GETUPVAL  R38 U5       ; R38 := U5
222 [-]: MOVE      R39 R1       ; R39 := R1
223 [-]: MOVE      R40 R0       ; R40 := R0
224 [-]: MOVE      R41 R33      ; R41 := R33
225 [-]: MOVE      R42 R6       ; R42 := R6
226 [-]: MOVE      R43 R5       ; R43 := R5
227 [-]: SELF      R44 R1 K41   ; R45 := R1; R44 := R1["0x8C1ACCEF"]
228 [-]: CALL      R44 2 0      ; R44,... := R44(R45)
229 [-]: CALL      R38 0 1      ; R38(R39,...)
230 [-]: SELF      R38 R1 K2    ; R39 := R1; R38 := R1["0x15D4DAEE"]
231 [-]: GETUPVAL  R40 U6       ; R40 := U6
232 [-]: CALL      R38 3 2      ; R38 := R38(R39,R40)
233 [-]: LOADK     R39 K4       ; R39 := 1
234 [-]: LEN       R40 R38      ; R40 := # R38
235 [-]: LOADK     R41 K4       ; R41 := 1
236 [-]: FORPREP   R39 258      ; R39 -= R41; PC := 258
237 [-]: GETTABLE  R43 R38 R42  ; R43 := R38[R42]
238 [-]: SELF      R44 R0 K42   ; R45 := R0; R44 := R0["0xAB436EF2"]
239 [-]: SELF      R46 R43 K43  ; R47 := R43; R46 := R43["0xCA60A387"]
240 [-]: CALL      R46 2 2      ; R46 := R46(R47)
241 [-]: SELF      R47 R43 K44  ; R48 := R43; R47 := R43["0xDA59764B"]
242 [-]: CALL      R47 2 2      ; R47 := R47(R48)
243 [-]: SELF      R48 R43 K45  ; R49 := R43; R48 := R43["0x36B2BB97"]
244 [-]: CALL      R48 2 2      ; R48 := R48(R49)
245 [-]: SELF      R49 R43 K46  ; R50 := R43; R49 := R43["0x227DF1B0"]
246 [-]: CALL      R49 2 0      ; R49,... := R49(R50)
247 [-]: CALL      R44 0 2      ; R44 := R44(R45,...)
248 [-]: SELF      R45 R44 K47  ; R46 := R44; R45 := R44["0x4014BD75"]
249 [-]: LOADK     R47 K10      ; R47 := 0
250 [-]: CALL      R45 3 1      ; R45(R46,R47)
251 [-]: GETUPVAL  R45 U3       ; R45 := U3
252 [-]: MOVE      R46 R44      ; R46 := R44
253 [-]: MOVE      R47 R43      ; R47 := R43
254 [-]: CALL      R45 3 1      ; R45(R46,R47)
255 [-]: SELF      R45 R44 K48  ; R46 := R44; R45 := R44["0xC361230D"]
256 [-]: MOVE      R47 R43      ; R47 := R43
257 [-]: CALL      R45 3 1      ; R45(R46,R47)
258 [-]: FORLOOP   R39 237      ; R39 += R41; if R39 <= R40 then begin PC := 237; R42 := R39 end
