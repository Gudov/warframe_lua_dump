...
; Command line was: -dis C:\wlua_dump\path\Lotus\Interface\TransmissionUtilities.lua 
...
461 [-]: FORPREP   R28 664      ; R28 -= R30; PC := 664
...
664 [-]: FORLOOP   R28 462      ; R28 += R30; if R28 <= R29 then begin PC := 462; R31 := R28 end
665 [-]: TEST      R3 1         ; if R3 then PC := 729
666 [-]: JMP       729          ; PC := 729
667 [-]: GETTABLE  R44 R0 K9    ; R44 := R0["mVoiceParticles"]
668 [-]: EQ        0 R44 K2     ; if R44 ~= nil then PC := 698
669 [-]: JMP       698          ; PC := 698
670 [-]: SELF      R44 R2 K142  ; R45 := R2; R44 := R2["0xA76F0612"]
671 [-]: GETTABLE  R46 R0 K108  ; R46 := R0["VOICE_TAG"]
672 [-]: CALL      R44 3 2      ; R44 := R44(R45,R46)
673 [-]: SETTABLE  R0 K9 R44    ; R0["mVoiceParticles"] := R44
674 [-]: GETTABLE  R44 R0 K9    ; R44 := R0["mVoiceParticles"]
675 [-]: EQ        0 R44 K2     ; if R44 ~= nil then PC := 680
676 [-]: JMP       680          ; PC := 680
677 [-]: NEWTABLE  R44 0 0      ; R44 := {}
678 [-]: SETTABLE  R0 K9 R44    ; R0["mVoiceParticles"] := R44
679 [-]: JMP       698          ; PC := 698
680 [-]: GETTABLE  R44 R0 K9    ; R44 := R0["mVoiceParticles"]
681 [-]: LEN       R44 R44      ; R44 := # R44
682 [-]: LOADK     R45 K4       ; R45 := 1
683 [-]: LOADK     R46 K143     ; R46 := -1
684 [-]: FORPREP   R44 697      ; R44 -= R46; PC := 697
685 [-]: GETTABLE  R48 R0 K9    ; R48 := R0["mVoiceParticles"]
686 [-]: GETTABLE  R48 R48 R47  ; R48 := R48[R47]
687 [-]: SELF      R48 R48 K122 ; R49 := R48; R48 := R48["0x8B598ED4"]
688 [-]: GETGLOBAL R50 K144     ; R50 := gParticleSysType
689 [-]: CALL      R48 3 2      ; R48 := R48(R49,R50)
690 [-]: TEST      R48 1        ; if R48 then PC := 697
691 [-]: JMP       697          ; PC := 697
692 [-]: GETGLOBAL R48 K140     ; R48 := table
693 [-]: GETTABLE  R48 R48 K145 ; R48 := R48["0xCDB1FD5E"]
694 [-]: GETTABLE  R49 R0 K9    ; R49 := R0["mVoiceParticles"]
695 [-]: MOVE      R50 R47      ; R50 := R47
696 [-]: CALL      R48 3 1      ; R48(R49,R50)
697 [-]: FORLOOP   R44 685      ; R44 += R46; if R44 <= R45 then begin PC := 685; R47 := R44 end
698 [-]: LOADK     R48 K4       ; R48 := 1
699 [-]: GETTABLE  R49 R0 K9    ; R49 := R0["mVoiceParticles"]
700 [-]: LEN       R49 R49      ; R49 := # R49
701 [-]: LOADK     R50 K4       ; R50 := 1
702 [-]: FORPREP   R48 728      ; R48 -= R50; PC := 728
703 [-]: GETGLOBAL R52 K20      ; R52 := 0x400E7765
704 [-]: GETTABLE  R53 R0 K9    ; R53 := R0["mVoiceParticles"]
705 [-]: GETTABLE  R53 R53 R51  ; R53 := R53[R51]
706 [-]: CALL      R52 2 2      ; R52 := R52(R53)
707 [-]: TEST      R52 1        ; if R52 then PC := 728
708 [-]: JMP       728          ; PC := 728
709 [-]: GETTABLE  R52 R0 K49   ; R52 := R0["mSmoothAmp"]
710 [-]: SELF      R52 R52 K98  ; R53 := R52; R52 := R52["0xC4E503B0"]
711 [-]: CALL      R52 2 2      ; R52 := R52(R53)
712 [-]: LOADK     R53 K41      ; R53 := 0
713 [-]: LT        0 K42 R52    ; if 0.15000000596046 >= R52 then PC := 721
714 [-]: JMP       721          ; PC := 721
715 [-]: GETGLOBAL R54 K40      ; R54 := 0x93034B55
716 [-]: LOADK     R55 K41      ; R55 := 0
717 [-]: LOADK     R56 K146     ; R56 := 20
718 [-]: MOVE      R57 R9       ; R57 := R9
719 [-]: CALL      R54 4 2      ; R54 := R54(R55,R56,R57)
720 [-]: MOVE      R53 R54      ; R53 := R54
721 [-]: GETTABLE  R54 R0 K9    ; R54 := R0["mVoiceParticles"]
722 [-]: GETTABLE  R54 R54 R51  ; R54 := R54[R51]
723 [-]: SELF      R54 R54 K147 ; R55 := R54; R54 := R54["0x1A640338"]
724 [-]: MOVE      R56 R53      ; R56 := R53
725 [-]: MOVE      R57 R53      ; R57 := R53
726 [-]: MOVE      R58 R0       ; R58 := R0
727 [-]: CALL      R54 5 1      ; R54(R55,R56,R57,R58)
728 [-]: FORLOOP   R48 703      ; R48 += R50; if R48 <= R49 then begin PC := 703; R51 := R48 end
729 [-]: GETTABLE  R54 R0 K10   ; R54 := R0["mChatterDeco"]
730 [-]: TEST      R54 1        ; if R54 then PC := 736
731 [-]: JMP       736          ; PC := 736
732 [-]: SELF      R54 R2 K142  ; R55 := R2; R54 := R2["0xA76F0612"]
733 [-]: GETTABLE  R56 R0 K148  ; R56 := R0["CHATTER_TAG"]
734 [-]: CALL      R54 3 2      ; R54 := R54(R55,R56)
735 [-]: SETTABLE  R0 K10 R54   ; R0["mChatterDeco"] := R54
736 [-]: GETTABLE  R54 R0 K10   ; R54 := R0["mChatterDeco"]
737 [-]: LEN       R54 R54      ; R54 := # R54
738 [-]: LT        0 K41 R54    ; if 0 >= R54 then PC := 808
739 [-]: JMP       808          ; PC := 808
740 [-]: LOADK     R54 K4       ; R54 := 1
741 [-]: GETTABLE  R55 R0 K10   ; R55 := R0["mChatterDeco"]
742 [-]: LEN       R55 R55      ; R55 := # R55
743 [-]: LOADK     R56 K4       ; R56 := 1
744 [-]: FORPREP   R54 807      ; R54 -= R56; PC := 807
745 [-]: GETTABLE  R58 R0 K10   ; R58 := R0["mChatterDeco"]
746 [-]: GETTABLE  R58 R58 R57  ; R58 := R58[R57]
747 [-]: GETGLOBAL R59 K20      ; R59 := 0x400E7765
748 [-]: MOVE      R60 R58      ; R60 := R58
749 [-]: CALL      R59 2 2      ; R59 := R59(R60)
750 [-]: TEST      R59 1        ; if R59 then PC := 807
751 [-]: JMP       807          ; PC := 807
752 [-]: SELF      R59 R58 K138 ; R60 := R58; R59 := R58["0xD124E361"]
753 [-]: GETGLOBAL R61 K149     ; R61 := Lotus_Game
754 [-]: GETTABLE  R61 R61 K150 ; R61 := R61["UNLIT_ATTEN"]
755 [-]: MUL       R62 R9 K73   ; R62 := R9 * 4
756 [-]: ADD       R62 K127 R62 ; R62 := 0.25 + R62
757 [-]: CALL      R59 4 1      ; R59(R60,R61,R62)
758 [-]: SELF      R59 R58 K138 ; R60 := R58; R59 := R58["0xD124E361"]
759 [-]: GETUPVAL  R61 U2       ; R61 := U2
760 [-]: MUL       R62 R9 K151  ; R62 := R9 * 0.03999999910593
761 [-]: CALL      R59 4 1      ; R59(R60,R61,R62)
762 [-]: LOADK     R59 K4       ; R59 := 1
763 [-]: GETTABLE  R60 R0 K152  ; R60 := R0["WAVEPARAMS"]
764 [-]: LEN       R60 R60      ; R60 := # R60
765 [-]: LOADK     R61 K4       ; R61 := 1
766 [-]: FORPREP   R59 806      ; R59 -= R61; PC := 806
767 [-]: SUB       R63 R62 K4   ; R63 := R62 - 1
768 [-]: MUL       R63 R63 K73  ; R63 := R63 * 4
769 [-]: GETGLOBAL R64 K153     ; R64 := 0x6374FD98
770 [-]: GETGLOBAL R65 K102     ; R65 := 0xC1B52CDC
771 [-]: GETGLOBAL R66 K154     ; R66 := 0xA1FD035F
772 [-]: GETGLOBAL R67 K100     ; R67 := 0x58E5C2DB
773 [-]: CALL      R67 1 0      ; R67,... := R67()
774 [-]: CALL      R66 0 2      ; R66 := R66(R67,...)
775 [-]: MUL       R66 R62 R66  ; R66 := R62 * R66
776 [-]: CALL      R65 2 2      ; R65 := R65(R66)
777 [-]: MUL       R65 K73 R65  ; R65 := 4 * R65
778 [-]: LOADK     R66 K37      ; R66 := 0.5
779 [-]: LOADK     R67 K4       ; R67 := 1
780 [-]: CALL      R64 4 2      ; R64 := R64(R65,R66,R67)
781 [-]: SELF      R65 R58 K138 ; R66 := R58; R65 := R58["0xD124E361"]
782 [-]: GETTABLE  R67 R0 K152  ; R67 := R0["WAVEPARAMS"]
783 [-]: GETTABLE  R67 R67 R62  ; R67 := R67[R62]
784 [-]: GETTABLE  R68 R0 K155  ; R68 := R0["WAVEVALUES"]
785 [-]: ADD       R69 R63 K4   ; R69 := R63 + 1
786 [-]: GETTABLE  R68 R68 R69  ; R68 := R68[R69]
787 [-]: GETGLOBAL R69 K35      ; R69 := math
788 [-]: GETTABLE  R69 R69 K106 ; R69 := R69["0x65F9712A"]
789 [-]: LOADK     R70 K4       ; R70 := 1
790 [-]: MOVE      R71 R9       ; R71 := R9
791 [-]: CALL      R69 3 2      ; R69 := R69(R70,R71)
792 [-]: MUL       R69 R64 R69  ; R69 := R64 * R69
793 [-]: GETTABLE  R70 R0 K155  ; R70 := R0["WAVEVALUES"]
794 [-]: ADD       R71 R63 K90  ; R71 := R63 + 2
795 [-]: GETTABLE  R70 R70 R71  ; R70 := R70[R71]
796 [-]: MUL       R69 R69 R70  ; R69 := R69 * R70
797 [-]: MUL       R70 R64 K156 ; R70 := R64 * 12
798 [-]: GETTABLE  R71 R0 K155  ; R71 := R0["WAVEVALUES"]
799 [-]: ADD       R72 R63 K132 ; R72 := R63 + 3
800 [-]: GETTABLE  R71 R71 R72  ; R71 := R71[R72]
801 [-]: ADD       R70 R70 R71  ; R70 := R70 + R71
802 [-]: GETTABLE  R71 R0 K155  ; R71 := R0["WAVEVALUES"]
803 [-]: ADD       R72 R63 K73  ; R72 := R63 + 4
804 [-]: GETTABLE  R71 R71 R72  ; R71 := R71[R72]
805 [-]: CALL      R65 7 1      ; R65(R66,R67,R68,R69,R70,R71)
806 [-]: FORLOOP   R59 767      ; R59 += R61; if R59 <= R60 then begin PC := 767; R62 := R59 end
807 [-]: FORLOOP   R54 745      ; R54 += R56; if R54 <= R55 then begin PC := 745; R57 := R54 end
808 [-]: GETTABLE  R65 R0 K11   ; R65 := R0["mAllCameraSpots"]
809 [-]: TEST      R65 1        ; if R65 then PC := 854
810 [-]: JMP       854          ; PC := 854
811 [-]: SELF      R65 R2 K104  ; R66 := R2; R65 := R2["0x9139A00"]
812 [-]: GETGLOBAL R67 K157     ; R67 := gCameraSpotType
813 [-]: CALL      R65 3 2      ; R65 := R65(R66,R67)
814 [-]: SETTABLE  R0 K11 R65   ; R0["mAllCameraSpots"] := R65
815 [-]: GETGLOBAL R65 K30      ; R65 := gRegion
816 [-]: EQ        1 R2 R65     ; if R2 == R65 then PC := 854
817 [-]: JMP       854          ; PC := 854
818 [-]: GETTABLE  R65 R0 K158  ; R65 := R0["TransmissionCameraOffset"]
819 [-]: EQ        1 R65 K2     ; if R65 == nil then PC := 854
820 [-]: JMP       854          ; PC := 854
821 [-]: GETGLOBAL R65 K159     ; R65 := 0x63B09107
822 [-]: GETTABLE  R66 R0 K11   ; R66 := R0["mAllCameraSpots"]
823 [-]: CALL      R65 2 4      ; R65,R66,R67 := R65(R66)
824 [-]: JMP       852          ; PC := 852
825 [-]: GETGLOBAL R70 K20      ; R70 := 0x400E7765
826 [-]: SELF      R71 R69 K160 ; R72 := R69; R71 := R69["0x9F1DC568"]
827 [-]: GETTABLE  R73 R0 K161  ; R73 := R0["CameraWaypointType"]
828 [-]: CALL      R71 3 0      ; R71,... := R71(R72,R73)
829 [-]: CALL      R70 0 2      ; R70 := R70(R71,...)
830 [-]: TEST      R70 0        ; if not R70 then PC := 852
831 [-]: JMP       852          ; PC := 852
832 [-]: SELF      R70 R69 K162 ; R71 := R69; R70 := R69["0xF23A7849"]
833 [-]: CALL      R70 2 2      ; R70 := R70(R71)
834 [-]: GETTABLE  R71 R0 K163  ; R71 := R0["TransmissionHeadingOffset"]
835 [-]: EQ        1 R71 K2     ; if R71 == nil then PC := 841
836 [-]: JMP       841          ; PC := 841
837 [-]: GETTABLE  R71 R70 K164 ; R71 := R70["heading"]
838 [-]: GETTABLE  R72 R0 K163  ; R72 := R0["TransmissionHeadingOffset"]
839 [-]: ADD       R71 R71 R72  ; R71 := R71 + R72
840 [-]: SETTABLE  R70 K164 R71 ; R70["heading"] := R71
841 [-]: SELF      R71 R69 K165 ; R72 := R69; R71 := R69["0x39D7F449"]
842 [-]: SELF      R73 R69 K166 ; R74 := R69; R73 := R69["0x6DA72501"]
843 [-]: CALL      R73 2 2      ; R73 := R73(R74)
844 [-]: GETTABLE  R74 R0 K158  ; R74 := R0["TransmissionCameraOffset"]
845 [-]: ADD       R73 R73 R74  ; R73 := R73 + R74
846 [-]: MOVE      R74 R70      ; R74 := R70
847 [-]: CALL      R71 4 1      ; R71(R72,R73,R74)
848 [-]: SELF      R71 R69 K167 ; R72 := R69; R71 := R69["0xAB436EF2"]
849 [-]: GETTABLE  R73 R0 K161  ; R73 := R0["CameraWaypointType"]
850 [-]: GETGLOBAL R74 K168     ; R74 := EMPTY_SYMBOL
851 [-]: CALL      R71 4 1      ; R71(R72,R73,R74)
852 [-]: TFORLOOP  R65 2        ; R68,R69 :=  R65(R66,R67); if R68 ~= nil then begin PC = 825; R67 := R68 end
853 [-]: JMP       825          ; PC := 825
854 [-]: GETTABLE  R71 R0 K84   ; R71 := R0["mTrackCamera"]
855 [-]: TEST      R71 0        ; if not R71 then PC := 967
856 [-]: JMP       967          ; PC := 967
857 [-]: TEST      R5 0         ; if not R5 then PC := 967
858 [-]: JMP       967          ; PC := 967
859 [-]: GETGLOBAL R71 K20      ; R71 := 0x400E7765
860 [-]: MOVE      R72 R4       ; R72 := R4
861 [-]: CALL      R71 2 2      ; R71 := R71(R72)
862 [-]: TEST      R71 0        ; if not R71 then PC := 967
863 [-]: JMP       967          ; PC := 967
864 [-]: GETGLOBAL R71 K19      ; R71 := _T
865 [-]: GETTABLE  R71 R71 K169 ; R71 := R71["DisableCameraTracking"]
866 [-]: TEST      R71 1        ; if R71 then PC := 967
867 [-]: JMP       967          ; PC := 967
868 [-]: GETTABLE  R71 R0 K11   ; R71 := R0["mAllCameraSpots"]
869 [-]: LEN       R71 R71      ; R71 := # R71
870 [-]: LT        0 K41 R71    ; if 0 >= R71 then PC := 967
871 [-]: JMP       967          ; PC := 967
872 [-]: GETGLOBAL R71 K20      ; R71 := 0x400E7765
873 [-]: GETTABLE  R72 R0 K11   ; R72 := R0["mAllCameraSpots"]
874 [-]: GETTABLE  R72 R72 K4   ; R72 := R72[1]
875 [-]: CALL      R71 2 2      ; R71 := R71(R72)
876 [-]: TEST      R71 1        ; if R71 then PC := 967
877 [-]: JMP       967          ; PC := 967
878 [-]: GETGLOBAL R71 K170     ; R71 := 0xAAC38154
879 [-]: LOADK     R72 K90      ; R72 := 2
880 [-]: LOADK     R73 K4       ; R73 := 1
881 [-]: GETGLOBAL R74 K100     ; R74 := 0x58E5C2DB
882 [-]: CALL      R74 1 2      ; R74 := R74()
883 [-]: MUL       R74 R74 K101 ; R74 := R74 * 0.050000000745058
884 [-]: GETGLOBAL R75 K154     ; R75 := 0xA1FD035F
885 [-]: GETGLOBAL R76 K100     ; R76 := 0x58E5C2DB
886 [-]: CALL      R76 1 2      ; R76 := R76()
887 [-]: MUL       R76 R76 K137 ; R76 := R76 * 0.10000000149012
888 [-]: CALL      R75 2 0      ; R75,... := R75(R76)
889 [-]: CALL      R71 0 2      ; R71 := R71(R72,...)
890 [-]: MUL       R71 R71 K132 ; R71 := R71 * 3
891 [-]: GETGLOBAL R72 K153     ; R72 := 0x6374FD98
892 [-]: GETTABLE  R73 R0 K171  ; R73 := R0["mZoomer"]
893 [-]: GETGLOBAL R74 K45      ; R74 := 0x4CDEF9FF
894 [-]: CALL      R74 1 2      ; R74 := R74()
895 [-]: MUL       R74 R71 R74  ; R74 := R71 * R74
896 [-]: ADD       R73 R73 R74  ; R73 := R73 + R74
897 [-]: LOADK     R74 K41      ; R74 := 0
898 [-]: LOADK     R75 K4       ; R75 := 1
899 [-]: CALL      R72 4 2      ; R72 := R72(R73,R74,R75)
900 [-]: SETTABLE  R0 K171 R72  ; R0["mZoomer"] := R72
901 [-]: GETGLOBAL R72 K40      ; R72 := 0x93034B55
902 [-]: GETTABLE  R73 R0 K79   ; R73 := R0["mMinFOV"]
903 [-]: GETTABLE  R74 R0 K81   ; R74 := R0["mMaxFOV"]
904 [-]: GETGLOBAL R75 K172     ; R75 := 0x9E1B8940
905 [-]: GETTABLE  R76 R0 K171  ; R76 := R0["mZoomer"]
906 [-]: CALL      R75 2 0      ; R75,... := R75(R76)
907 [-]: CALL      R72 0 2      ; R72 := R72(R73,...)
908 [-]: GETTABLE  R73 R0 K11   ; R73 := R0["mAllCameraSpots"]
909 [-]: GETTABLE  R73 R73 K4   ; R73 := R73[1]
910 [-]: SELF      R73 R73 K173 ; R74 := R73; R73 := R73["0x95E6F2AA"]
911 [-]: MOVE      R75 R72      ; R75 := R72
912 [-]: CALL      R73 3 1      ; R73(R74,R75)
913 [-]: TEST      R11 0        ; if not R11 then PC := 967
914 [-]: JMP       967          ; PC := 967
915 [-]: GETTABLE  R73 R0 K83   ; R73 := R0["mUseHeadTarget"]
916 [-]: TEST      R73 0        ; if not R73 then PC := 967
917 [-]: JMP       967          ; PC := 967
918 [-]: GETTABLE  R73 R11 K174 ; R73 := R11["y"]
919 [-]: SUB       R73 R73 K101 ; R73 := R73 - 0.050000000745058
920 [-]: SETTABLE  R11 K174 R73 ; R11["y"] := R73
921 [-]: GETTABLE  R73 R0 K1    ; R73 := R0["mSmoothHead"]
922 [-]: TEST      R73 1        ; if R73 then PC := 930
923 [-]: JMP       930          ; PC := 930
924 [-]: GETGLOBAL R73 K92      ; R73 := 0x221C9700
925 [-]: GETTABLE  R74 R11 K175 ; R74 := R11["x"]
926 [-]: GETTABLE  R75 R11 K174 ; R75 := R11["y"]
927 [-]: GETTABLE  R76 R11 K176 ; R76 := R11["z"]
928 [-]: CALL      R73 4 2      ; R73 := R73(R74,R75,R76)
929 [-]: SETTABLE  R0 K1 R73    ; R0["mSmoothHead"] := R73
930 [-]: GETGLOBAL R73 K177     ; R73 := 0xE0C881B4
931 [-]: GETTABLE  R74 R0 K1    ; R74 := R0["mSmoothHead"]
932 [-]: MOVE      R75 R11      ; R75 := R11
933 [-]: GETGLOBAL R76 K45      ; R76 := 0x4CDEF9FF
934 [-]: CALL      R76 1 2      ; R76 := R76()
935 [-]: GETTABLE  R77 R0 K89   ; R77 := R0["mTrackSpeed"]
936 [-]: MUL       R76 R76 R77  ; R76 := R76 * R77
937 [-]: CALL      R73 4 2      ; R73 := R73(R74,R75,R76)
938 [-]: SETTABLE  R0 K1 R73    ; R0["mSmoothHead"] := R73
939 [-]: GETGLOBAL R73 K178     ; R73 := 0xEDD2EBFF
940 [-]: GETTABLE  R74 R0 K11   ; R74 := R0["mAllCameraSpots"]
941 [-]: GETTABLE  R74 R74 K4   ; R74 := R74[1]
942 [-]: SELF      R74 R74 K166 ; R75 := R74; R74 := R74["0x6DA72501"]
943 [-]: CALL      R74 2 2      ; R74 := R74(R75)
944 [-]: GETTABLE  R75 R0 K1    ; R75 := R0["mSmoothHead"]
945 [-]: CALL      R73 3 2      ; R73 := R73(R74,R75)
946 [-]: GETTABLE  R74 R73 K164 ; R74 := R73["heading"]
947 [-]: GETTABLE  R75 R0 K179  ; R75 := R0["mScale"]
948 [-]: MUL       R75 R75 K90  ; R75 := R75 * 2
949 [-]: ADD       R74 R74 R75  ; R74 := R74 + R75
950 [-]: GETUPVAL  R75 U3       ; R75 := U3
951 [-]: GETTABLE  R75 R75 K180 ; R75 := R75["0xF81722A2"]
952 [-]: GETTABLE  R76 R0 K163  ; R76 := R0["TransmissionHeadingOffset"]
953 [-]: EQ        0 R76 K2     ; if R76 ~= nil then PC := 956
954 [-]: JMP       956          ; PC := 956
955 [-]: MOVE      R76 R0       ; R76 := R0
956 [-]: MOVE      R76 R1       ; R76 := R1
957 [-]: GETTABLE  R77 R0 K163  ; R77 := R0["TransmissionHeadingOffset"]
958 [-]: LOADK     R78 K41      ; R78 := 0
959 [-]: CALL      R75 4 2      ; R75 := R75(R76,R77,R78)
960 [-]: ADD       R74 R74 R75  ; R74 := R74 + R75
961 [-]: SETTABLE  R73 K164 R74 ; R73["heading"] := R74
962 [-]: GETTABLE  R74 R0 K11   ; R74 := R0["mAllCameraSpots"]
963 [-]: GETTABLE  R74 R74 K4   ; R74 := R74[1]
964 [-]: SELF      R74 R74 K181 ; R75 := R74; R74 := R74["0x5097FD8C"]
965 [-]: MOVE      R76 R73      ; R76 := R73
966 [-]: CALL      R74 3 1      ; R74(R75,R76)
967 [-]: GETTABLE  R74 R0 K85   ; R74 := R0["mTrackCameraTag"]
968 [-]: TEST      R74 0        ; if not R74 then PC := 1013
969 [-]: JMP       1013         ; PC := 1013
970 [-]: GETGLOBAL R74 K20      ; R74 := 0x400E7765
971 [-]: GETGLOBAL R75 K19      ; R75 := _T
972 [-]: GETTABLE  R75 R75 K21  ; R75 := R75["curTransmission"]
973 [-]: CALL      R74 2 2      ; R74 := R74(R75)
974 [-]: TEST      R74 1        ; if R74 then PC := 1013
975 [-]: JMP       1013         ; PC := 1013
976 [-]: GETTABLE  R74 R0 K11   ; R74 := R0["mAllCameraSpots"]
977 [-]: TEST      R74 1        ; if R74 then PC := 983
978 [-]: JMP       983          ; PC := 983
979 [-]: SELF      R74 R2 K104  ; R75 := R2; R74 := R2["0x9139A00"]
980 [-]: GETGLOBAL R76 K157     ; R76 := gCameraSpotType
981 [-]: CALL      R74 3 2      ; R74 := R74(R75,R76)
982 [-]: SETTABLE  R0 K11 R74   ; R0["mAllCameraSpots"] := R74
983 [-]: GETGLOBAL R74 K19      ; R74 := _T
984 [-]: GETTABLE  R74 R74 K21  ; R74 := R74["curTransmission"]
985 [-]: SELF      R74 R74 K25  ; R75 := R74; R74 := R74["0xCE832AFF"]
986 [-]: CALL      R74 2 2      ; R74 := R74(R75)
987 [-]: GETTABLE  R75 R0 K17   ; R75 := R0["mLastCamTag"]
988 [-]: EQ        1 R74 R75    ; if R74 == R75 then PC := 1013
989 [-]: JMP       1013         ; PC := 1013
990 [-]: SETTABLE  R0 K17 R74   ; R0["mLastCamTag"] := R74
991 [-]: LOADK     R75 K4       ; R75 := 1
992 [-]: GETTABLE  R76 R0 K11   ; R76 := R0["mAllCameraSpots"]
993 [-]: LEN       R76 R76      ; R76 := # R76
994 [-]: LOADK     R77 K4       ; R77 := 1
995 [-]: FORPREP   R75 1012     ; R75 -= R77; PC := 1012
996 [-]: GETTABLE  R79 R0 K11   ; R79 := R0["mAllCameraSpots"]
997 [-]: GETTABLE  R79 R79 R78  ; R79 := R79[R78]
998 [-]: SELF      R79 R79 K107 ; R80 := R79; R79 := R79["0x3D6BC661"]
999 [-]: MOVE      R81 R74      ; R81 := R74
1000 [-]: CALL      R79 3 2      ; R79 := R79(R80,R81)
1001 [-]: TEST      R79 0        ; if not R79 then PC := 1008
1002 [-]: JMP       1008         ; PC := 1008
1003 [-]: GETTABLE  R79 R0 K11   ; R79 := R0["mAllCameraSpots"]
1004 [-]: GETTABLE  R79 R79 R78  ; R79 := R79[R78]
1005 [-]: SELF      R79 R79 K182 ; R80 := R79; R79 := R79["0x2B02BBA7"]
1006 [-]: CALL      R79 2 1      ; R79(R80)
1007 [-]: JMP       1012         ; PC := 1012
1008 [-]: GETTABLE  R79 R0 K11   ; R79 := R0["mAllCameraSpots"]
1009 [-]: GETTABLE  R79 R79 R78  ; R79 := R79[R78]
1010 [-]: SELF      R79 R79 K183 ; R80 := R79; R79 := R79["0xE15B9E90"]
1011 [-]: CALL      R79 2 1      ; R79(R80)
1012 [-]: FORLOOP   R75 996      ; R75 += R77; if R75 <= R76 then begin PC := 996; R78 := R75 end
