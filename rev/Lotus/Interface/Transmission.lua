...
; Command line was: -dis C:\wlua_dump\path\Lotus\Interface\Transmission.lua 
...
293 [-]: SELF      R6 R3 K51    ; R7 := R3; R6 := R3["0x6BED9584"]
294 [-]: CALL      R6 2 2       ; R6 := R6(R7)
295 [-]: SELF      R7 R3 K52    ; R8 := R3; R7 := R3["0xCA4BB86"]
296 [-]: CALL      R7 2 2       ; R7 := R7(R8)
297 [-]: LE        1 K9 R6      ; if 0 <= R6 then PC := 301
298 [-]: JMP       301          ; PC := 301
299 [-]: LT        0 K9 R7      ; if 0 >= R7 then PC := 386
300 [-]: JMP       386          ; PC := 386
301 [-]: GETGLOBAL R8 K53       ; R8 := 0x58E5C2DB
302 [-]: CALL      R8 1 2       ; R8 := R8()
303 [-]: GETGLOBAL R9 K3        ; R9 := _T
304 [-]: GETTABLE  R9 R9 K50    ; R9 := R9["TransmissionHistory"]
305 [-]: GETTABLE  R9 R9 R2     ; R9 := R9[R2]
306 [-]: EQ        0 R9 K8      ; if R9 ~= nil then PC := 320
307 [-]: JMP       320          ; PC := 320
308 [-]: GETGLOBAL R9 K3        ; R9 := _T
309 [-]: GETTABLE  R9 R9 K50    ; R9 := R9["TransmissionHistory"]
310 [-]: NEWTABLE  R10 0 1      ; R10 := {}
311 [-]: SETTABLE  R10 K54 R8   ; R10["nextTime"] := R8
312 [-]: SETTABLE  R9 R2 R10    ; R9[R2] := R10
313 [-]: LE        0 K9 R6      ; if 0 > R6 then PC := 355
314 [-]: JMP       355          ; PC := 355
315 [-]: GETGLOBAL R9 K3        ; R9 := _T
316 [-]: GETTABLE  R9 R9 K50    ; R9 := R9["TransmissionHistory"]
317 [-]: GETTABLE  R9 R9 R2     ; R9 := R9[R2]
318 [-]: SETTABLE  R9 K55 R6    ; R9["repeatsRemaining"] := R6
319 [-]: JMP       355          ; PC := 355
320 [-]: LE        0 K9 R6      ; if 0 > R6 then PC := 355
321 [-]: JMP       355          ; PC := 355
322 [-]: GETGLOBAL R9 K3        ; R9 := _T
323 [-]: GETTABLE  R9 R9 K50    ; R9 := R9["TransmissionHistory"]
324 [-]: GETTABLE  R9 R9 R2     ; R9 := R9[R2]
325 [-]: GETTABLE  R9 R9 K55    ; R9 := R9["repeatsRemaining"]
326 [-]: EQ        0 R9 K9      ; if R9 ~= 0 then PC := 346
327 [-]: JMP       346          ; PC := 346
328 [-]: GETGLOBAL R9 K3        ; R9 := _T
329 [-]: GETTABLE  R9 R9 K36    ; R9 := R9["BlockTransmissionFadeOut"]
330 [-]: TEST      R9 0         ; if not R9 then PC := 344
331 [-]: JMP       344          ; PC := 344
332 [-]: GETGLOBAL R9 K0        ; R9 := 0x400E7765
333 [-]: GETGLOBAL R10 K3       ; R10 := _T
334 [-]: GETTABLE  R10 R10 K37  ; R10 := R10["TransmissionOverrideFallback"]
335 [-]: CALL      R9 2 2       ; R9 := R9(R10)
336 [-]: TEST      R9 1         ; if R9 then PC := 344
337 [-]: JMP       344          ; PC := 344
338 [-]: GETGLOBAL R9 K18       ; R9 := 0x7C282057
339 [-]: GETGLOBAL R10 K3       ; R10 := _T
340 [-]: GETTABLE  R10 R10 K37  ; R10 := R10["TransmissionOverrideFallback"]
341 [-]: CALL      R9 2 2       ; R9 := R9(R10)
342 [-]: MOVE      R3 R9        ; R3 := R9
343 [-]: JMP       355          ; PC := 355
344 [-]: RETURN    R0 1         ; return 
345 [-]: JMP       355          ; PC := 355
346 [-]: GETGLOBAL R9 K3        ; R9 := _T
347 [-]: GETTABLE  R9 R9 K50    ; R9 := R9["TransmissionHistory"]
348 [-]: GETTABLE  R9 R9 R2     ; R9 := R9[R2]
349 [-]: GETGLOBAL R10 K3       ; R10 := _T
350 [-]: GETTABLE  R10 R10 K50  ; R10 := R10["TransmissionHistory"]
351 [-]: GETTABLE  R10 R10 R2   ; R10 := R10[R2]
352 [-]: GETTABLE  R10 R10 K55  ; R10 := R10["repeatsRemaining"]
353 [-]: SUB       R10 R10 K17  ; R10 := R10 - 1
354 [-]: SETTABLE  R9 K55 R10   ; R9["repeatsRemaining"] := R10
355 [-]: LT        0 K9 R7      ; if 0 >= R7 then PC := 386
356 [-]: JMP       386          ; PC := 386
357 [-]: GETGLOBAL R9 K3        ; R9 := _T
358 [-]: GETTABLE  R9 R9 K50    ; R9 := R9["TransmissionHistory"]
359 [-]: GETTABLE  R9 R9 R2     ; R9 := R9[R2]
360 [-]: GETTABLE  R9 R9 K54    ; R9 := R9["nextTime"]
361 [-]: LT        0 R8 R9      ; if R8 >= R9 then PC := 381
362 [-]: JMP       381          ; PC := 381
363 [-]: GETGLOBAL R9 K3        ; R9 := _T
364 [-]: GETTABLE  R9 R9 K36    ; R9 := R9["BlockTransmissionFadeOut"]
365 [-]: TEST      R9 0         ; if not R9 then PC := 379
366 [-]: JMP       379          ; PC := 379
367 [-]: GETGLOBAL R9 K0        ; R9 := 0x400E7765
368 [-]: GETGLOBAL R10 K3       ; R10 := _T
369 [-]: GETTABLE  R10 R10 K37  ; R10 := R10["TransmissionOverrideFallback"]
370 [-]: CALL      R9 2 2       ; R9 := R9(R10)
371 [-]: TEST      R9 1         ; if R9 then PC := 379
372 [-]: JMP       379          ; PC := 379
373 [-]: GETGLOBAL R9 K18       ; R9 := 0x7C282057
374 [-]: GETGLOBAL R10 K3       ; R10 := _T
375 [-]: GETTABLE  R10 R10 K37  ; R10 := R10["TransmissionOverrideFallback"]
376 [-]: CALL      R9 2 2       ; R9 := R9(R10)
377 [-]: MOVE      R3 R9        ; R3 := R9
378 [-]: JMP       386          ; PC := 386
379 [-]: RETURN    R0 1         ; return 
380 [-]: JMP       386          ; PC := 386
381 [-]: GETGLOBAL R9 K3        ; R9 := _T
382 [-]: GETTABLE  R9 R9 K50    ; R9 := R9["TransmissionHistory"]
383 [-]: GETTABLE  R9 R9 R2     ; R9 := R9[R2]
384 [-]: ADD       R10 R8 R7    ; R10 := R8 + R7
385 [-]: SETTABLE  R9 K54 R10   ; R9["nextTime"] := R10
386 [-]: GETGLOBAL R9 K3        ; R9 := _T
387 [-]: SETTABLE  R9 K37 K8    ; R9["TransmissionOverrideFallback"] := nil
388 [-]: GETGLOBAL R9 K56       ; R9 := 0x93B1256B
389 [-]: LOADK     R10 K57      ; R10 := "Updated pulled nextQueued: "
390 [-]: SELF      R11 R0 K35   ; R12 := R0; R11 := R0["0x1B252E3C"]
391 [-]: CALL      R11 2 2      ; R11 := R11(R12)
392 [-]: CONCAT    R10 R10 R11  ; R10 := R10 .. R11
393 [-]: CALL      R9 2 1       ; R9(R10)
394 [-]: GETGLOBAL R9 K58       ; R9 := 0xCAA43ABB
395 [-]: MOVE      R10 R3       ; R10 := R3
396 [-]: CALL      R9 2 2       ; R9 := R9(R10)
397 [-]: MOVE      R9 R13       ; R9 := R13
398 [-]: GETGLOBAL R9 K3        ; R9 := _T
399 [-]: SETTABLE  R9 K6 R3     ; R9["curTransmission"] := R3
400 [-]: GETGLOBAL R9 K3        ; R9 := _T
401 [-]: GETTABLE  R9 R9 K6     ; R9 := R9["curTransmission"]
402 [-]: SELF      R9 R9 K59    ; R10 := R9; R9 := R9["0x3E2E17F7"]
403 [-]: CALL      R9 2 2       ; R9 := R9(R10)
404 [-]: GETGLOBAL R10 K0       ; R10 := 0x400E7765
405 [-]: MOVE      R11 R9       ; R11 := R9
406 [-]: CALL      R10 2 2      ; R10 := R10(R11)
407 [-]: TEST      R10 1        ; if R10 then PC := 425
408 [-]: JMP       425          ; PC := 425
409 [-]: SELF      R10 R9 K49   ; R11 := R9; R10 := R9["0x98ECE81"]
410 [-]: CALL      R10 2 2      ; R10 := R10(R11)
411 [-]: GETGLOBAL R11 K3       ; R11 := _T
412 [-]: GETTABLE  R11 R11 K6   ; R11 := R11["curTransmission"]
413 [-]: SELF      R11 R11 K49  ; R12 := R11; R11 := R11["0x98ECE81"]
414 [-]: CALL      R11 2 2      ; R11 := R11(R12)
415 [-]: EQ        0 R10 R11    ; if R10 ~= R11 then PC := 425
416 [-]: JMP       425          ; PC := 425
417 [-]: SELF      R10 R9 K60   ; R11 := R9; R10 := R9["0x45F80B2A"]
418 [-]: CALL      R10 2 2      ; R10 := R10(R11)
419 [-]: LE        0 R10 K9     ; if R10 > 0 then PC := 425
420 [-]: JMP       425          ; PC := 425
421 [-]: GETUPVAL  R10 U14      ; R10 := U14
422 [-]: MOVE      R11 R9       ; R11 := R9
423 [-]: CALL      R10 2 1      ; R10(R11)
424 [-]: JMP       460          ; PC := 460
425 [-]: GETGLOBAL R10 K0       ; R10 := 0x400E7765
426 [-]: MOVE      R11 R9       ; R11 := R9
427 [-]: CALL      R10 2 2      ; R10 := R10(R11)
428 [-]: TEST      R10 0        ; if not R10 then PC := 460
429 [-]: JMP       460          ; PC := 460
430 [-]: GETGLOBAL R10 K0       ; R10 := 0x400E7765
431 [-]: GETGLOBAL R11 K61      ; R11 := gRegion
432 [-]: CALL      R10 2 2      ; R10 := R10(R11)
433 [-]: TEST      R10 1        ; if R10 then PC := 460
434 [-]: JMP       460          ; PC := 460
435 [-]: GETGLOBAL R10 K61      ; R10 := gRegion
436 [-]: SELF      R10 R10 K62  ; R11 := R10; R10 := R10["0x3E2F6BF"]
437 [-]: CALL      R10 2 2      ; R10 := R10(R11)
438 [-]: GETGLOBAL R11 K0       ; R11 := 0x400E7765
439 [-]: MOVE      R12 R10      ; R12 := R10
440 [-]: CALL      R11 2 2      ; R11 := R11(R12)
441 [-]: TEST      R11 1        ; if R11 then PC := 460
442 [-]: JMP       460          ; PC := 460
443 [-]: GETUPVAL  R11 U15      ; R11 := U15
444 [-]: SELF      R11 R11 K63  ; R12 := R11; R11 := R11["0x2F701D2B"]
445 [-]: GETGLOBAL R13 K3       ; R13 := _T
446 [-]: GETTABLE  R13 R13 K6   ; R13 := R13["curTransmission"]
447 [-]: SELF      R13 R13 K64  ; R14 := R13; R13 := R13["0xCE832AFF"]
448 [-]: CALL      R13 2 2      ; R13 := R13(R14)
449 [-]: GETGLOBAL R14 K65      ; R14 := gGameData
450 [-]: MOVE      R15 R10      ; R15 := R10
451 [-]: CALL      R11 5 2      ; R11 := R11(R12,R13,R14,R15)
452 [-]: GETGLOBAL R12 K0       ; R12 := 0x400E7765
453 [-]: MOVE      R13 R11      ; R13 := R11
454 [-]: CALL      R12 2 2      ; R12 := R12(R13)
455 [-]: TEST      R12 1        ; if R12 then PC := 460
456 [-]: JMP       460          ; PC := 460
457 [-]: SELF      R12 R10 K66  ; R13 := R10; R12 := R10["0x8AD099B"]
458 [-]: MOVE      R14 R11      ; R14 := R11
459 [-]: CALL      R12 3 1      ; R12(R13,R14)
460 [-]: GETUPVAL  R12 U16      ; R12 := U16
461 [-]: MOVE      R13 R3       ; R13 := R3
462 [-]: CALL      R12 2 1      ; R12(R13)
463 [-]: GETUPVAL  R12 U17      ; R12 := U17
464 [-]: CALL      R12 1 1      ; R12()
465 [-]: GETUPVAL  R12 U19      ; R12 := U19
466 [-]: MOVE      R12 R18      ; R12 := R18
467 [-]: GETGLOBAL R12 K3       ; R12 := _T
468 [-]: GETTABLE  R12 R12 K6   ; R12 := R12["curTransmission"]
469 [-]: SELF      R12 R12 K60  ; R13 := R12; R12 := R12["0x45F80B2A"]
470 [-]: CALL      R12 2 2      ; R12 := R12(R13)
471 [-]: MOVE      R12 R20      ; R12 := R20
472 [-]: GETUPVAL  R12 U21      ; R12 := U21
473 [-]: GETGLOBAL R13 K3       ; R13 := _T
474 [-]: GETTABLE  R13 R13 K6   ; R13 := R13["curTransmission"]
475 [-]: CALL      R12 2 2      ; R12 := R12(R13)
476 [-]: GETGLOBAL R13 K3       ; R13 := _T
477 [-]: GETTABLE  R13 R13 K6   ; R13 := R13["curTransmission"]
478 [-]: SELF      R13 R13 K67  ; R14 := R13; R13 := R13["0xD08547E3"]
479 [-]: CALL      R13 2 2      ; R13 := R13(R14)
480 [-]: TEST      R13 1        ; if R13 then PC := 485
481 [-]: JMP       485          ; PC := 485
482 [-]: GETUPVAL  R13 U23      ; R13 := U23
483 [-]: MOVE      R13 R13      ; R13 := R13
484 [-]: JMP       487          ; PC := 487
485 [-]: MOVE      R13 R0       ; R13 := R0
486 [-]: MOVE      R13 R1       ; R13 := R1
487 [-]: MOVE      R13 R22      ; R13 := R22
488 [-]: MOVE      R13 R0       ; R13 := R0
489 [-]: MOVE      R13 R24      ; R13 := R24
490 [-]: GETGLOBAL R13 K0       ; R13 := 0x400E7765
491 [-]: MOVE      R14 R12      ; R14 := R12
492 [-]: CALL      R13 2 2      ; R13 := R13(R14)
493 [-]: TEST      R13 1        ; if R13 then PC := 503
494 [-]: JMP       503          ; PC := 503
495 [-]: GETUPVAL  R13 U25      ; R13 := U25
496 [-]: GETUPVAL  R14 U22      ; R14 := U22
497 [-]: SETTABLE  R13 K68 R14  ; R13["mPortrait"] := R14
498 [-]: GETUPVAL  R13 U25      ; R13 := U25
499 [-]: SELF      R13 R13 K69  ; R14 := R13; R13 := R13["0xF0BB6DD"]
500 [-]: MOVE      R15 R12      ; R15 := R12
501 [-]: CALL      R13 3 1      ; R13(R14,R15)
502 [-]: JMP       512          ; PC := 512
503 [-]: GETUPVAL  R13 U22      ; R13 := U22
504 [-]: TEST      R13 1        ; if R13 then PC := 512
505 [-]: JMP       512          ; PC := 512
506 [-]: GETGLOBAL R13 K3       ; R13 := _T
507 [-]: GETTABLE  R13 R13 K70  ; R13 := R13["KeepTransmissionBgRegion"]
508 [-]: TEST      R13 0        ; if not R13 then PC := 512
509 [-]: JMP       512          ; PC := 512
510 [-]: MOVE      R13 R1       ; R13 := R1
511 [-]: MOVE      R13 R24      ; R13 := R24
512 [-]: GETGLOBAL R13 K3       ; R13 := _T
513 [-]: GETTABLE  R13 R13 K70  ; R13 := R13["KeepTransmissionBgRegion"]
514 [-]: TEST      R13 1        ; if R13 then PC := 521
515 [-]: JMP       521          ; PC := 521
516 [-]: GETUPVAL  R13 U15      ; R13 := U15
517 [-]: GETGLOBAL R14 K72      ; R14 := math
518 [-]: GETTABLE  R14 R14 K73  ; R14 := R14["0x865961F7"]
519 [-]: CALL      R14 1 2      ; R14 := R14()
520 [-]: SETTABLE  R13 K71 R14  ; R13["mZoomer"] := R14
521 [-]: GETGLOBAL R13 K0       ; R13 := 0x400E7765
522 [-]: GETGLOBAL R14 K3       ; R14 := _T
523 [-]: GETTABLE  R14 R14 K6   ; R14 := R14["curTransmission"]
524 [-]: CALL      R13 2 2      ; R13 := R13(R14)
525 [-]: TEST      R13 0        ; if not R13 then PC := 528
526 [-]: JMP       528          ; PC := 528
527 [-]: RETURN    R0 1         ; return 
528 [-]: GETUPVAL  R13 U26      ; R13 := U26
529 [-]: CALL      R13 1 1      ; R13()
530 [-]: GETUPVAL  R13 U0       ; R13 := U0
531 [-]: SELF      R13 R13 K74  ; R14 := R13; R13 := R13["0x6B7B470B"]
532 [-]: GETUPVAL  R15 U27      ; R15 := U27
533 [-]: LOADK     R16 K75      ; R16 := "_alpha"
534 [-]: CALL      R13 4 2      ; R13 := R13(R14,R15,R16)
535 [-]: GETUPVAL  R14 U0       ; R14 := U0
536 [-]: SELF      R14 R14 K20  ; R15 := R14; R14 := R14["0x1C19D966"]
537 [-]: LOADK     R16 K76      ; R16 := "ImageFrame"
538 [-]: LOADK     R17 K75      ; R17 := "_alpha"
539 [-]: MOVE      R18 R13      ; R18 := R13
540 [-]: CALL      R14 5 1      ; R14(R15,R16,R17,R18)
541 [-]: GETUPVAL  R14 U0       ; R14 := U0
542 [-]: SELF      R14 R14 K20  ; R15 := R14; R14 := R14["0x1C19D966"]
543 [-]: LOADK     R16 K76      ; R16 := "ImageFrame"
544 [-]: LOADK     R17 K22      ; R17 := "_x"
545 [-]: GETUPVAL  R18 U28      ; R18 := U28
546 [-]: SUB       R18 R18 R13  ; R18 := R18 - R13
547 [-]: CALL      R14 5 1      ; R14(R15,R16,R17,R18)
548 [-]: LOADK     R14 K77      ; R14 := 0.025000000372529
549 [-]: GETGLOBAL R15 K53      ; R15 := 0x58E5C2DB
550 [-]: CALL      R15 1 2      ; R15 := R15()
551 [-]: GETGLOBAL R16 K78      ; R16 := 0x9E1B8940
552 [-]: GETGLOBAL R17 K79      ; R17 := 0xC1B52CDC
553 [-]: MUL       R18 R15 R14  ; R18 := R15 * R14
554 [-]: CALL      R17 2 0      ; R17,... := R17(R18)
555 [-]: CALL      R16 0 2      ; R16 := R16(R17,...)
556 [-]: MUL       R16 R16 K80  ; R16 := R16 * 30
557 [-]: GETGLOBAL R17 K72      ; R17 := math
558 [-]: GETTABLE  R17 R17 K81  ; R17 := R17["0xD6F2D811"]
559 [-]: GETGLOBAL R18 K82      ; R18 := 0x49D2F3F2
560 [-]: ADD       R19 K83 R15  ; R19 := 7 + R15
561 [-]: MUL       R19 R19 R14  ; R19 := R19 * R14
562 [-]: CALL      R18 2 2      ; R18 := R18(R19)
563 [-]: LOADK     R19 K84      ; R19 := 2
564 [-]: CALL      R17 3 2      ; R17 := R17(R18,R19)
565 [-]: MUL       R17 R17 K85  ; R17 := R17 * 15
566 [-]: GETUPVAL  R18 U29      ; R18 := U29
567 [-]: EQ        0 R18 K17    ; if R18 ~= 1 then PC := 584
568 [-]: JMP       584          ; PC := 584
569 [-]: GETUPVAL  R18 U9       ; R18 := U9
570 [-]: TEST      R18 1        ; if R18 then PC := 584
571 [-]: JMP       584          ; PC := 584
572 [-]: GETUPVAL  R18 U0       ; R18 := U0
573 [-]: SELF      R18 R18 K20  ; R19 := R18; R18 := R18["0x1C19D966"]
574 [-]: LOADK     R20 K76      ; R20 := "ImageFrame"
575 [-]: LOADK     R21 K86      ; R21 := "_pitch"
576 [-]: MOVE      R22 R17      ; R22 := R17
577 [-]: CALL      R18 5 1      ; R18(R19,R20,R21,R22)
578 [-]: GETUPVAL  R18 U0       ; R18 := U0
579 [-]: SELF      R18 R18 K20  ; R19 := R18; R18 := R18["0x1C19D966"]
580 [-]: LOADK     R20 K76      ; R20 := "ImageFrame"
581 [-]: LOADK     R21 K87      ; R21 := "_heading"
582 [-]: SUB       R22 R16 K85  ; R22 := R16 - 15
583 [-]: CALL      R18 5 1      ; R18(R19,R20,R21,R22)
584 [-]: GETGLOBAL R18 K72      ; R18 := math
585 [-]: GETTABLE  R18 R18 K88  ; R18 := R18["0xF93F7CC8"]
586 [-]: GETGLOBAL R19 K89      ; R19 := 0xAAC38154
587 [-]: LOADK     R20 K90      ; R20 := 3
588 [-]: LOADK     R21 K91      ; R21 := 0.5
589 [-]: GETGLOBAL R22 K53      ; R22 := 0x58E5C2DB
590 [-]: CALL      R22 1 2      ; R22 := R22()
591 [-]: MUL       R22 R22 K91  ; R22 := R22 * 0.5
592 [-]: LOADK     R23 K9       ; R23 := 0
593 [-]: CALL      R19 5 0      ; R19,... := R19(R20,R21,R22,R23)
594 [-]: CALL      R18 0 2      ; R18 := R18(R19,...)
595 [-]: GETGLOBAL R19 K72      ; R19 := math
596 [-]: GETTABLE  R19 R19 K92  ; R19 := R19["0x65F9712A"]
597 [-]: LOADK     R20 K17      ; R20 := 1
598 [-]: MOVE      R21 R18      ; R21 := R18
599 [-]: CALL      R19 3 2      ; R19 := R19(R20,R21)
600 [-]: MOVE      R18 R19      ; R18 := R19
601 [-]: GETGLOBAL R19 K93      ; R19 := 0xF595ADDE
602 [-]: GETUPVAL  R20 U0       ; R20 := U0
603 [-]: SELF      R20 R20 K74  ; R21 := R20; R20 := R20["0x6B7B470B"]
604 [-]: GETUPVAL  R22 U27      ; R22 := U27
605 [-]: LOADK     R23 K22      ; R23 := "_x"
606 [-]: CALL      R20 4 0      ; R20,... := R20(R21,R22,R23)
607 [-]: CALL      R19 0 2      ; R19 := R19(R20,...)
608 [-]: GETGLOBAL R20 K93      ; R20 := 0xF595ADDE
609 [-]: GETUPVAL  R21 U0       ; R21 := U0
610 [-]: SELF      R21 R21 K74  ; R22 := R21; R21 := R21["0x6B7B470B"]
611 [-]: GETUPVAL  R23 U27      ; R23 := U27
612 [-]: LOADK     R24 K25      ; R24 := "_y"
613 [-]: CALL      R21 4 0      ; R21,... := R21(R22,R23,R24)
614 [-]: CALL      R20 0 2      ; R20 := R20(R21,...)
615 [-]: GETGLOBAL R21 K72      ; R21 := math
616 [-]: GETTABLE  R21 R21 K88  ; R21 := R21["0xF93F7CC8"]
617 [-]: GETUPVAL  R22 U30      ; R22 := U30
618 [-]: SUB       R22 R22 R19  ; R22 := R22 - R19
619 [-]: CALL      R21 2 2      ; R21 := R21(R22)
620 [-]: DIV       R21 R21 K94  ; R21 := R21 / 200
621 [-]: GETGLOBAL R22 K72      ; R22 := math
622 [-]: GETTABLE  R22 R22 K95  ; R22 := R22["0x8B011038"]
623 [-]: MOVE      R23 R21      ; R23 := R21
624 [-]: GETGLOBAL R24 K72      ; R24 := math
625 [-]: GETTABLE  R24 R24 K88  ; R24 := R24["0xF93F7CC8"]
626 [-]: GETUPVAL  R25 U31      ; R25 := U31
627 [-]: SUB       R25 R25 R20  ; R25 := R25 - R20
628 [-]: CALL      R24 2 2      ; R24 := R24(R25)
629 [-]: DIV       R24 R24 K94  ; R24 := R24 / 200
630 [-]: CALL      R22 3 2      ; R22 := R22(R23,R24)
631 [-]: MOVE      R21 R22      ; R21 := R22
632 [-]: GETGLOBAL R22 K72      ; R22 := math
633 [-]: GETTABLE  R22 R22 K81  ; R22 := R22["0xD6F2D811"]
634 [-]: MOVE      R23 R21      ; R23 := R21
635 [-]: LOADK     R24 K91      ; R24 := 0.5
636 [-]: CALL      R22 3 2      ; R22 := R22(R23,R24)
637 [-]: MOVE      R21 R22      ; R21 := R22
638 [-]: GETGLOBAL R22 K96      ; R22 := 0x93034B55
639 [-]: LOADK     R23 K9       ; R23 := 0
640 [-]: LOADK     R24 K97      ; R24 := 0.050000000745058
641 [-]: MUL       R25 R18 R18  ; R25 := R18 * R18
642 [-]: CALL      R22 4 2      ; R22 := R22(R23,R24,R25)
643 [-]: GETUPVAL  R23 U0       ; R23 := U0
644 [-]: SELF      R23 R23 K98  ; R24 := R23; R23 := R23["0x302AAB2F"]
645 [-]: LOADK     R25 K99      ; R25 := "ImageFrame.Image"
646 [-]: LOADK     R26 K100     ; R26 := "PlasmaStrength"
647 [-]: MOVE      R27 R22      ; R27 := R22
648 [-]: LOADK     R28 K9       ; R28 := 0
649 [-]: LOADK     R29 K9       ; R29 := 0
650 [-]: LOADK     R30 K9       ; R30 := 0
651 [-]: CALL      R23 8 1      ; R23(R24,R25,R26,R27,R28,R29,R30)
652 [-]: GETUPVAL  R23 U32      ; R23 := U32
653 [-]: GETUPVAL  R24 U33      ; R24 := U33
654 [-]: EQ        1 R23 R24    ; if R23 == R24 then PC := 660
655 [-]: JMP       660          ; PC := 660
656 [-]: GETUPVAL  R23 U32      ; R23 := U32
657 [-]: GETUPVAL  R24 U34      ; R24 := U34
658 [-]: EQ        0 R23 R24    ; if R23 ~= R24 then PC := 702
659 [-]: JMP       702          ; PC := 702
660 [-]: GETGLOBAL R23 K101     ; R23 := 0x6374FD98
661 [-]: GETGLOBAL R24 K72      ; R24 := math
662 [-]: GETTABLE  R24 R24 K88  ; R24 := R24["0xF93F7CC8"]
663 [-]: GETGLOBAL R25 K89      ; R25 := 0xAAC38154
664 [-]: LOADK     R26 K84      ; R26 := 2
665 [-]: LOADK     R27 K91      ; R27 := 0.5
666 [-]: GETGLOBAL R28 K53      ; R28 := 0x58E5C2DB
667 [-]: CALL      R28 1 2      ; R28 := R28()
668 [-]: MUL       R28 R28 K91  ; R28 := R28 * 0.5
669 [-]: LOADK     R29 K9       ; R29 := 0
670 [-]: CALL      R25 5 0      ; R25,... := R25(R26,R27,R28,R29)
671 [-]: CALL      R24 0 2      ; R24 := R24(R25,...)
672 [-]: MUL       R24 R24 K102 ; R24 := R24 * 1.25
673 [-]: LOADK     R25 K9       ; R25 := 0
674 [-]: LOADK     R26 K17      ; R26 := 1
675 [-]: CALL      R23 4 2      ; R23 := R23(R24,R25,R26)
676 [-]: MOVE      R18 R23      ; R18 := R23
677 [-]: GETGLOBAL R23 K0       ; R23 := 0x400E7765
678 [-]: GETUPVAL  R24 U11      ; R24 := U11
679 [-]: CALL      R23 2 2      ; R23 := R23(R24)
680 [-]: TEST      R23 1        ; if R23 then PC := 702
681 [-]: JMP       702          ; PC := 702
682 [-]: GETUPVAL  R23 U11      ; R23 := U11
683 [-]: SELF      R23 R23 K103 ; R24 := R23; R23 := R23["0x6544EA90"]
684 [-]: LOADK     R25 K17      ; R25 := 1
685 [-]: GETGLOBAL R26 K101     ; R26 := 0x6374FD98
686 [-]: MUL       R27 R18 R18  ; R27 := R18 * R18
687 [-]: MUL       R27 R27 K84  ; R27 := R27 * 2
688 [-]: LOADK     R28 K9       ; R28 := 0
689 [-]: LOADK     R29 K17      ; R29 := 1
690 [-]: CALL      R26 4 0      ; R26,... := R26(R27,R28,R29)
691 [-]: CALL      R23 0 1      ; R23(R24,...)
692 [-]: GETUPVAL  R23 U11      ; R23 := U11
693 [-]: SELF      R23 R23 K103 ; R24 := R23; R23 := R23["0x6544EA90"]
694 [-]: LOADK     R25 K90      ; R25 := 3
695 [-]: GETGLOBAL R26 K101     ; R26 := 0x6374FD98
696 [-]: MUL       R27 R18 R18  ; R27 := R18 * R18
697 [-]: MUL       R27 R27 K84  ; R27 := R27 * 2
698 [-]: LOADK     R28 K9       ; R28 := 0
699 [-]: LOADK     R29 K17      ; R29 := 1
700 [-]: CALL      R26 4 0      ; R26,... := R26(R27,R28,R29)
701 [-]: CALL      R23 0 1      ; R23(R24,...)
702 [-]: GETGLOBAL R23 K3       ; R23 := _T
703 [-]: GETTABLE  R23 R23 K104 ; R23 := R23["LotusGlitching"]
704 [-]: TEST      R23 0        ; if not R23 then PC := 707
705 [-]: JMP       707          ; PC := 707
706 [-]: GETUPVAL  R23 U35      ; R23 := U35
707 [-]: GETUPVAL  R24 U32      ; R24 := U32
708 [-]: GETUPVAL  R25 U36      ; R25 := U36
709 [-]: EQ        0 R24 R25    ; if R24 ~= R25 then PC := 774
710 [-]: JMP       774          ; PC := 774
711 [-]: GETGLOBAL R24 K3       ; R24 := _T
712 [-]: GETTABLE  R24 R24 K105 ; R24 := R24["Scramble_Strong"]
713 [-]: TEST      R24 1        ; if R24 then PC := 716
714 [-]: JMP       716          ; PC := 716
715 [-]: LOADK     R24 K17      ; R24 := 1
716 [-]: LOADK     R25 K106     ; R25 := 0.69999998807907
717 [-]: LOADK     R26 K107     ; R26 := 0.20000000298023
718 [-]: GETUPVAL  R27 U0       ; R27 := U0
719 [-]: SELF      R27 R27 K98  ; R28 := R27; R27 := R27["0x302AAB2F"]
720 [-]: GETUPVAL  R29 U27      ; R29 := U27
721 [-]: LOADK     R30 K108     ; R30 := ".ImageOuter.Image"
722 [-]: CONCAT    R29 R29 R30  ; R29 := R29 .. R30
723 [-]: LOADK     R30 K109     ; R30 := "PixelateBias"
724 [-]: LOADK     R31 K9       ; R31 := 0
725 [-]: GETGLOBAL R32 K101     ; R32 := 0x6374FD98
726 [-]: SUB       R33 K17 R18  ; R33 := 1 - R18
727 [-]: LOADK     R34 K9       ; R34 := 0
728 [-]: LOADK     R35 K110     ; R35 := 0.80000001192093
729 [-]: CALL      R32 4 2      ; R32 := R32(R33,R34,R35)
730 [-]: MUL       R32 R25 R32  ; R32 := R25 * R32
731 [-]: ADD       R32 R26 R32  ; R32 := R26 + R32
732 [-]: LOADK     R33 K9       ; R33 := 0
733 [-]: LOADK     R34 K9       ; R34 := 0
734 [-]: CALL      R27 8 1      ; R27(R28,R29,R30,R31,R32,R33,R34)
735 [-]: GETUPVAL  R27 U0       ; R27 := U0
736 [-]: SELF      R27 R27 K98  ; R28 := R27; R27 := R27["0x302AAB2F"]
737 [-]: GETUPVAL  R29 U27      ; R29 := U27
738 [-]: LOADK     R30 K108     ; R30 := ".ImageOuter.Image"
739 [-]: CONCAT    R29 R29 R30  ; R29 := R29 .. R30
740 [-]: LOADK     R30 K100     ; R30 := "PlasmaStrength"
741 [-]: MUL       R31 K91 R24  ; R31 := 0.5 * R24
742 [-]: LOADK     R32 K9       ; R32 := 0
743 [-]: LOADK     R33 K9       ; R33 := 0
744 [-]: LOADK     R34 K9       ; R34 := 0
745 [-]: CALL      R27 8 1      ; R27(R28,R29,R30,R31,R32,R33,R34)
746 [-]: TEST      R23 1        ; if R23 then PC := 812
747 [-]: JMP       812          ; PC := 812
748 [-]: GETGLOBAL R27 K0       ; R27 := 0x400E7765
749 [-]: GETUPVAL  R28 U11      ; R28 := U11
750 [-]: CALL      R27 2 2      ; R27 := R27(R28)
751 [-]: TEST      R27 1        ; if R27 then PC := 812
752 [-]: JMP       812          ; PC := 812
753 [-]: GETUPVAL  R27 U11      ; R27 := U11
754 [-]: SELF      R27 R27 K111 ; R28 := R27; R27 := R27["0xD6F5F878"]
755 [-]: CALL      R27 2 2      ; R27 := R27(R28)
756 [-]: GETUPVAL  R28 U0       ; R28 := U0
757 [-]: SELF      R28 R28 K98  ; R29 := R28; R28 := R28["0x302AAB2F"]
758 [-]: GETUPVAL  R30 U27      ; R30 := U27
759 [-]: LOADK     R31 K108     ; R31 := ".ImageOuter.Image"
760 [-]: CONCAT    R30 R30 R31  ; R30 := R30 .. R31
761 [-]: LOADK     R31 K112     ; R31 := "Atten"
762 [-]: LOADK     R32 K17      ; R32 := 1
763 [-]: LOADK     R33 K17      ; R33 := 1
764 [-]: LOADK     R34 K17      ; R34 := 1
765 [-]: GETGLOBAL R35 K101     ; R35 := 0x6374FD98
766 [-]: MOVE      R36 R27      ; R36 := R27
767 [-]: LOADK     R37 K9       ; R37 := 0
768 [-]: LOADK     R38 K17      ; R38 := 1
769 [-]: CALL      R35 4 2      ; R35 := R35(R36,R37,R38)
770 [-]: MUL       R35 R35 K106 ; R35 := R35 * 0.69999998807907
771 [-]: ADD       R35 K113 R35 ; R35 := 0.30000001192093 + R35
772 [-]: CALL      R28 8 1      ; R28(R29,R30,R31,R32,R33,R34,R35)
773 [-]: JMP       812          ; PC := 812
774 [-]: GETUPVAL  R28 U0       ; R28 := U0
775 [-]: SELF      R28 R28 K98  ; R29 := R28; R28 := R28["0x302AAB2F"]
776 [-]: GETUPVAL  R30 U27      ; R30 := U27
777 [-]: LOADK     R31 K108     ; R31 := ".ImageOuter.Image"
778 [-]: CONCAT    R30 R30 R31  ; R30 := R30 .. R31
779 [-]: LOADK     R31 K109     ; R31 := "PixelateBias"
780 [-]: LOADK     R32 K9       ; R32 := 0
781 [-]: GETGLOBAL R33 K96      ; R33 := 0x93034B55
782 [-]: LOADK     R34 K114     ; R34 := 1.5
783 [-]: LOADK     R35 K9       ; R35 := 0
784 [-]: MUL       R36 R18 R18  ; R36 := R18 * R18
785 [-]: CALL      R33 4 2      ; R33 := R33(R34,R35,R36)
786 [-]: ADD       R33 K91 R33  ; R33 := 0.5 + R33
787 [-]: LOADK     R34 K9       ; R34 := 0
788 [-]: LOADK     R35 K9       ; R35 := 0
789 [-]: CALL      R28 8 1      ; R28(R29,R30,R31,R32,R33,R34,R35)
790 [-]: GETUPVAL  R28 U0       ; R28 := U0
791 [-]: SELF      R28 R28 K98  ; R29 := R28; R28 := R28["0x302AAB2F"]
792 [-]: GETUPVAL  R30 U27      ; R30 := U27
793 [-]: LOADK     R31 K108     ; R31 := ".ImageOuter.Image"
794 [-]: CONCAT    R30 R30 R31  ; R30 := R30 .. R31
795 [-]: LOADK     R31 K100     ; R31 := "PlasmaStrength"
796 [-]: LOADK     R32 K9       ; R32 := 0
797 [-]: LOADK     R33 K9       ; R33 := 0
798 [-]: LOADK     R34 K9       ; R34 := 0
799 [-]: LOADK     R35 K9       ; R35 := 0
800 [-]: CALL      R28 8 1      ; R28(R29,R30,R31,R32,R33,R34,R35)
801 [-]: GETUPVAL  R28 U0       ; R28 := U0
802 [-]: SELF      R28 R28 K98  ; R29 := R28; R28 := R28["0x302AAB2F"]
803 [-]: GETUPVAL  R30 U27      ; R30 := U27
804 [-]: LOADK     R31 K108     ; R31 := ".ImageOuter.Image"
805 [-]: CONCAT    R30 R30 R31  ; R30 := R30 .. R31
806 [-]: LOADK     R31 K112     ; R31 := "Atten"
807 [-]: LOADK     R32 K17      ; R32 := 1
808 [-]: LOADK     R33 K17      ; R33 := 1
809 [-]: LOADK     R34 K17      ; R34 := 1
810 [-]: LOADK     R35 K17      ; R35 := 1
811 [-]: CALL      R28 8 1      ; R28(R29,R30,R31,R32,R33,R34,R35)
812 [-]: GETGLOBAL R28 K0       ; R28 := 0x400E7765
813 [-]: GETUPVAL  R29 U11      ; R29 := U11
814 [-]: CALL      R28 2 2      ; R28 := R28(R29)
815 [-]: TEST      R28 1        ; if R28 then PC := 840
816 [-]: JMP       840          ; PC := 840
817 [-]: GETUPVAL  R28 U37      ; R28 := U37
818 [-]: TEST      R28 1        ; if R28 then PC := 840
819 [-]: JMP       840          ; PC := 840
820 [-]: GETUPVAL  R28 U11      ; R28 := U11
821 [-]: SELF      R28 R28 K103 ; R29 := R28; R28 := R28["0x6544EA90"]
822 [-]: LOADK     R30 K9       ; R30 := 0
823 [-]: GETGLOBAL R31 K101     ; R31 := 0x6374FD98
824 [-]: MUL       R32 R18 R18  ; R32 := R18 * R18
825 [-]: MUL       R32 R32 K84  ; R32 := R32 * 2
826 [-]: LOADK     R33 K9       ; R33 := 0
827 [-]: LOADK     R34 K17      ; R34 := 1
828 [-]: CALL      R31 4 0      ; R31,... := R31(R32,R33,R34)
829 [-]: CALL      R28 0 1      ; R28(R29,...)
830 [-]: GETUPVAL  R28 U11      ; R28 := U11
831 [-]: SELF      R28 R28 K103 ; R29 := R28; R28 := R28["0x6544EA90"]
832 [-]: LOADK     R30 K115     ; R30 := 5
833 [-]: GETGLOBAL R31 K101     ; R31 := 0x6374FD98
834 [-]: MUL       R32 R18 R18  ; R32 := R18 * R18
835 [-]: MUL       R32 R32 K90  ; R32 := R32 * 3
836 [-]: LOADK     R33 K9       ; R33 := 0
837 [-]: LOADK     R34 K17      ; R34 := 1
838 [-]: CALL      R31 4 0      ; R31,... := R31(R32,R33,R34)
839 [-]: CALL      R28 0 1      ; R28(R29,...)
840 [-]: TEST      R23 0        ; if not R23 then PC := 879
841 [-]: JMP       879          ; PC := 879
842 [-]: GETGLOBAL R28 K0       ; R28 := 0x400E7765
843 [-]: GETUPVAL  R29 U11      ; R29 := U11
844 [-]: CALL      R28 2 2      ; R28 := R28(R29)
845 [-]: TEST      R28 1        ; if R28 then PC := 879
846 [-]: JMP       879          ; PC := 879
847 [-]: GETGLOBAL R28 K3       ; R28 := _T
848 [-]: GETTABLE  R28 R28 K116 ; R28 := R28["LotusVoxelAmt"]
849 [-]: MUL       R28 R28 K117 ; R28 := R28 * 0.75
850 [-]: GETUPVAL  R29 U11      ; R29 := U11
851 [-]: SELF      R29 R29 K103 ; R30 := R29; R29 := R29["0x6544EA90"]
852 [-]: LOADK     R31 K9       ; R31 := 0
853 [-]: LOADK     R32 K17      ; R32 := 1
854 [-]: CALL      R29 4 1      ; R29(R30,R31,R32)
855 [-]: GETUPVAL  R29 U11      ; R29 := U11
856 [-]: SELF      R29 R29 K103 ; R30 := R29; R29 := R29["0x6544EA90"]
857 [-]: LOADK     R31 K84      ; R31 := 2
858 [-]: GETGLOBAL R32 K101     ; R32 := 0x6374FD98
859 [-]: MOVE      R33 R28      ; R33 := R28
860 [-]: LOADK     R34 K9       ; R34 := 0
861 [-]: LOADK     R35 K17      ; R35 := 1
862 [-]: CALL      R32 4 0      ; R32,... := R32(R33,R34,R35)
863 [-]: CALL      R29 0 1      ; R29(R30,...)
864 [-]: GETUPVAL  R29 U11      ; R29 := U11
865 [-]: SELF      R29 R29 K103 ; R30 := R29; R29 := R29["0x6544EA90"]
866 [-]: LOADK     R31 K90      ; R31 := 3
867 [-]: GETGLOBAL R32 K101     ; R32 := 0x6374FD98
868 [-]: MOVE      R33 R28      ; R33 := R28
869 [-]: LOADK     R34 K9       ; R34 := 0
870 [-]: LOADK     R35 K17      ; R35 := 1
871 [-]: CALL      R32 4 0      ; R32,... := R32(R33,R34,R35)
872 [-]: CALL      R29 0 1      ; R29(R30,...)
873 [-]: GETUPVAL  R29 U11      ; R29 := U11
874 [-]: SELF      R29 R29 K103 ; R30 := R29; R29 := R29["0x6544EA90"]
875 [-]: LOADK     R31 K83      ; R31 := 7
876 [-]: LOADK     R32 K91      ; R32 := 0.5
877 [-]: CALL      R29 4 1      ; R29(R30,R31,R32)
878 [-]: JMP       907          ; PC := 907
879 [-]: GETGLOBAL R29 K0       ; R29 := 0x400E7765
880 [-]: GETUPVAL  R30 U11      ; R30 := U11
881 [-]: CALL      R29 2 2      ; R29 := R29(R30)
882 [-]: TEST      R29 1        ; if R29 then PC := 907
883 [-]: JMP       907          ; PC := 907
884 [-]: GETUPVAL  R29 U35      ; R29 := U35
885 [-]: TEST      R29 0        ; if not R29 then PC := 907
886 [-]: JMP       907          ; PC := 907
887 [-]: GETUPVAL  R29 U11      ; R29 := U11
888 [-]: SELF      R29 R29 K103 ; R30 := R29; R29 := R29["0x6544EA90"]
889 [-]: LOADK     R31 K9       ; R31 := 0
890 [-]: LOADK     R32 K9       ; R32 := 0
891 [-]: CALL      R29 4 1      ; R29(R30,R31,R32)
892 [-]: GETUPVAL  R29 U11      ; R29 := U11
893 [-]: SELF      R29 R29 K103 ; R30 := R29; R29 := R29["0x6544EA90"]
894 [-]: LOADK     R31 K84      ; R31 := 2
895 [-]: LOADK     R32 K9       ; R32 := 0
896 [-]: CALL      R29 4 1      ; R29(R30,R31,R32)
897 [-]: GETUPVAL  R29 U11      ; R29 := U11
898 [-]: SELF      R29 R29 K103 ; R30 := R29; R29 := R29["0x6544EA90"]
899 [-]: LOADK     R31 K90      ; R31 := 3
900 [-]: LOADK     R32 K9       ; R32 := 0
901 [-]: CALL      R29 4 1      ; R29(R30,R31,R32)
902 [-]: GETUPVAL  R29 U11      ; R29 := U11
903 [-]: SELF      R29 R29 K103 ; R30 := R29; R29 := R29["0x6544EA90"]
904 [-]: LOADK     R31 K83      ; R31 := 7
905 [-]: LOADK     R32 K9       ; R32 := 0
906 [-]: CALL      R29 4 1      ; R29(R30,R31,R32)
907 [-]: GETUPVAL  R29 U15      ; R29 := U15
908 [-]: GETUPVAL  R30 U38      ; R30 := U38
909 [-]: SETTABLE  R29 K118 R30 ; R29["mScale"] := R30
910 [-]: GETGLOBAL R29 K119     ; R29 := gBackgroundRegion
911 [-]: GETUPVAL  R30 U22      ; R30 := U22
912 [-]: TEST      R30 0        ; if not R30 then PC := 915
913 [-]: JMP       915          ; PC := 915
914 [-]: GETGLOBAL R29 K120     ; R29 := gPortraitRegion
915 [-]: GETGLOBAL R30 K0       ; R30 := 0x400E7765
916 [-]: GETUPVAL  R31 U39      ; R31 := U39
917 [-]: CALL      R30 2 2      ; R30 := R30(R31)
918 [-]: TEST      R30 1        ; if R30 then PC := 921
919 [-]: JMP       921          ; PC := 921
920 [-]: GETGLOBAL R29 K61      ; R29 := gRegion
921 [-]: GETUPVAL  R30 U15      ; R30 := U15
922 [-]: SELF      R30 R30 K121 ; R31 := R30; R30 := R30["0x45A0DEBB"]
923 [-]: GETUPVAL  R32 U12      ; R32 := U12
924 [-]: MOVE      R33 R29      ; R33 := R29
925 [-]: GETGLOBAL R34 K0       ; R34 := 0x400E7765
926 [-]: GETUPVAL  R35 U39      ; R35 := U39
927 [-]: CALL      R34 2 2      ; R34 := R34(R35)
928 [-]: MOVE      R34 R34      ; R34 := R34
929 [-]: GETUPVAL  R35 U39      ; R35 := U39
930 [-]: CALL      R30 6 1      ; R30(R31,R32,R33,R34,R35)
931 [-]: LOADK     R30 K9       ; R30 := 0
932 [-]: GETUPVAL  R31 U32      ; R31 := U32
933 [-]: EQ        1 R31 K8     ; if R31 == nil then PC := 955
934 [-]: JMP       955          ; PC := 955
935 [-]: GETGLOBAL R31 K3       ; R31 := _T
936 [-]: GETGLOBAL R32 K122     ; R32 := 0x9FAED6BC
937 [-]: GETUPVAL  R33 U32      ; R33 := U32
938 [-]: CALL      R32 2 2      ; R32 := R32(R33)
939 [-]: GETTABLE  R31 R31 R32  ; R31 := R31[R32]
940 [-]: EQ        1 R31 K8     ; if R31 == nil then PC := 955
941 [-]: JMP       955          ; PC := 955
942 [-]: GETGLOBAL R31 K101     ; R31 := 0x6374FD98
943 [-]: GETGLOBAL R32 K93      ; R32 := 0xF595ADDE
944 [-]: GETGLOBAL R33 K3       ; R33 := _T
945 [-]: GETGLOBAL R34 K122     ; R34 := 0x9FAED6BC
946 [-]: GETUPVAL  R35 U32      ; R35 := U32
947 [-]: CALL      R34 2 2      ; R34 := R34(R35)
948 [-]: GETTABLE  R33 R33 R34  ; R33 := R33[R34]
949 [-]: CALL      R32 2 2      ; R32 := R32(R33)
950 [-]: LOADK     R33 K9       ; R33 := 0
951 [-]: LOADK     R34 K17      ; R34 := 1
952 [-]: CALL      R31 4 2      ; R31 := R31(R32,R33,R34)
953 [-]: MOVE      R30 R31      ; R30 := R31
954 [-]: MUL       R30 R30 R30  ; R30 := R30 * R30
955 [-]: GETUPVAL  R31 U0       ; R31 := U0
956 [-]: SELF      R31 R31 K98  ; R32 := R31; R31 := R31["0x302AAB2F"]
957 [-]: LOADK     R33 K99      ; R33 := "ImageFrame.Image"
958 [-]: LOADK     R34 K123     ; R34 := "Scramble"
959 [-]: MOVE      R35 R30      ; R35 := R30
960 [-]: LOADK     R36 K9       ; R36 := 0
961 [-]: LOADK     R37 K9       ; R37 := 0
962 [-]: LOADK     R38 K9       ; R38 := 0
963 [-]: CALL      R31 8 1      ; R31(R32,R33,R34,R35,R36,R37,R38)
964 [-]: GETGLOBAL R31 K72      ; R31 := math
965 [-]: GETTABLE  R31 R31 K95  ; R31 := R31["0x8B011038"]
966 [-]: LOADK     R32 K9       ; R32 := 0
967 [-]: GETUPVAL  R33 U40      ; R33 := U40
968 [-]: GETGLOBAL R34 K30      ; R34 := 0x4CDEF9FF
969 [-]: CALL      R34 1 2      ; R34 := R34()
970 [-]: MUL       R34 R34 K84  ; R34 := R34 * 2
971 [-]: SUB       R33 R33 R34  ; R33 := R33 - R34
972 [-]: CALL      R31 3 2      ; R31 := R31(R32,R33)
973 [-]: MOVE      R31 R40      ; R31 := R40
974 [-]: GETUPVAL  R31 U18      ; R31 := U18
975 [-]: GETUPVAL  R32 U41      ; R32 := U41
976 [-]: EQ        0 R31 R32    ; if R31 ~= R32 then PC := 985
977 [-]: JMP       985          ; PC := 985
978 [-]: MUL       R31 R13 K124 ; R31 := R13 * 0.0099999997764826
979 [-]: GETUPVAL  R32 U42      ; R32 := U42
980 [-]: MUL       R31 R31 R32  ; R31 := R31 * R32
981 [-]: GETUPVAL  R32 U0       ; R32 := U0
982 [-]: SELF      R32 R32 K125 ; R33 := R32; R32 := R32["0xE7F490E3"]
983 [-]: MOVE      R34 R31      ; R34 := R31
984 [-]: CALL      R32 3 1      ; R32(R33,R34)
