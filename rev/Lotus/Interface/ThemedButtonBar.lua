...
; Command line was: -dis C:\wlua_dump\path\Lotus\Interface\ThemedButtonBar.lua 
...
; Max Stack Size:  7
 ...
 12 [-]: GETTABLE  R6 R6 K3     ; R6 := R6["mMovie"]
 13 [-]: EQ        0 R6 R0      ; if R6 ~= R0 then PC := 18
 14 [-]: JMP       18           ; PC := 18
 15 [-]: GETUPVAL  R6 U0        ; R6 := U0
 16 [-]: GETTABLE  R6 R6 R5     ; R6 := R6[R5]
 17 [-]: RETURN    R6 2         ; return R6
 18 [-]: FORLOOP   R2 10        ; R2 += R4; if R2 <= R3 then begin PC := 10; R5 := R2 end
 19 [-]: LT        0 K4 R1      ; if 0 >= R1 then PC := 24
 20 [-]: JMP       24           ; PC := 24
 21 [-]: GETUPVAL  R6 U0        ; R6 := U0
 22 [-]: GETTABLE  R6 R6 R1     ; R6 := R6[R1]
