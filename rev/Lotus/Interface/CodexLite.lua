...
; Command line was: -dis C:\wlua_dump\path\Lotus\Interface\CodexLite.lua 
...
; Max Stack Size:  13
  ...
  6 [-]: LOADK     R3 K4        ; R3 := "_alpha"
  7 [-]: LOADK     R4 K5        ; R4 := 0
  8 [-]: CALL      R0 5 1       ; R0(R1,R2,R3,R4)
  9 [-]: GETUPVAL  R0 U1        ; R0 := U1
 10 [-]: GETTABLE  R0 R0 K6     ; R0 := R0["0xFED4DB22"]
 11 [-]: GETGLOBAL R1 K1        ; R1 := mMovie
 12 [-]: LOADK     R2 K7        ; R2 := "Panel"
 13 [-]: CALL      R0 3 1       ; R0(R1,R2)
 14 [-]: GETGLOBAL R0 K1        ; R0 := mMovie
 15 [-]: SELF      R0 R0 K2     ; R1 := R0; R0 := R0["0x1C19D966"]
 16 [-]: LOADK     R2 K8        ; R2 := "Panel.Foreground"
 17 [-]: LOADK     R3 K9        ; R3 := "_z"
 18 [-]: LOADK     R4 K5        ; R4 := 0
 19 [-]: CALL      R0 5 1       ; R0(R1,R2,R3,R4)
 20 [-]: GETGLOBAL R0 K1        ; R0 := mMovie
 21 [-]: SELF      R0 R0 K2     ; R1 := R0; R0 := R0["0x1C19D966"]
 22 [-]: LOADK     R2 K10       ; R2 := "Panel.Shadow"
 23 [-]: LOADK     R3 K9        ; R3 := "_z"
 24 [-]: LOADK     R4 K5        ; R4 := 0
 25 [-]: CALL      R0 5 1       ; R0(R1,R2,R3,R4)
 26 [-]: GETGLOBAL R0 K1        ; R0 := mMovie
 27 [-]: SELF      R0 R0 K2     ; R1 := R0; R0 := R0["0x1C19D966"]
 28 [-]: LOADK     R2 K11       ; R2 := "Panel.BackShadow"
 29 [-]: LOADK     R3 K9        ; R3 := "_z"
 30 [-]: LOADK     R4 K5        ; R4 := 0
 31 [-]: CALL      R0 5 1       ; R0(R1,R2,R3,R4)
 32 [-]: GETGLOBAL R0 K1        ; R0 := mMovie
 33 [-]: SELF      R0 R0 K2     ; R1 := R0; R0 := R0["0x1C19D966"]
 34 [-]: LOADK     R2 K12       ; R2 := "Enemy"
 35 [-]: LOADK     R3 K9        ; R3 := "_z"
 36 [-]: LOADK     R4 K13       ; R4 := -200
 37 [-]: CALL      R0 5 1       ; R0(R1,R2,R3,R4)
 38 [-]: GETGLOBAL R0 K1        ; R0 := mMovie
 39 [-]: SELF      R0 R0 K2     ; R1 := R0; R0 := R0["0x1C19D966"]
 40 [-]: LOADK     R2 K14       ; R2 := "TipImage"
 41 [-]: LOADK     R3 K9        ; R3 := "_z"
 42 [-]: LOADK     R4 K13       ; R4 := -200
 43 [-]: CALL      R0 5 1       ; R0(R1,R2,R3,R4)
 44 [-]: GETGLOBAL R0 K15       ; R0 := 0xF595ADDE
 45 [-]: GETGLOBAL R1 K1        ; R1 := mMovie
 46 [-]: SELF      R1 R1 K16    ; R2 := R1; R1 := R1["0x6B7B470B"]
 47 [-]: LOADK     R3 K7        ; R3 := "Panel"
 48 [-]: LOADK     R4 K17       ; R4 := "_height"
 49 [-]: CALL      R1 4 0       ; R1,... := R1(R2,R3,R4)
 50 [-]: CALL      R0 0 2       ; R0 := R0(R1,...)
 51 [-]: MOVE      R0 R2        ; R0 := R2
 52 [-]: GETGLOBAL R0 K1        ; R0 := mMovie
 53 [-]: SELF      R0 R0 K18    ; R1 := R0; R0 := R0["0x7E1F26D7"]
 54 [-]: LOADK     R2 K14       ; R2 := "TipImage"
 55 [-]: GETGLOBAL R3 K19       ; R3 := imageMaterial
 56 [-]: CALL      R0 4 1       ; R0(R1,R2,R3)
 57 [-]: GETGLOBAL R0 K1        ; R0 := mMovie
 58 [-]: SELF      R0 R0 K18    ; R1 := R0; R0 := R0["0x7E1F26D7"]
 59 [-]: LOADK     R2 K20       ; R2 := "TipImageShadow"
 60 [-]: GETGLOBAL R3 K21       ; R3 := imageShadowMaterial
 61 [-]: CALL      R0 4 1       ; R0(R1,R2,R3)
 62 [-]: GETGLOBAL R0 K22       ; R0 := 0x63B09107
 63 [-]: NEWTABLE  R1 2 0       ; R1 := {}
 64 [-]: LOADK     R2 K14       ; R2 := "TipImage"
 65 [-]: LOADK     R3 K20       ; R3 := "TipImageShadow"
 66 [-]: SETLIST   R1 2 1       ; R1[(1-1)*FPF+i] := R(1+i), 1 <= i <= 2
 67 [-]: CALL      R0 2 4       ; R0,R1,R2 := R0(R1)
 68 [-]: JMP       96           ; PC := 96
 69 [-]: GETGLOBAL R5 K1        ; R5 := mMovie
 70 [-]: SELF      R5 R5 K23    ; R6 := R5; R5 := R5["0x302AAB2F"]
 71 [-]: MOVE      R7 R4        ; R7 := R4
 72 [-]: LOADK     R8 K24       ; R8 := "VisibilityCenter"
 73 [-]: LOADK     R9 K25       ; R9 := 0.38999998569489
 74 [-]: LOADK     R10 K5       ; R10 := 0
 75 [-]: LOADK     R11 K5       ; R11 := 0
 76 [-]: LOADK     R12 K5       ; R12 := 0
 77 [-]: CALL      R5 8 1       ; R5(R6,R7,R8,R9,R10,R11,R12)
 78 [-]: GETGLOBAL R5 K1        ; R5 := mMovie
 79 [-]: SELF      R5 R5 K23    ; R6 := R5; R5 := R5["0x302AAB2F"]
 80 [-]: MOVE      R7 R4        ; R7 := R4
 81 [-]: LOADK     R8 K26       ; R8 := "VisibilitySize"
 82 [-]: LOADK     R9 K27       ; R9 := 0.18500000238419
 83 [-]: LOADK     R10 K5       ; R10 := 0
 84 [-]: LOADK     R11 K5       ; R11 := 0
 85 [-]: LOADK     R12 K5       ; R12 := 0
 86 [-]: CALL      R5 8 1       ; R5(R6,R7,R8,R9,R10,R11,R12)
 87 [-]: GETGLOBAL R5 K1        ; R5 := mMovie
 88 [-]: SELF      R5 R5 K23    ; R6 := R5; R5 := R5["0x302AAB2F"]
 89 [-]: MOVE      R7 R4        ; R7 := R4
 90 [-]: LOADK     R8 K28       ; R8 := "VisibilityFadeSize"
 91 [-]: LOADK     R9 K29       ; R9 := 0.0035000001080334
 92 [-]: LOADK     R10 K5       ; R10 := 0
 93 [-]: LOADK     R11 K5       ; R11 := 0
 94 [-]: LOADK     R12 K5       ; R12 := 0
 95 [-]: CALL      R5 8 1       ; R5(R6,R7,R8,R9,R10,R11,R12)
 96 [-]: TFORLOOP  R0 2         ; R3,R4 :=  R0(R1,R2); if R3 ~= nil then begin PC = 69; R2 := R3 end
 97 [-]: JMP       69           ; PC := 69
