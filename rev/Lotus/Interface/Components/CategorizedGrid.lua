...
; Command line was: -dis C:\wlua_dump\path\Lotus\Interface\Components\CategorizedGrid.lua 
...
; Max Stack Size:  5
 ...
 14 [-]: JMP       19           ; PC := 19
 15 [-]: SELF      R2 R0 K2     ; R3 := R0; R2 := R0["0x3DFBB1D4"]
 16 [-]: CLOSURE   R4 0         ; R4 := closure(Function #1.26.1)
 17 [-]: MOVE      R0 R1        ; R0 := R1
