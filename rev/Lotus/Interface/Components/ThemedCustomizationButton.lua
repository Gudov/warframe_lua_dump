...
; Command line was: -dis C:\wlua_dump\path\Lotus\Interface\Components\ThemedCustomizationButton.lua 
...
; Max Stack Size:  6
  ...
  5 [-]: GETGLOBAL R2 K2        ; R2 := 0x7FD4B57D
  6 [-]: LOADK     R3 K3        ; R3 := 1
  7 [-]: LEN       R4 R1        ; R4 := # R1
  8 [-]: CALL      R2 3 2       ; R2 := R2(R3,R4)
  9 [-]: GETTABLE  R2 R1 R2     ; R2 := R1[R2]
 10 [-]: SELF      R3 R0 K4     ; R4 := R0; R3 := R0["0xF0B150AC"]
 11 [-]: MOVE      R5 R2        ; R5 := R2
