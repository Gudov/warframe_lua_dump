...
; Command line was: -dis C:\wlua_dump\path\Lotus\Interface\Components\ThemedButton.lua 
...
145 [-]: GETGLOBAL R12 K101     ; R12 := 0xECFDD17
146 [-]: MOVE      R13 R8       ; R13 := R8
147 [-]: CALL      R12 2 4      ; R12,R13,R14 := R12(R13)
148 [-]: JMP       150          ; PC := 150
149 [-]: SETTABLE  R11 R15 R16  ; R11[R15] := R16
150 [-]: TFORLOOP  R12 2        ; R15,R16 :=  R12(R13,R14); if R15 ~= nil then begin PC = 149; R14 := R15 end
151 [-]: JMP       149          ; PC := 149
152 [-]: SELF      R17 R11 K102 ; R18 := R11; R17 := R11["0xEC183DDC"]
153 [-]: SELF      R19 R0 K103  ; R20 := R0; R19 := R0["0x6B7B470B"]
154 [-]: MOVE      R21 R1       ; R21 := R1
155 [-]: LOADK     R22 K104     ; R22 := "_x"
156 [-]: CALL      R19 4 2      ; R19 := R19(R20,R21,R22)
157 [-]: SELF      R20 R0 K103  ; R21 := R0; R20 := R0["0x6B7B470B"]
158 [-]: MOVE      R22 R1       ; R22 := R1
159 [-]: LOADK     R23 K105     ; R23 := "_y"
160 [-]: CALL      R20 4 0      ; R20,... := R20(R21,R22,R23)
161 [-]: CALL      R17 0 1      ; R17(R18,...)
162 [-]: SELF      R17 R11 K106 ; R18 := R11; R17 := R11["0x37AAD7A"]
163 [-]: MOVE      R19 R3       ; R19 := R3
164 [-]: CALL      R17 3 1      ; R17(R18,R19)
165 [-]: SELF      R17 R11 K107 ; R18 := R11; R17 := R11["0x6470BAF4"]
166 [-]: CALL      R17 2 1      ; R17(R18)
167 [-]: SELF      R17 R11 K108 ; R18 := R11; R17 := R11["0xCBF84FF"]
168 [-]: MOVE      R19 R1       ; R19 := R1
169 [-]: CALL      R17 3 1      ; R17(R18,R19)
170 [-]: RETURN    R11 2        ; return R11
...
; Max Stack Size:  11
 ...
 35 [-]: MOVE      R1 R3        ; R1 := R3
 36 [-]: SELF      R3 R0 K10    ; R4 := R0; R3 := R0["0x9490FE70"]
 37 [-]: CALL      R3 2 2       ; R3 := R3(R4)
 38 [-]: TEST      R3 0         ; if not R3 then PC := 73
 39 [-]: JMP       73           ; PC := 73
 40 [-]: GETTABLE  R3 R0 K11    ; R3 := R0["mPrefixCallout"]
 41 [-]: TEST      R3 0         ; if not R3 then PC := 73
 42 [-]: JMP       73           ; PC := 73
 43 [-]: GETTABLE  R3 R0 K3     ; R3 := R0["mMovie"]
 44 [-]: SELF      R3 R3 K4     ; R4 := R3; R3 := R3["0x5DB0BD4"]
 45 [-]: GETTABLE  R5 R0 K12    ; R5 := R0["mCallout"]
 46 [-]: MOVE      R6 R1        ; R6 := R1
 47 [-]: CALL      R3 4 2       ; R3 := R3(R4,R5,R6)
 48 [-]: GETTABLE  R4 R0 K3     ; R4 := R0["mMovie"]
 49 [-]: SELF      R4 R4 K13    ; R5 := R4; R4 := R4["0x880196A7"]
 50 [-]: GETTABLE  R6 R0 K14    ; R6 := R0["mClipName"]
 51 [-]: LOADK     R7 K15       ; R7 := "Label"
 52 [-]: LOADK     R8 K16       ; R8 := "text"
 53 [-]: MOVE      R9 R3        ; R9 := R3
 54 [-]: CALL      R4 6 1       ; R4(R5,R6,R7,R8,R9)
 55 [-]: GETGLOBAL R4 K17       ; R4 := 0xF595ADDE
 56 [-]: GETTABLE  R5 R0 K3     ; R5 := R0["mMovie"]
 57 [-]: SELF      R5 R5 K18    ; R6 := R5; R5 := R5["0x6B7B470B"]
 58 [-]: GETTABLE  R7 R0 K14    ; R7 := R0["mClipName"]
 59 [-]: LOADK     R8 K19       ; R8 := ".Label"
 60 [-]: CONCAT    R7 R7 R8     ; R7 := R7 .. R8
 61 [-]: LOADK     R8 K20       ; R8 := "textWidth"
 62 [-]: CALL      R5 4 0       ; R5,... := R5(R6,R7,R8)
 63 [-]: CALL      R4 0 2       ; R4 := R4(R5,...)
 64 [-]: TEST      R4 1         ; if R4 then PC := 67
 65 [-]: JMP       67           ; PC := 67
 66 [-]: LOADK     R4 K21       ; R4 := 0
 67 [-]: LT        0 K21 R4     ; if 0 >= R4 then PC := 73
 68 [-]: JMP       73           ; PC := 73
 69 [-]: MOVE      R4 R3        ; R4 := R3
 70 [-]: LOADK     R5 K22       ; R5 := " "
 71 [-]: MOVE      R6 R1        ; R6 := R1
 72 [-]: CONCAT    R1 R4 R6     ; R1 := R4 .. R5 .. R6
 73 [-]: GETTABLE  R4 R0 K3     ; R4 := R0["mMovie"]
 74 [-]: SELF      R4 R4 K23    ; R5 := R4; R4 := R4["0xD6A79FE9"]
 75 [-]: GETTABLE  R6 R0 K14    ; R6 := R0["mClipName"]
 76 [-]: LOADK     R7 K19       ; R7 := ".Label"
 77 [-]: CONCAT    R6 R6 R7     ; R6 := R6 .. R7
 78 [-]: LOADK     R7 K16       ; R7 := "text"
 79 [-]: GETTABLE  R8 R0 K24    ; R8 := R0["mFormatPrefix"]
 80 [-]: MOVE      R9 R1        ; R9 := R1
 81 [-]: GETTABLE  R10 R0 K25   ; R10 := R0["mFormatSuffix"]
 82 [-]: CONCAT    R8 R8 R10    ; R8 := R8 .. R9 .. R10
 83 [-]: CALL      R4 5 1       ; R4(R5,R6,R7,R8)
 84 [-]: GETTABLE  R4 R0 K3     ; R4 := R0["mMovie"]
 85 [-]: SELF      R4 R4 K13    ; R5 := R4; R4 := R4["0x880196A7"]
 86 [-]: GETTABLE  R6 R0 K14    ; R6 := R0["mClipName"]
 87 [-]: LOADK     R7 K15       ; R7 := "Label"
 88 [-]: LOADK     R8 K26       ; R8 := "textAlign"
 89 [-]: GETTABLE  R9 R0 K27    ; R9 := R0["mAlignment"]
 90 [-]: CALL      R4 6 1       ; R4(R5,R6,R7,R8,R9)
 91 [-]: TEST      R2 1         ; if R2 then PC := 114
 92 [-]: JMP       114          ; PC := 114
 93 [-]: GETTABLE  R4 R0 K28    ; R4 := R0["mMinSize"]
 94 [-]: GETTABLE  R5 R0 K29    ; R5 := R0["mMaxSize"]
 95 [-]: EQ        0 R4 R5      ; if R4 ~= R5 then PC := 114
 96 [-]: JMP       114          ; PC := 114
 97 [-]: GETTABLE  R4 R0 K30    ; R4 := R0["mWidth"]
 98 [-]: EQ        1 R4 K31     ; if R4 == nil then PC := 114
 99 [-]: JMP       114          ; PC := 114
100 [-]: GETTABLE  R4 R0 K28    ; R4 := R0["mMinSize"]
101 [-]: EQ        1 R4 K31     ; if R4 == nil then PC := 107
102 [-]: JMP       107          ; PC := 107
103 [-]: GETTABLE  R4 R0 K30    ; R4 := R0["mWidth"]
104 [-]: GETTABLE  R5 R0 K28    ; R5 := R0["mMinSize"]
105 [-]: LT        1 R4 R5      ; if R4 < R5 then PC := 114
106 [-]: JMP       114          ; PC := 114
107 [-]: GETTABLE  R4 R0 K29    ; R4 := R0["mMaxSize"]
108 [-]: EQ        1 R4 K31     ; if R4 == nil then PC := 116
109 [-]: JMP       116          ; PC := 116
110 [-]: GETTABLE  R4 R0 K30    ; R4 := R0["mWidth"]
111 [-]: GETTABLE  R5 R0 K29    ; R5 := R0["mMaxSize"]
112 [-]: LT        0 R5 R4      ; if R5 >= R4 then PC := 116
113 [-]: JMP       116          ; PC := 116
114 [-]: SELF      R4 R0 K32    ; R5 := R0; R4 := R0["0xA0107BF2"]
