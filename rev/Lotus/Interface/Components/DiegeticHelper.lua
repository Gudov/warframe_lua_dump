...
; Command line was: -dis C:\wlua_dump\path\Lotus\Interface\Components\DiegeticHelper.lua 
...
; Max Stack Size:  16
 ...
 95 [-]: TEST      R6 1         ; if R6 then PC := 289
 96 [-]: JMP       289          ; PC := 289
 97 [-]: GETTABLE  R6 R0 K2     ; R6 := R0["mClosing"]
 98 [-]: TEST      R6 1         ; if R6 then PC := 289
 99 [-]: JMP       289          ; PC := 289
...
220 [-]: GETGLOBAL R8 K62       ; R8 := 0x221C9700
221 [-]: CALL      R8 1 2       ; R8 := R8()
222 [-]: GETTABLE  R9 R0 K18    ; R9 := R0["mCameraSpotPos"]
223 [-]: GETTABLE  R9 R9 K63    ; R9 := R9["x"]
224 [-]: SETTABLE  R8 K63 R9    ; R8["x"] := R9
225 [-]: GETTABLE  R9 R0 K18    ; R9 := R0["mCameraSpotPos"]
226 [-]: GETTABLE  R9 R9 K64    ; R9 := R9["y"]
227 [-]: SETTABLE  R8 K64 R9    ; R8["y"] := R9
228 [-]: GETTABLE  R9 R0 K18    ; R9 := R0["mCameraSpotPos"]
229 [-]: GETTABLE  R9 R9 K65    ; R9 := R9["z"]
230 [-]: SETTABLE  R8 K65 R9    ; R8["z"] := R9
231 [-]: GETGLOBAL R9 K67       ; R9 := 0xE0C881B4
232 [-]: GETGLOBAL R10 K62      ; R10 := 0x221C9700
233 [-]: GETTABLE  R11 R0 K68   ; R11 := R0["mMinCameraShiftX"]
234 [-]: LOADK     R12 K69      ; R12 := 0
235 [-]: LOADK     R13 K69      ; R13 := 0
236 [-]: CALL      R10 4 2      ; R10 := R10(R11,R12,R13)
237 [-]: GETGLOBAL R11 K62      ; R11 := 0x221C9700
238 [-]: GETTABLE  R12 R0 K70   ; R12 := R0["mMaxCameraShiftX"]
239 [-]: LOADK     R13 K69      ; R13 := 0
240 [-]: LOADK     R14 K69      ; R14 := 0
241 [-]: CALL      R11 4 2      ; R11 := R11(R12,R13,R14)
242 [-]: MOVE      R12 R1       ; R12 := R1
243 [-]: CALL      R9 4 2       ; R9 := R9(R10,R11,R12)
244 [-]: SETTABLE  R0 K66 R9    ; R0["mPositionOffset"] := R9
245 [-]: GETTABLE  R9 R0 K66    ; R9 := R0["mPositionOffset"]
246 [-]: GETGLOBAL R10 K67      ; R10 := 0xE0C881B4
247 [-]: GETGLOBAL R11 K62      ; R11 := 0x221C9700
248 [-]: LOADK     R12 K69      ; R12 := 0
249 [-]: GETTABLE  R13 R0 K71   ; R13 := R0["mMinCameraShiftY"]
250 [-]: LOADK     R14 K69      ; R14 := 0
251 [-]: CALL      R11 4 2      ; R11 := R11(R12,R13,R14)
252 [-]: GETGLOBAL R12 K62      ; R12 := 0x221C9700
253 [-]: LOADK     R13 K69      ; R13 := 0
254 [-]: GETTABLE  R14 R0 K72   ; R14 := R0["mMaxCameraShiftY"]
255 [-]: LOADK     R15 K69      ; R15 := 0
256 [-]: CALL      R12 4 2      ; R12 := R12(R13,R14,R15)
257 [-]: MOVE      R13 R2       ; R13 := R2
258 [-]: CALL      R10 4 2      ; R10 := R10(R11,R12,R13)
259 [-]: ADD       R9 R9 R10    ; R9 := R9 + R10
260 [-]: SETTABLE  R0 K66 R9    ; R0["mPositionOffset"] := R9
261 [-]: GETGLOBAL R9 K73       ; R9 := 0x4CBE9A09
262 [-]: GETTABLE  R10 R0 K66   ; R10 := R0["mPositionOffset"]
263 [-]: MOVE      R11 R6       ; R11 := R6
264 [-]: CALL      R9 3 2       ; R9 := R9(R10,R11)
265 [-]: SETTABLE  R0 K66 R9    ; R0["mPositionOffset"] := R9
266 [-]: GETTABLE  R9 R0 K66    ; R9 := R0["mPositionOffset"]
267 [-]: ADD       R8 R8 R9     ; R8 := R8 + R9
268 [-]: GETGLOBAL R9 K0        ; R9 := 0x400E7765
269 [-]: GETTABLE  R10 R0 K11   ; R10 := R0["mCameraSpot"]
270 [-]: SELF      R10 R10 K17  ; R11 := R10; R10 := R10["0x907C463B"]
271 [-]: CALL      R10 2 0      ; R10,... := R10(R11)
272 [-]: CALL      R9 0 2       ; R9 := R9(R10,...)
273 [-]: TEST      R9 0         ; if not R9 then PC := 284
274 [-]: JMP       284          ; PC := 284
275 [-]: GETTABLE  R9 R0 K11    ; R9 := R0["mCameraSpot"]
276 [-]: SELF      R9 R9 K74    ; R10 := R9; R9 := R9["0x5097FD8C"]
277 [-]: MOVE      R11 R6       ; R11 := R6
278 [-]: CALL      R9 3 1       ; R9(R10,R11)
279 [-]: GETTABLE  R9 R0 K11    ; R9 := R0["mCameraSpot"]
280 [-]: SELF      R9 R9 K75    ; R10 := R9; R9 := R9["0xEC183DDC"]
281 [-]: MOVE      R11 R8       ; R11 := R8
282 [-]: CALL      R9 3 1       ; R9(R10,R11)
283 [-]: JMP       289          ; PC := 289
284 [-]: GETTABLE  R9 R0 K11    ; R9 := R0["mCameraSpot"]
285 [-]: SELF      R9 R9 K76    ; R10 := R9; R9 := R9["0xA78B7FA7"]
286 [-]: MOVE      R11 R8       ; R11 := R8
287 [-]: MOVE      R12 R6       ; R12 := R6
288 [-]: CALL      R9 4 1       ; R9(R10,R11,R12)
289 [-]: SELF      R9 R0 K77    ; R10 := R0; R9 := R0["0xD4EA9E3"]
