...
; Command line was: -dis C:\wlua_dump\path\Lotus\Interface\Backgrounds\Overlay\OverlayBackground.lua 
...
; Max Stack Size:  10
 ...
 12 [-]: LOADK     R7 K7        ; R7 := 0.5
 13 [-]: LOADK     R8 K6        ; R8 := 0
 14 [-]: CLOSURE   R9 0         ; R9 := closure(Function #6.1)
 15 [-]: GETUPVAL  R0 U0        ; R0 := U0
 16 [-]: GETUPVAL  R0 U1        ; R0 := U1
 17 [-]: MOVE      R0 R0        ; R0 := R0
 18 [-]: CALL      R1 9 1       ; R1(R2,R3,R4,R5,R6,R7,R8,R9)
 19 [-]: GETUPVAL  R1 U2        ; R1 := U2
 20 [-]: GETTABLE  R1 R1 K8     ; R1 := R1["0xCC17D312"]
 21 [-]: MOVE      R2 R0        ; R2 := R0
 22 [-]: CALL      R1 2 1       ; R1(R2)
 23 [-]: GETUPVAL  R1 U3        ; R1 := U3
 24 [-]: GETTABLE  R1 R1 K9     ; R1 := R1["0xDB33ECB2"]
 25 [-]: GETGLOBAL R2 K1        ; R2 := mMovie
 26 [-]: LOADK     R3 K6        ; R3 := 0
 27 [-]: LOADK     R4 K7        ; R4 := 0.5
