...
; Command line was: -dis C:\wlua_dump\path\Lotus\Interface\ThemedDetailedPurchaseDialog.lua 
...
; Max Stack Size:  13
 ...
 42 [-]: LT        0 R3 R2      ; if R3 >= R2 then PC := 98
 43 [-]: JMP       98           ; PC := 98
 44 [-]: GETGLOBAL R3 K17       ; R3 := gGameStatsMgr
 45 [-]: EQ        1 R3 K3      ; if R3 == nil then PC := 54
 46 [-]: JMP       54           ; PC := 54
 47 [-]: GETGLOBAL R3 K17       ; R3 := gGameStatsMgr
 48 [-]: SELF      R3 R3 K18    ; R4 := R3; R3 := R3["0x31F80B49"]
 49 [-]: GETGLOBAL R5 K19       ; R5 := 0xEC274B1A
 50 [-]: LOADK     R6 K20       ; R6 := "INSUFFICIENT_PLAT_POPUP"
 51 [-]: CALL      R5 2 2       ; R5 := R5(R6)
 52 [-]: LOADK     R6 K21       ; R6 := "GIFTING"
 53 [-]: CALL      R3 4 1       ; R3(R4,R5,R6)
 54 [-]: GETGLOBAL R3 K22       ; R3 := mMovie
 55 [-]: SELF      R3 R3 K23    ; R4 := R3; R3 := R3["0x5DB0BD4"]
 56 [-]: LOADK     R5 K24       ; R5 := "/Lotus/Language/Menu/Global_InsufficientPlatinum"
 57 [-]: MOVE      R6 R1        ; R6 := R1
 58 [-]: NEWTABLE  R7 0 1       ; R7 := {}
 59 [-]: GETTABLE  R8 R0 K26    ; R8 := R0["ItemName"]
 60 [-]: SETTABLE  R7 K25 R8    ; R7["ITEM"] := R8
 61 [-]: CALL      R3 5 2       ; R3 := R3(R4,R5,R6,R7)
 62 [-]: GETGLOBAL R4 K27       ; R4 := Engine
 63 [-]: GETTABLE  R4 R4 K28    ; R4 := R4["0x79E04C26"]
 64 [-]: CALL      R4 1 2       ; R4 := R4()
 65 [-]: TEST      R4 0         ; if not R4 then PC := 85
 66 [-]: JMP       85           ; PC := 85
 67 [-]: GETGLOBAL R4 K27       ; R4 := Engine
 68 [-]: GETTABLE  R4 R4 K29    ; R4 := R4["0x9A594D4D"]
 69 [-]: CALL      R4 1 2       ; R4 := R4()
 70 [-]: TEST      R4 0         ; if not R4 then PC := 85
 71 [-]: JMP       85           ; PC := 85
 72 [-]: GETGLOBAL R4 K0        ; R4 := _T
 73 [-]: GETTABLE  R4 R4 K30    ; R4 := R4["BackgroundMovie"]
 74 [-]: SELF      R4 R4 K31    ; R5 := R4; R4 := R4["0xB9C96BA0"]
 75 [-]: LOADK     R6 K32       ; R6 := "ShowInsufficientFundsPopup"
 76 [-]: NEWTABLE  R7 5 0       ; R7 := {}
 77 [-]: LOADK     R8 K33       ; R8 := "Platinum"
 78 [-]: LOADK     R9 K34       ; R9 := "0"
 79 [-]: MOVE      R10 R3       ; R10 := R3
 80 [-]: LOADK     R11 K35      ; R11 := "false"
 81 [-]: LOADK     R12 K21      ; R12 := "GIFTING"
 82 [-]: SETLIST   R7 5 1       ; R7[(1-1)*FPF+i] := R(7+i), 1 <= i <= 5
 83 [-]: CALL      R4 4 1       ; R4(R5,R6,R7)
 84 [-]: JMP       97           ; PC := 97
 85 [-]: GETGLOBAL R4 K22       ; R4 := mMovie
 86 [-]: SELF      R4 R4 K23    ; R5 := R4; R4 := R4["0x5DB0BD4"]
 87 [-]: LOADK     R6 K36       ; R6 := "/Lotus/Language/Menu/Global_UpSellPlatPrompt"
 88 [-]: MOVE      R7 R1        ; R7 := R1
 89 [-]: CALL      R4 4 2       ; R4 := R4(R5,R6,R7)
 90 [-]: GETUPVAL  R5 U1        ; R5 := U1
 91 [-]: GETTABLE  R5 R5 K37    ; R5 := R5["0x1C988750"]
 92 [-]: MOVE      R6 R3        ; R6 := R3
 93 [-]: MOVE      R7 R4        ; R7 := R4
 94 [-]: CONCAT    R6 R6 R7     ; R6 := R6 .. R7
 95 [-]: LOADK     R7 K38       ; R7 := "OnWantToBuyPlat"
 96 [-]: CALL      R5 3 1       ; R5(R6,R7)
 97 [-]: RETURN    R0 1         ; return 
 98 [-]: GETUPVAL  R5 U0        ; R5 := U0
 99 [-]: SELF      R5 R5 K39    ; R6 := R5; R5 := R5["0x4A22B053"]
100 [-]: CALL      R5 2 2       ; R5 := R5(R6)
101 [-]: LE        0 R5 K40     ; if R5 > 0 then PC := 117
102 [-]: JMP       117          ; PC := 117
103 [-]: GETUPVAL  R5 U0        ; R5 := U0
104 [-]: SELF      R5 R5 K41    ; R6 := R5; R5 := R5["0x53396FD3"]
105 [-]: CALL      R5 2 2       ; R5 := R5(R6)
106 [-]: GETUPVAL  R6 U1        ; R6 := U1
107 [-]: GETTABLE  R6 R6 K42    ; R6 := R6["0xB11F032"]
108 [-]: GETGLOBAL R7 K22       ; R7 := mMovie
109 [-]: SELF      R7 R7 K23    ; R8 := R7; R7 := R7["0x5DB0BD4"]
110 [-]: LOADK     R9 K43       ; R9 := "/Lotus/Language/Menu/GiftFail_NoGiftsRemaining"
111 [-]: MOVE      R10 R1       ; R10 := R1
112 [-]: NEWTABLE  R11 0 1      ; R11 := {}
113 [-]: SETTABLE  R11 K44 R5   ; R11["NUM_GIFTS"] := R5
114 [-]: CALL      R7 5 0       ; R7,... := R7(R8,R9,R10,R11)
115 [-]: CALL      R6 0 1       ; R6(R7,...)
116 [-]: RETURN    R0 1         ; return 
117 [-]: TEST      R1 0         ; if not R1 then PC := 125
118 [-]: JMP       125          ; PC := 125
119 [-]: GETGLOBAL R6 K0        ; R6 := _T
120 [-]: GETTABLE  R6 R6 K1     ; R6 := R6["GiftParams"]
121 [-]: GETTABLE  R7 R0 K13    ; R7 := R0["Coupon"]
122 [-]: GETTABLE  R7 R7 K46    ; R7 := R7["mId"]
123 [-]: SETTABLE  R6 K45 R7    ; R6["CouponId"] := R7
124 [-]: JMP       128          ; PC := 128
125 [-]: GETGLOBAL R6 K0        ; R6 := _T
126 [-]: GETTABLE  R6 R6 K1     ; R6 := R6["GiftParams"]
127 [-]: SETTABLE  R6 K45 K3    ; R6["CouponId"] := nil
128 [-]: GETGLOBAL R6 K4        ; R6 := 0x400E7765
129 [-]: GETUPVAL  R7 U3        ; R7 := U3
130 [-]: CALL      R6 2 2       ; R6 := R6(R7)
131 [-]: TEST      R6 0         ; if not R6 then PC := 181
132 [-]: JMP       181          ; PC := 181
133 [-]: GETGLOBAL R6 K4        ; R6 := 0x400E7765
134 [-]: GETGLOBAL R7 K0        ; R7 := _T
135 [-]: GETTABLE  R7 R7 K30    ; R7 := R7["BackgroundMovie"]
136 [-]: CALL      R6 2 2       ; R6 := R6(R7)
137 [-]: TEST      R6 1         ; if R6 then PC := 181
138 [-]: JMP       181          ; PC := 181
139 [-]: GETGLOBAL R6 K0        ; R6 := _T
140 [-]: SETTABLE  R6 K47 K48   ; R6["SetShowOfflinePlayers"] := "0x1"
141 [-]: GETGLOBAL R6 K0        ; R6 := _T
142 [-]: GETTABLE  R6 R6 K49    ; R6 := R6["0x10F7E690"]
143 [-]: LOADK     R7 K50       ; R7 := "InvitePanel"
144 [-]: CALL      R6 2 2       ; R6 := R6(R7)
145 [-]: MOVE      R6 R3        ; R6 := R3
146 [-]: GETGLOBAL R6 K4        ; R6 := 0x400E7765
147 [-]: GETUPVAL  R7 U3        ; R7 := U3
148 [-]: CALL      R6 2 2       ; R6 := R6(R7)
149 [-]: TEST      R6 1         ; if R6 then PC := 181
150 [-]: JMP       181          ; PC := 181
151 [-]: GETUPVAL  R6 U3        ; R6 := U3
152 [-]: SELF      R6 R6 K51    ; R7 := R6; R6 := R6["0x458F27A9"]
153 [-]: LOADK     R8 K52       ; R8 := "SetTitle"
154 [-]: LOADK     R9 K53       ; R9 := "/Lotus/Language/Menu/GiftChooseRecipientPartOne"
155 [-]: CALL      R6 4 1       ; R6(R7,R8,R9)
156 [-]: GETUPVAL  R6 U3        ; R6 := U3
157 [-]: SELF      R6 R6 K51    ; R7 := R6; R6 := R6["0x458F27A9"]
158 [-]: LOADK     R8 K54       ; R8 := "SetPlayerInvitePrompt"
159 [-]: LOADK     R9 K55       ; R9 := "/Lotus/Language/Menu/GiftChooseRecipientPartTwo"
160 [-]: CALL      R6 4 1       ; R6(R7,R8,R9)
161 [-]: GETUPVAL  R6 U3        ; R6 := U3
162 [-]: SELF      R6 R6 K51    ; R7 := R6; R6 := R6["0x458F27A9"]
163 [-]: LOADK     R8 K56       ; R8 := "SetButtonDesc"
164 [-]: LOADK     R9 K57       ; R9 := "/Lotus/Language/Menu/Item_GiftToPlayerShort"
165 [-]: CALL      R6 4 1       ; R6(R7,R8,R9)
166 [-]: GETUPVAL  R6 U3        ; R6 := U3
167 [-]: SELF      R6 R6 K51    ; R7 := R6; R6 := R6["0x458F27A9"]
168 [-]: LOADK     R8 K58       ; R8 := "SetDefaultName"
169 [-]: GETGLOBAL R9 K0        ; R9 := _T
170 [-]: GETTABLE  R9 R9 K1     ; R9 := R9["GiftParams"]
171 [-]: GETTABLE  R9 R9 K59    ; R9 := R9["Recipient"]
172 [-]: CALL      R6 4 1       ; R6(R7,R8,R9)
173 [-]: GETGLOBAL R6 K0        ; R6 := _T
174 [-]: CLOSURE   R7 0         ; R7 := closure(Function #37.1)
175 [-]: SETTABLE  R6 K60 R7    ; R6["OnNameEnteredCallback"] := R7
176 [-]: GETUPVAL  R6 U3        ; R6 := U3
177 [-]: SELF      R6 R6 K51    ; R7 := R6; R6 := R6["0x458F27A9"]
178 [-]: LOADK     R8 K61       ; R8 := "SetCallback"
179 [-]: LOADK     R9 K60       ; R9 := "OnNameEnteredCallback"
...
220 [-]: TEST      R5 1         ; if R5 then PC := 315
221 [-]: JMP       315          ; PC := 315
...
290 [-]: TEST      R15 1        ; if R15 then PC := 303
291 [-]: JMP       303          ; PC := 303
292 [-]: GETUPVAL  R15 U0       ; R15 := U0
293 [-]: GETUPVAL  R16 U1       ; R16 := U1
294 [-]: GETTABLE  R16 R16 K29  ; R16 := R16["MULTI"]
295 [-]: EQ        0 R15 R16    ; if R15 ~= R16 then PC := 303
296 [-]: JMP       303          ; PC := 303
297 [-]: GETGLOBAL R15 K4       ; R15 := mMovie
298 [-]: SELF      R15 R15 K56  ; R16 := R15; R15 := R15["0x12635C5E"]
299 [-]: GETUPVAL  R17 U5       ; R17 := U5
300 [-]: GETTABLE  R17 R17 K57  ; R17 := R17["mInputField"]
301 [-]: GETTABLE  R17 R17 K58  ; R17 := R17["mLabelClipName"]
302 [-]: CALL      R15 3 1      ; R15(R16,R17)
303 [-]: GETUPVAL  R15 U3       ; R15 := U3
304 [-]: GETUPVAL  R16 U3       ; R16 := U3
305 [-]: GETTABLE  R16 R16 K60  ; R16 := R16["ContentHeight"]
306 [-]: SETTABLE  R15 K59 R16  ; R15["PrevContentHeight"] := R16
307 [-]: GETUPVAL  R15 U3       ; R15 := U3
308 [-]: ADD       R16 R9 R13   ; R16 := R9 + R13
309 [-]: SUB       R16 R16 K24  ; R16 := R16 - 50
310 [-]: SETTABLE  R15 K60 R16  ; R15["ContentHeight"] := R16
311 [-]: GETUPVAL  R15 U3       ; R15 := U3
312 [-]: SELF      R15 R15 K61  ; R16 := R15; R15 := R15["0xB7CBA6A1"]
313 [-]: CALL      R15 2 1      ; R15(R16)
314 [-]: JMP       328          ; PC := 328
315 [-]: GETUPVAL  R15 U3       ; R15 := U3
316 [-]: GETTABLE  R15 R15 K59  ; R15 := R15["PrevContentHeight"]
317 [-]: EQ        1 R15 K19    ; if R15 == nil then PC := 328
318 [-]: JMP       328          ; PC := 328
319 [-]: GETUPVAL  R15 U3       ; R15 := U3
320 [-]: GETUPVAL  R16 U3       ; R16 := U3
321 [-]: GETTABLE  R16 R16 K59  ; R16 := R16["PrevContentHeight"]
322 [-]: SETTABLE  R15 K60 R16  ; R15["ContentHeight"] := R16
323 [-]: GETUPVAL  R15 U3       ; R15 := U3
324 [-]: SETTABLE  R15 K59 K19  ; R15["PrevContentHeight"] := nil
325 [-]: GETUPVAL  R15 U3       ; R15 := U3
326 [-]: SELF      R15 R15 K61  ; R16 := R15; R15 := R15["0xB7CBA6A1"]
327 [-]: CALL      R15 2 1      ; R15(R16)
328 [-]: TEST      R1 1         ; if R1 then PC := 332
329 [-]: JMP       332          ; PC := 332
330 [-]: GETUPVAL  R15 U8       ; R15 := U8
331 [-]: CALL      R15 1 1      ; R15()
...
390 [-]: JMP       397          ; PC := 397
391 [-]: EQ        0 R19 K6     ; if R19 ~= 0 then PC := 397
392 [-]: JMP       397          ; PC := 397
393 [-]: EQ        0 R20 K6     ; if R20 ~= 0 then PC := 397
394 [-]: JMP       397          ; PC := 397
395 [-]: MOVE      R19 R21      ; R19 := R21
...
; Max Stack Size:  43
 ...
 86 [-]: JMP       74           ; PC := 74
 87 [-]: GETGLOBAL R32 K27      ; R32 := 0xF595ADDE
 88 [-]: GETGLOBAL R33 K6       ; R33 := mMovie
 89 [-]: SELF      R33 R33 K28  ; R34 := R33; R33 := R33["0x6B7B470B"]
 90 [-]: LOADK     R35 K29      ; R35 := "ItemGrid"
 91 [-]: LOADK     R36 K30      ; R36 := "_y"
 92 [-]: CALL      R33 4 0      ; R33,... := R33(R34,R35,R36)
 93 [-]: CALL      R32 0 2      ; R32 := R32(R33,...)
 94 [-]: GETUPVAL  R33 U1       ; R33 := U1
 95 [-]: GETTABLE  R33 R33 K31  ; R33 := R33["mRowSeparation"]
 96 [-]: GETUPVAL  R34 U1       ; R34 := U1
 97 [-]: GETTABLE  R34 R34 K32  ; R34 := R34["mRows"]
 98 [-]: MUL       R33 R33 R34  ; R33 := R33 * R34
 99 [-]: GETUPVAL  R34 U1       ; R34 := U1
100 [-]: GETTABLE  R34 R34 K33  ; R34 := R34["ElementDimBuffer"]
101 [-]: SUB       R33 R33 R34  ; R33 := R33 - R34
102 [-]: GETUPVAL  R34 U0       ; R34 := U0
103 [-]: GETTABLE  R34 R34 K5   ; R34 := R34["0x65939576"]
104 [-]: GETGLOBAL R35 K6       ; R35 := mMovie
105 [-]: GETUPVAL  R36 U1       ; R36 := U1
106 [-]: GETTABLE  R36 R36 K34  ; R36 := R36["mInitialY"]
107 [-]: GETUPVAL  R37 U1       ; R37 := U1
108 [-]: GETTABLE  R37 R37 K35  ; R37 := R37["ElementHeight"]
109 [-]: DIV       R37 R37 K8   ; R37 := R37 / 2
110 [-]: SUB       R36 R36 R37  ; R36 := R36 - R37
111 [-]: ADD       R36 R32 R36  ; R36 := R32 + R36
112 [-]: DIV       R37 R33 K8   ; R37 := R33 / 2
113 [-]: ADD       R36 R36 R37  ; R36 := R36 + R37
114 [-]: CALL      R34 3 2      ; R34 := R34(R35,R36)
115 [-]: MOVE      R3 R34       ; R3 := R34
116 [-]: GETUPVAL  R34 U0       ; R34 := U0
117 [-]: GETTABLE  R34 R34 K9   ; R34 := R34["0x9884F87F"]
118 [-]: GETGLOBAL R35 K6       ; R35 := mMovie
119 [-]: MOVE      R36 R33      ; R36 := R33
120 [-]: CALL      R34 3 2      ; R34 := R34(R35,R36)
121 [-]: MOVE      R4 R34       ; R4 := R34
122 [-]: GETUPVAL  R34 U0       ; R34 := U0
123 [-]: GETTABLE  R34 R34 K10  ; R34 := R34["0x73838B63"]
124 [-]: GETGLOBAL R35 K6       ; R35 := mMovie
125 [-]: LOADK     R36 K36      ; R36 := 10
126 [-]: CALL      R34 3 2      ; R34 := R34(R35,R36)
127 [-]: MOVE      R5 R34       ; R5 := R34
128 [-]: GETGLOBAL R34 K12      ; R34 := 0x63B09107
129 [-]: MOVE      R35 R11      ; R35 := R11
130 [-]: CALL      R34 2 4      ; R34,R35,R36 := R34(R35)
131 [-]: JMP       147          ; PC := 147
132 [-]: SELF      R39 R38 K13  ; R40 := R38; R39 := R38["0x94FB2E1A"]
133 [-]: GETGLOBAL R41 K14      ; R41 := Lotus_Game
134 [-]: GETTABLE  R41 R41 K15  ; R41 := R41["VISIBILITY_CENTER"]
135 [-]: MOVE      R42 R3       ; R42 := R3
136 [-]: CALL      R39 4 1      ; R39(R40,R41,R42)
137 [-]: SELF      R39 R38 K13  ; R40 := R38; R39 := R38["0x94FB2E1A"]
138 [-]: GETGLOBAL R41 K14      ; R41 := Lotus_Game
139 [-]: GETTABLE  R41 R41 K16  ; R41 := R41["VISIBILITY_SIZE"]
140 [-]: MOVE      R42 R4       ; R42 := R4
141 [-]: CALL      R39 4 1      ; R39(R40,R41,R42)
142 [-]: SELF      R39 R38 K13  ; R40 := R38; R39 := R38["0x94FB2E1A"]
143 [-]: GETGLOBAL R41 K14      ; R41 := Lotus_Game
144 [-]: GETTABLE  R41 R41 K17  ; R41 := R41["VISIBILITY_FADE_SIZE"]
145 [-]: MOVE      R42 R5       ; R42 := R5
146 [-]: CALL      R39 4 1      ; R39(R40,R41,R42)
147 [-]: TFORLOOP  R34 2        ; R37,R38 :=  R34(R35,R36); if R37 ~= nil then begin PC = 132; R36 := R37 end
148 [-]: JMP       132          ; PC := 132
149 [-]: GETGLOBAL R39 K37      ; R39 := 0x400E7765
150 [-]: GETUPVAL  R40 U2       ; R40 := U2
151 [-]: CALL      R39 2 2      ; R39 := R39(R40)
152 [-]: TEST      R39 1        ; if R39 then PC := 157
153 [-]: JMP       157          ; PC := 157
154 [-]: GETUPVAL  R39 U2       ; R39 := U2
155 [-]: SELF      R39 R39 K38  ; R40 := R39; R39 := R39["0xBB0F32E7"]
156 [-]: CALL      R39 2 1      ; R39(R40)
...
; Max Stack Size:  49
 ...
 30 [-]: TEST      R4 0         ; if not R4 then PC := 101
 31 [-]: JMP       101          ; PC := 101
 ...
 40 [-]: TEST      R4 0         ; if not R4 then PC := 91
 41 [-]: JMP       91           ; PC := 91
 42 [-]: LOADK     R4 K1        ; R4 := 0
 ...
 47 [-]: GETTABLE  R8 R3 K11    ; R8 := R3["StoreItemInfo"]
 48 [-]: GETTABLE  R8 R8 K20    ; R8 := R8["Type"]
 49 [-]: SETTABLE  R7 K19 R8    ; R7["mItemType"] := R8
 50 [-]: SETTABLE  R6 K18 R7    ; R6["mUpgrade"] := R7
 51 [-]: CALL      R5 2 2       ; R5 := R5(R6)
 52 [-]: TEST      R5 1         ; if R5 then PC := 90
 53 [-]: JMP       90           ; PC := 90
 54 [-]: GETUPVAL  R5 U1        ; R5 := U1
 55 [-]: SELF      R5 R5 K21    ; R6 := R5; R5 := R5["0x640AA7E"]
 56 [-]: CALL      R5 2 2       ; R5 := R5(R6)
 57 [-]: LOADK     R6 K22       ; R6 := 1
 58 [-]: LEN       R7 R5        ; R7 := # R5
 59 [-]: LOADK     R8 K22       ; R8 := 1
 60 [-]: FORPREP   R6 74        ; R6 -= R8; PC := 74
 61 [-]: GETTABLE  R10 R5 R9    ; R10 := R5[R9]
 62 [-]: GETTABLE  R10 R10 K23  ; R10 := R10["mItemCount"]
 63 [-]: LT        0 K1 R10     ; if 0 >= R10 then PC := 74
 64 [-]: JMP       74           ; PC := 74
 65 [-]: GETTABLE  R10 R5 R9    ; R10 := R5[R9]
 66 [-]: GETTABLE  R10 R10 K19  ; R10 := R10["mItemType"]
 67 [-]: GETTABLE  R11 R3 K11   ; R11 := R3["StoreItemInfo"]
 68 [-]: GETTABLE  R11 R11 K20  ; R11 := R11["Type"]
 69 [-]: EQ        0 R10 R11    ; if R10 ~= R11 then PC := 74
 70 [-]: JMP       74           ; PC := 74
 71 [-]: GETTABLE  R10 R5 R9    ; R10 := R5[R9]
 72 [-]: GETTABLE  R4 R10 K23   ; R4 := R10["mItemCount"]
 73 [-]: JMP       75           ; PC := 75
 74 [-]: FORLOOP   R6 61        ; R6 += R8; if R6 <= R7 then begin PC := 61; R9 := R6 end
 75 [-]: GETUPVAL  R10 U1       ; R10 := U1
 76 [-]: SELF      R10 R10 K24  ; R11 := R10; R10 := R10["0x85D4CA1C"]
 77 [-]: CALL      R10 2 2      ; R10 := R10(R11)
 78 [-]: LOADK     R11 K22      ; R11 := 1
 79 [-]: LEN       R12 R10      ; R12 := # R10
 80 [-]: LOADK     R13 K22      ; R13 := 1
 81 [-]: FORPREP   R11 89       ; R11 -= R13; PC := 89
 82 [-]: GETTABLE  R15 R10 R14  ; R15 := R10[R14]
 83 [-]: GETTABLE  R15 R15 K19  ; R15 := R15["mItemType"]
 84 [-]: GETTABLE  R16 R3 K11   ; R16 := R3["StoreItemInfo"]
 85 [-]: GETTABLE  R16 R16 K20  ; R16 := R16["Type"]
 86 [-]: EQ        0 R15 R16    ; if R15 ~= R16 then PC := 89
 87 [-]: JMP       89           ; PC := 89
 88 [-]: ADD       R4 R4 K22    ; R4 := R4 + 1
 89 [-]: FORLOOP   R11 82       ; R11 += R13; if R11 <= R12 then begin PC := 82; R14 := R11 end
 90 [-]: SETTABLE  R3 K25 R4    ; R3["NumOwned"] := R4
 91 [-]: GETUPVAL  R15 U2       ; R15 := U2
 92 [-]: GETTABLE  R15 R15 K26  ; R15 := R15["0x59A3B972"]
 93 [-]: GETGLOBAL R16 K4       ; R16 := mMovie
 94 [-]: NEWTABLE  R17 0 0      ; R17 := {}
 95 [-]: GETTABLE  R18 R3 K11   ; R18 := R3["StoreItemInfo"]
 96 [-]: NEWTABLE  R19 0 3      ; R19 := {}
 97 [-]: SETTABLE  R19 K27 K1   ; R19["ZoomYShift"] := 0
 98 [-]: SETTABLE  R19 K28 K29  ; R19["IsFocused"] := "0x1"
 99 [-]: SETTABLE  R19 K30 K29  ; R19["DisableSaturation"] := "0x1"
100 [-]: CALL      R15 5 1      ; R15(R16,R17,R18,R19)
101 [-]: GETGLOBAL R15 K3       ; R15 := 0x400E7765
102 [-]: GETTABLE  R16 R3 K31   ; R16 := R3["Syndicate"]
103 [-]: CALL      R15 2 2      ; R15 := R15(R16)
104 [-]: MOVE      R15 R15      ; R15 := R15
105 [-]: GETGLOBAL R16 K4       ; R16 := mMovie
106 [-]: SELF      R16 R16 K32  ; R17 := R16; R16 := R16["0x880196A7"]
107 [-]: MOVE      R18 R1       ; R18 := R1
108 [-]: LOADK     R19 K33      ; R19 := "SyndicateInfo"
109 [-]: LOADK     R20 K7       ; R20 := "_visible"
110 [-]: MOVE      R21 R15      ; R21 := R15
111 [-]: CALL      R16 6 1      ; R16(R17,R18,R19,R20,R21)
112 [-]: GETGLOBAL R16 K3       ; R16 := 0x400E7765
113 [-]: GETTABLE  R17 R3 K31   ; R17 := R3["Syndicate"]
114 [-]: CALL      R16 2 2      ; R16 := R16(R17)
115 [-]: TEST      R16 1        ; if R16 then PC := 134
116 [-]: JMP       134          ; PC := 134
117 [-]: GETUPVAL  R16 U3       ; R16 := U3
118 [-]: GETTABLE  R16 R16 K34  ; R16 := R16["0x55780EE6"]
119 [-]: GETGLOBAL R17 K4       ; R17 := mMovie
120 [-]: GETUPVAL  R18 U4       ; R18 := U4
121 [-]: GETTABLE  R19 R3 K31   ; R19 := R3["Syndicate"]
122 [-]: CALL      R16 4 1      ; R16(R17,R18,R19)
123 [-]: GETGLOBAL R16 K4       ; R16 := mMovie
124 [-]: SELF      R16 R16 K32  ; R17 := R16; R16 := R16["0x880196A7"]
125 [-]: MOVE      R18 R1       ; R18 := R1
126 [-]: LOADK     R19 K33      ; R19 := "SyndicateInfo"
127 [-]: LOADK     R20 K35      ; R20 := "_y"
128 [-]: ADD       R21 R2 K36   ; R21 := R2 + 5
129 [-]: CALL      R16 6 1      ; R16(R17,R18,R19,R20,R21)
130 [-]: GETUPVAL  R16 U4       ; R16 := U4
131 [-]: GETTABLE  R16 R16 K37  ; R16 := R16["mHeight"]
132 [-]: ADD       R16 R2 R16   ; R16 := R2 + R16
133 [-]: ADD       R2 R16 K38   ; R2 := R16 + 25
134 [-]: GETGLOBAL R16 K4       ; R16 := mMovie
135 [-]: SELF      R16 R16 K32  ; R17 := R16; R16 := R16["0x880196A7"]
136 [-]: MOVE      R18 R1       ; R18 := R1
137 [-]: LOADK     R19 K39      ; R19 := "ItemName"
138 [-]: LOADK     R20 K35      ; R20 := "_y"
139 [-]: MOVE      R21 R2       ; R21 := R2
140 [-]: CALL      R16 6 1      ; R16(R17,R18,R19,R20,R21)
141 [-]: GETGLOBAL R16 K4       ; R16 := mMovie
142 [-]: SELF      R16 R16 K40  ; R17 := R16; R16 := R16["0x17028E8F"]
143 [-]: MOVE      R18 R1       ; R18 := R1
144 [-]: LOADK     R19 K41      ; R19 := ".ItemName.text"
145 [-]: CONCAT    R18 R18 R19  ; R18 := R18 .. R19
146 [-]: GETTABLE  R19 R3 K39   ; R19 := R3["ItemName"]
147 [-]: CALL      R16 4 1      ; R16(R17,R18,R19)
148 [-]: GETTABLE  R16 R3 K39   ; R16 := R3["ItemName"]
149 [-]: EQ        1 R16 K42    ; if R16 == "" then PC := 162
150 [-]: JMP       162          ; PC := 162
151 [-]: GETGLOBAL R16 K43      ; R16 := 0xF595ADDE
152 [-]: GETGLOBAL R17 K4       ; R17 := mMovie
153 [-]: SELF      R17 R17 K44  ; R18 := R17; R17 := R17["0x6B7B470B"]
154 [-]: MOVE      R19 R1       ; R19 := R1
155 [-]: LOADK     R20 K45      ; R20 := ".ItemName"
156 [-]: CONCAT    R19 R19 R20  ; R19 := R19 .. R20
157 [-]: LOADK     R20 K46      ; R20 := "textHeight"
158 [-]: CALL      R17 4 0      ; R17,... := R17(R18,R19,R20)
159 [-]: CALL      R16 0 2      ; R16 := R16(R17,...)
160 [-]: ADD       R17 R2 R16   ; R17 := R2 + R16
161 [-]: ADD       R2 R17 K36   ; R2 := R17 + 5
162 [-]: GETGLOBAL R17 K4       ; R17 := mMovie
163 [-]: SELF      R17 R17 K32  ; R18 := R17; R17 := R17["0x880196A7"]
164 [-]: MOVE      R19 R1       ; R19 := R1
165 [-]: LOADK     R20 K39      ; R20 := "ItemName"
166 [-]: LOADK     R21 K47      ; R21 := "cursorPos"
167 [-]: LOADK     R22 K48      ; R22 := 1000
168 [-]: CALL      R17 6 1      ; R17(R18,R19,R20,R21,R22)
169 [-]: GETGLOBAL R17 K43      ; R17 := 0xF595ADDE
170 [-]: GETGLOBAL R18 K4       ; R18 := mMovie
171 [-]: SELF      R18 R18 K44  ; R19 := R18; R18 := R18["0x6B7B470B"]
172 [-]: MOVE      R20 R1       ; R20 := R1
173 [-]: LOADK     R21 K45      ; R21 := ".ItemName"
174 [-]: CONCAT    R20 R20 R21  ; R20 := R20 .. R21
175 [-]: LOADK     R21 K49      ; R21 := "cursorX"
176 [-]: CALL      R18 4 0      ; R18,... := R18(R19,R20,R21)
177 [-]: CALL      R17 0 2      ; R17 := R17(R18,...)
178 [-]: GETGLOBAL R18 K4       ; R18 := mMovie
179 [-]: SELF      R18 R18 K32  ; R19 := R18; R18 := R18["0x880196A7"]
180 [-]: MOVE      R20 R1       ; R20 := R1
181 [-]: LOADK     R21 K50      ; R21 := "Wishlist"
182 [-]: LOADK     R22 K51      ; R22 := "_x"
183 [-]: MOVE      R23 R17      ; R23 := R17
184 [-]: CALL      R18 6 1      ; R18(R19,R20,R21,R22,R23)
185 [-]: GETGLOBAL R18 K4       ; R18 := mMovie
186 [-]: SELF      R18 R18 K32  ; R19 := R18; R18 := R18["0x880196A7"]
187 [-]: MOVE      R20 R1       ; R20 := R1
188 [-]: LOADK     R21 K50      ; R21 := "Wishlist"
189 [-]: LOADK     R22 K35      ; R22 := "_y"
190 [-]: SUB       R23 R2 K52   ; R23 := R2 - 27
191 [-]: CALL      R18 6 1      ; R18(R19,R20,R21,R22,R23)
192 [-]: GETGLOBAL R18 K4       ; R18 := mMovie
193 [-]: SELF      R18 R18 K32  ; R19 := R18; R18 := R18["0x880196A7"]
194 [-]: MOVE      R20 R1       ; R20 := R1
195 [-]: LOADK     R21 K53      ; R21 := "Owned"
196 [-]: LOADK     R22 K35      ; R22 := "_y"
197 [-]: ADD       R23 R2 K54   ; R23 := R2 + 10
198 [-]: CALL      R18 6 1      ; R18(R19,R20,R21,R22,R23)
199 [-]: GETGLOBAL R18 K4       ; R18 := mMovie
200 [-]: SELF      R18 R18 K32  ; R19 := R18; R18 := R18["0x880196A7"]
201 [-]: MOVE      R20 R1       ; R20 := R1
202 [-]: LOADK     R21 K55      ; R21 := "RankLock"
203 [-]: LOADK     R22 K35      ; R22 := "_y"
204 [-]: ADD       R23 R2 K54   ; R23 := R2 + 10
205 [-]: CALL      R18 6 1      ; R18(R19,R20,R21,R22,R23)
206 [-]: GETTABLE  R18 R3 K25   ; R18 := R3["NumOwned"]
207 [-]: LT        1 K1 R18     ; if 0 < R18 then PC := 210
208 [-]: JMP       210          ; PC := 210
209 [-]: MOVE      R18 R0       ; R18 := R0
210 [-]: MOVE      R18 R1       ; R18 := R1
211 [-]: GETGLOBAL R19 K4       ; R19 := mMovie
212 [-]: SELF      R19 R19 K32  ; R20 := R19; R19 := R19["0x880196A7"]
213 [-]: MOVE      R21 R1       ; R21 := R1
214 [-]: LOADK     R22 K53      ; R22 := "Owned"
215 [-]: LOADK     R23 K7       ; R23 := "_visible"
216 [-]: MOVE      R24 R18      ; R24 := R18
217 [-]: CALL      R19 6 1      ; R19(R20,R21,R22,R23,R24)
218 [-]: TEST      R18 0        ; if not R18 then PC := 233
219 [-]: JMP       233          ; PC := 233
220 [-]: GETGLOBAL R19 K4       ; R19 := mMovie
221 [-]: SELF      R19 R19 K40  ; R20 := R19; R19 := R19["0x17028E8F"]
222 [-]: MOVE      R21 R1       ; R21 := R1
223 [-]: LOADK     R22 K56      ; R22 := ".Owned.Label.text"
224 [-]: CONCAT    R21 R21 R22  ; R21 := R21 .. R22
225 [-]: LOADK     R22 K57      ; R22 := "/Lotus/Language/Menu/Crafting_Owned"
226 [-]: NEWTABLE  R23 0 1      ; R23 := {}
227 [-]: GETUPVAL  R24 U5       ; R24 := U5
228 [-]: GETTABLE  R24 R24 K59  ; R24 := R24["0x7E197415"]
229 [-]: GETTABLE  R25 R3 K25   ; R25 := R3["NumOwned"]
230 [-]: CALL      R24 2 2      ; R24 := R24(R25)
231 [-]: SETTABLE  R23 K58 R24  ; R23["HOW_MANY"] := R24
232 [-]: CALL      R19 5 1      ; R19(R20,R21,R22,R23)
233 [-]: GETTABLE  R19 R3 K60   ; R19 := R3["RecipesOwned"]
234 [-]: EQ        1 R19 K61    ; if R19 == nil then PC := 239
235 [-]: JMP       239          ; PC := 239
236 [-]: GETTABLE  R19 R3 K60   ; R19 := R3["RecipesOwned"]
237 [-]: LT        1 K1 R19     ; if 0 < R19 then PC := 240
238 [-]: JMP       240          ; PC := 240
239 [-]: MOVE      R19 R0       ; R19 := R0
240 [-]: MOVE      R19 R1       ; R19 := R1
241 [-]: GETUPVAL  R20 U6       ; R20 := U6
242 [-]: GETTABLE  R20 R20 K62  ; R20 := R20["0x29844C14"]
243 [-]: GETTABLE  R21 R3 K63   ; R21 := R3["StoreItem"]
244 [-]: CALL      R20 2 3      ; R20,R21 := R20(R21)
245 [-]: EQ        1 R21 K61    ; if R21 == nil then PC := 249
246 [-]: JMP       249          ; PC := 249
247 [-]: LT        1 K1 R21     ; if 0 < R21 then PC := 250
248 [-]: JMP       250          ; PC := 250
249 [-]: MOVE      R22 R0       ; R22 := R0
250 [-]: MOVE      R22 R1       ; R22 := R1
251 [-]: MOVE      R23 R0       ; R23 := R0
252 [-]: GETGLOBAL R24 K4       ; R24 := mMovie
253 [-]: SELF      R24 R24 K32  ; R25 := R24; R24 := R24["0x880196A7"]
254 [-]: MOVE      R26 R1       ; R26 := R1
255 [-]: LOADK     R27 K55      ; R27 := "RankLock"
256 [-]: LOADK     R28 K7       ; R28 := "_visible"
257 [-]: MOVE      R29 R22      ; R29 := R22
258 [-]: CALL      R24 6 1      ; R24(R25,R26,R27,R28,R29)
259 [-]: TEST      R22 0        ; if not R22 then PC := 296
260 [-]: JMP       296          ; PC := 296
261 [-]: GETGLOBAL R24 K4       ; R24 := mMovie
262 [-]: SELF      R24 R24 K32  ; R25 := R24; R24 := R24["0x880196A7"]
263 [-]: MOVE      R26 R1       ; R26 := R1
264 [-]: LOADK     R27 K64      ; R27 := "RankLock.Rank"
265 [-]: LOADK     R28 K65      ; R28 := "text"
266 [-]: MOVE      R29 R21      ; R29 := R21
267 [-]: CALL      R24 6 1      ; R24(R25,R26,R27,R28,R29)
268 [-]: GETGLOBAL R24 K4       ; R24 := mMovie
269 [-]: SELF      R24 R24 K40  ; R25 := R24; R24 := R24["0x17028E8F"]
270 [-]: MOVE      R26 R1       ; R26 := R1
271 [-]: LOADK     R27 K66      ; R27 := ".RankLock.Label.text"
272 [-]: CONCAT    R26 R26 R27  ; R26 := R26 .. R27
273 [-]: LOADK     R27 K67      ; R27 := "/Lotus/Language/Menu/DetailedPurchase_MasteryLocked"
274 [-]: CALL      R24 4 1      ; R24(R25,R26,R27)
275 [-]: LOADK     R24 K68      ; R24 := -11
276 [-]: TEST      R18 0        ; if not R18 then PC := 289
277 [-]: JMP       289          ; PC := 289
278 [-]: GETGLOBAL R25 K43      ; R25 := 0xF595ADDE
279 [-]: GETGLOBAL R26 K4       ; R26 := mMovie
280 [-]: SELF      R26 R26 K44  ; R27 := R26; R26 := R26["0x6B7B470B"]
281 [-]: MOVE      R28 R1       ; R28 := R1
282 [-]: LOADK     R29 K69      ; R29 := ".Owned.Label"
283 [-]: CONCAT    R28 R28 R29  ; R28 := R28 .. R29
284 [-]: LOADK     R29 K70      ; R29 := "textWidth"
285 [-]: CALL      R26 4 0      ; R26,... := R26(R27,R28,R29)
286 [-]: CALL      R25 0 2      ; R25 := R25(R26,...)
287 [-]: ADD       R26 R24 R25  ; R26 := R24 + R25
288 [-]: ADD       R24 R26 K71  ; R24 := R26 + 40
289 [-]: GETGLOBAL R26 K4       ; R26 := mMovie
290 [-]: SELF      R26 R26 K32  ; R27 := R26; R26 := R26["0x880196A7"]
291 [-]: MOVE      R28 R1       ; R28 := R1
292 [-]: LOADK     R29 K55      ; R29 := "RankLock"
293 [-]: LOADK     R30 K51      ; R30 := "_x"
294 [-]: MOVE      R31 R24      ; R31 := R24
295 [-]: CALL      R26 6 1      ; R26(R27,R28,R29,R30,R31)
296 [-]: TEST      R18 1        ; if R18 then PC := 300
297 [-]: JMP       300          ; PC := 300
298 [-]: TEST      R22 0        ; if not R22 then PC := 309
299 [-]: JMP       309          ; PC := 309
300 [-]: GETUPVAL  R26 U5       ; R26 := U5
301 [-]: GETTABLE  R26 R26 K72  ; R26 := R26["0xF81722A2"]
302 [-]: TESTSET   R27 R19 1    ; if R19 then PC := 305 else R27 := R19
303 [-]: JMP       305          ; PC := 305
304 [-]: MOVE      R27 R23      ; R27 := R23
305 [-]: LOADK     R28 K73      ; R28 := 35
306 [-]: LOADK     R29 K74      ; R29 := 50
307 [-]: CALL      R26 4 2      ; R26 := R26(R27,R28,R29)
308 [-]: ADD       R2 R2 R26    ; R2 := R2 + R26
309 [-]: TEST      R23 0        ; if not R23 then PC := 325
310 [-]: JMP       325          ; PC := 325
311 [-]: GETGLOBAL R26 K4       ; R26 := mMovie
312 [-]: SELF      R26 R26 K32  ; R27 := R26; R26 := R26["0x880196A7"]
313 [-]: MOVE      R28 R1       ; R28 := R1
314 [-]: LOADK     R29 K75      ; R29 := "Mastered"
315 [-]: LOADK     R30 K35      ; R30 := "_y"
316 [-]: ADD       R31 R2 K54   ; R31 := R2 + 10
317 [-]: CALL      R26 6 1      ; R26(R27,R28,R29,R30,R31)
318 [-]: GETUPVAL  R26 U5       ; R26 := U5
319 [-]: GETTABLE  R26 R26 K72  ; R26 := R26["0xF81722A2"]
320 [-]: MOVE      R27 R19      ; R27 := R19
321 [-]: LOADK     R28 K73      ; R28 := 35
322 [-]: LOADK     R29 K74      ; R29 := 50
323 [-]: CALL      R26 4 2      ; R26 := R26(R27,R28,R29)
324 [-]: ADD       R2 R2 R26    ; R2 := R2 + R26
325 [-]: GETGLOBAL R26 K4       ; R26 := mMovie
326 [-]: SELF      R26 R26 K32  ; R27 := R26; R26 := R26["0x880196A7"]
327 [-]: MOVE      R28 R1       ; R28 := R1
328 [-]: LOADK     R29 K75      ; R29 := "Mastered"
329 [-]: LOADK     R30 K7       ; R30 := "_visible"
330 [-]: MOVE      R31 R23      ; R31 := R23
331 [-]: CALL      R26 6 1      ; R26(R27,R28,R29,R30,R31)
332 [-]: TEST      R19 0        ; if not R19 then PC := 366
333 [-]: JMP       366          ; PC := 366
334 [-]: GETGLOBAL R26 K4       ; R26 := mMovie
335 [-]: SELF      R26 R26 K32  ; R27 := R26; R26 := R26["0x880196A7"]
336 [-]: MOVE      R28 R1       ; R28 := R1
337 [-]: LOADK     R29 K60      ; R29 := "RecipesOwned"
338 [-]: LOADK     R30 K35      ; R30 := "_y"
339 [-]: ADD       R31 R2 K54   ; R31 := R2 + 10
340 [-]: CALL      R26 6 1      ; R26(R27,R28,R29,R30,R31)
341 [-]: GETTABLE  R26 R3 K60   ; R26 := R3["RecipesOwned"]
342 [-]: EQ        0 R26 K22    ; if R26 ~= 1 then PC := 352
343 [-]: JMP       352          ; PC := 352
344 [-]: GETGLOBAL R26 K4       ; R26 := mMovie
345 [-]: SELF      R26 R26 K40  ; R27 := R26; R26 := R26["0x17028E8F"]
346 [-]: MOVE      R28 R1       ; R28 := R1
347 [-]: LOADK     R29 K76      ; R29 := ".RecipesOwned.Label.text"
348 [-]: CONCAT    R28 R28 R29  ; R28 := R28 .. R29
349 [-]: LOADK     R29 K77      ; R29 := "/Lotus/Language/CraftingComponents/RecipeOwnedSingular"
350 [-]: CALL      R26 4 1      ; R26(R27,R28,R29)
351 [-]: JMP       365          ; PC := 365
352 [-]: GETGLOBAL R26 K4       ; R26 := mMovie
353 [-]: SELF      R26 R26 K40  ; R27 := R26; R26 := R26["0x17028E8F"]
354 [-]: MOVE      R28 R1       ; R28 := R1
355 [-]: LOADK     R29 K76      ; R29 := ".RecipesOwned.Label.text"
356 [-]: CONCAT    R28 R28 R29  ; R28 := R28 .. R29
357 [-]: LOADK     R29 K78      ; R29 := "/Lotus/Language/CraftingComponents/RecipeOwnedPlural"
358 [-]: NEWTABLE  R30 0 1      ; R30 := {}
359 [-]: GETUPVAL  R31 U5       ; R31 := U5
360 [-]: GETTABLE  R31 R31 K59  ; R31 := R31["0x7E197415"]
361 [-]: GETTABLE  R32 R3 K60   ; R32 := R3["RecipesOwned"]
362 [-]: CALL      R31 2 2      ; R31 := R31(R32)
363 [-]: SETTABLE  R30 K79 R31  ; R30["COUNT"] := R31
364 [-]: CALL      R26 5 1      ; R26(R27,R28,R29,R30)
365 [-]: ADD       R2 R2 K74    ; R2 := R2 + 50
366 [-]: GETGLOBAL R26 K4       ; R26 := mMovie
367 [-]: SELF      R26 R26 K32  ; R27 := R26; R26 := R26["0x880196A7"]
368 [-]: MOVE      R28 R1       ; R28 := R1
369 [-]: LOADK     R29 K60      ; R29 := "RecipesOwned"
370 [-]: LOADK     R30 K7       ; R30 := "_visible"
371 [-]: MOVE      R31 R19      ; R31 := R19
372 [-]: CALL      R26 6 1      ; R26(R27,R28,R29,R30,R31)
373 [-]: GETTABLE  R26 R3 K80   ; R26 := R3["ItemDesc"]
374 [-]: GETGLOBAL R27 K4       ; R27 := mMovie
375 [-]: SELF      R27 R27 K32  ; R28 := R27; R27 := R27["0x880196A7"]
376 [-]: MOVE      R29 R1       ; R29 := R1
377 [-]: LOADK     R30 K81      ; R30 := "Description"
378 [-]: LOADK     R31 K35      ; R31 := "_y"
379 [-]: MOVE      R32 R2       ; R32 := R2
380 [-]: CALL      R27 6 1      ; R27(R28,R29,R30,R31,R32)
381 [-]: GETGLOBAL R27 K4       ; R27 := mMovie
382 [-]: SELF      R27 R27 K82  ; R28 := R27; R27 := R27["0xD6A79FE9"]
383 [-]: MOVE      R29 R1       ; R29 := R1
384 [-]: LOADK     R30 K83      ; R30 := ".Description"
385 [-]: CONCAT    R29 R29 R30  ; R29 := R29 .. R30
386 [-]: LOADK     R30 K65      ; R30 := "text"
387 [-]: MOVE      R31 R26      ; R31 := R26
388 [-]: CALL      R27 5 1      ; R27(R28,R29,R30,R31)
389 [-]: EQ        1 R26 K42    ; if R26 == "" then PC := 402
390 [-]: JMP       402          ; PC := 402
391 [-]: GETGLOBAL R27 K43      ; R27 := 0xF595ADDE
392 [-]: GETGLOBAL R28 K4       ; R28 := mMovie
393 [-]: SELF      R28 R28 K44  ; R29 := R28; R28 := R28["0x6B7B470B"]
394 [-]: MOVE      R30 R1       ; R30 := R1
395 [-]: LOADK     R31 K83      ; R31 := ".Description"
396 [-]: CONCAT    R30 R30 R31  ; R30 := R30 .. R31
397 [-]: LOADK     R31 K46      ; R31 := "textHeight"
398 [-]: CALL      R28 4 0      ; R28,... := R28(R29,R30,R31)
399 [-]: CALL      R27 0 2      ; R27 := R27(R28,...)
400 [-]: ADD       R27 R2 R27   ; R27 := R2 + R27
401 [-]: ADD       R2 R27 K84   ; R2 := R27 + 15
402 [-]: GETUPVAL  R27 U7       ; R27 := U7
403 [-]: SELF      R27 R27 K85  ; R28 := R27; R27 := R27["0xD9B67B05"]
404 [-]: CALL      R27 2 1      ; R27(R28)
405 [-]: GETGLOBAL R27 K4       ; R27 := mMovie
406 [-]: SELF      R27 R27 K32  ; R28 := R27; R27 := R27["0x880196A7"]
407 [-]: MOVE      R29 R1       ; R29 := R1
408 [-]: LOADK     R30 K86      ; R30 := "AbilityList"
409 [-]: LOADK     R31 K7       ; R31 := "_visible"
410 [-]: GETUPVAL  R32 U8       ; R32 := U8
411 [-]: GETTABLE  R32 R32 K87  ; R32 := R32["mIsSuitCat"]
412 [-]: CALL      R27 6 1      ; R27(R28,R29,R30,R31,R32)
413 [-]: GETUPVAL  R27 U8       ; R27 := U8
414 [-]: GETTABLE  R27 R27 K87  ; R27 := R27["mIsSuitCat"]
415 [-]: TEST      R27 0        ; if not R27 then PC := 451
416 [-]: JMP       451          ; PC := 451
417 [-]: LOADNIL   R27 R27      ; R27 := nil
418 [-]: GETTABLE  R28 R3 K63   ; R28 := R3["StoreItem"]
419 [-]: SELF      R28 R28 K88  ; R29 := R28; R28 := R28["0x8B598ED4"]
420 [-]: GETGLOBAL R30 K89      ; R30 := gRecipeStoreItemType
421 [-]: CALL      R28 3 2      ; R28 := R28(R29,R30)
422 [-]: TEST      R28 0        ; if not R28 then PC := 431
423 [-]: JMP       431          ; PC := 431
424 [-]: GETTABLE  R28 R3 K63   ; R28 := R3["StoreItem"]
425 [-]: SELF      R28 R28 K90  ; R29 := R28; R28 := R28["0xCF3F0AF8"]
426 [-]: CALL      R28 2 2      ; R28 := R28(R29)
427 [-]: SELF      R28 R28 K91  ; R29 := R28; R28 := R28["0x3077BE70"]
428 [-]: CALL      R28 2 2      ; R28 := R28(R29)
429 [-]: MOVE      R27 R28      ; R27 := R28
430 [-]: JMP       435          ; PC := 435
431 [-]: GETTABLE  R28 R3 K63   ; R28 := R3["StoreItem"]
432 [-]: SELF      R28 R28 K91  ; R29 := R28; R28 := R28["0x3077BE70"]
433 [-]: CALL      R28 2 2      ; R28 := R28(R29)
434 [-]: MOVE      R27 R28      ; R27 := R28
435 [-]: GETUPVAL  R28 U9       ; R28 := U9
436 [-]: SELF      R28 R28 K92  ; R29 := R28; R28 := R28["0xB66B3F0B"]
437 [-]: MOVE      R30 R27      ; R30 := R27
438 [-]: MOVE      R31 R0       ; R31 := R0
439 [-]: MOVE      R32 R0       ; R32 := R0
440 [-]: MOVE      R33 R0       ; R33 := R0
441 [-]: MOVE      R34 R1       ; R34 := R1
442 [-]: CALL      R28 7 1      ; R28(R29,R30,R31,R32,R33,R34)
443 [-]: GETGLOBAL R28 K4       ; R28 := mMovie
444 [-]: SELF      R28 R28 K32  ; R29 := R28; R28 := R28["0x880196A7"]
445 [-]: MOVE      R30 R1       ; R30 := R1
446 [-]: LOADK     R31 K86      ; R31 := "AbilityList"
447 [-]: LOADK     R32 K35      ; R32 := "_y"
448 [-]: ADD       R33 R2 K93   ; R33 := R2 + 75
449 [-]: CALL      R28 6 1      ; R28(R29,R30,R31,R32,R33)
450 [-]: ADD       R2 R2 K94    ; R2 := R2 + 80
451 [-]: GETUPVAL  R28 U10      ; R28 := U10
452 [-]: ADD       R29 R2 K54   ; R29 := R2 + 10
453 [-]: SETTABLE  R28 K95 R29  ; R28["PurchaseConfirmY"] := R29
454 [-]: GETGLOBAL R28 K4       ; R28 := mMovie
455 [-]: SELF      R28 R28 K32  ; R29 := R28; R28 := R28["0x880196A7"]
456 [-]: MOVE      R30 R1       ; R30 := R1
457 [-]: LOADK     R31 K96      ; R31 := "PurchaseConfirm"
458 [-]: LOADK     R32 K35      ; R32 := "_y"
459 [-]: MOVE      R33 R2       ; R33 := R2
460 [-]: CALL      R28 6 1      ; R28(R29,R30,R31,R32,R33)
461 [-]: GETGLOBAL R28 K4       ; R28 := mMovie
462 [-]: SELF      R28 R28 K32  ; R29 := R28; R28 := R28["0x880196A7"]
463 [-]: MOVE      R30 R1       ; R30 := R1
464 [-]: LOADK     R31 K97      ; R31 := "Options"
465 [-]: LOADK     R32 K35      ; R32 := "_y"
466 [-]: MOVE      R33 R2       ; R33 := R2
467 [-]: CALL      R28 6 1      ; R28(R29,R30,R31,R32,R33)
468 [-]: GETUPVAL  R28 U11      ; R28 := U11
469 [-]: GETTABLE  R28 R28 K98  ; R28 := R28["CustomizationList"]
470 [-]: SELF      R28 R28 K99  ; R29 := R28; R28 := R28["0xC51A5C9D"]
471 [-]: CALL      R28 2 2      ; R28 := R28(R29)
472 [-]: GETUPVAL  R29 U11      ; R29 := U11
473 [-]: GETTABLE  R29 R29 K98  ; R29 := R29["CustomizationList"]
474 [-]: GETTABLE  R29 R29 K100 ; R29 := R29["mForcedVerticalSeparation"]
475 [-]: MUL       R28 R28 R29  ; R28 := R28 * R29
476 [-]: ADD       R2 R2 R28    ; R2 := R2 + R28
477 [-]: GETTABLE  R28 R3 K101  ; R28 := R3["ParentBundles"]
478 [-]: EQ        1 R28 K61    ; if R28 == nil then PC := 484
479 [-]: JMP       484          ; PC := 484
480 [-]: GETTABLE  R28 R3 K101  ; R28 := R3["ParentBundles"]
481 [-]: LEN       R28 R28      ; R28 := # R28
482 [-]: LT        1 K1 R28     ; if 0 < R28 then PC := 485
483 [-]: JMP       485          ; PC := 485
484 [-]: MOVE      R28 R0       ; R28 := R0
485 [-]: MOVE      R28 R1       ; R28 := R1
486 [-]: GETGLOBAL R29 K4       ; R29 := mMovie
487 [-]: SELF      R29 R29 K32  ; R30 := R29; R29 := R29["0x880196A7"]
488 [-]: MOVE      R31 R1       ; R31 := R1
489 [-]: LOADK     R32 K101     ; R32 := "ParentBundles"
490 [-]: LOADK     R33 K7       ; R33 := "_visible"
491 [-]: TESTSET   R34 R28 0    ; if not R28 then PC := 500 else R34 := R28
492 [-]: JMP       500          ; PC := 500
493 [-]: GETUPVAL  R34 U12      ; R34 := U12
494 [-]: GETUPVAL  R35 U13      ; R35 := U13
495 [-]: GETTABLE  R35 R35 K102 ; R35 := R35["BASE"]
496 [-]: EQ        1 R34 R35    ; if R34 == R35 then PC := 499
497 [-]: JMP       499          ; PC := 499
498 [-]: MOVE      R34 R0       ; R34 := R0
499 [-]: MOVE      R34 R1       ; R34 := R1
500 [-]: CALL      R29 6 1      ; R29(R30,R31,R32,R33,R34)
501 [-]: TEST      R28 0        ; if not R28 then PC := 551
502 [-]: JMP       551          ; PC := 551
503 [-]: GETUPVAL  R29 U14      ; R29 := U14
504 [-]: SELF      R29 R29 K103 ; R30 := R29; R29 := R29["0x7CF71D03"]
505 [-]: MOVE      R31 R1       ; R31 := R1
506 [-]: MOVE      R32 R1       ; R32 := R1
507 [-]: CALL      R29 4 1      ; R29(R30,R31,R32)
508 [-]: LOADK     R29 K22      ; R29 := 1
509 [-]: GETTABLE  R30 R3 K101  ; R30 := R3["ParentBundles"]
510 [-]: LEN       R30 R30      ; R30 := # R30
511 [-]: LOADK     R31 K22      ; R31 := 1
512 [-]: FORPREP   R29 530      ; R29 -= R31; PC := 530
513 [-]: GETUPVAL  R33 U14      ; R33 := U14
514 [-]: SELF      R33 R33 K104 ; R34 := R33; R33 := R33["0xA77DA8EE"]
515 [-]: NEWTABLE  R35 0 2      ; R35 := {}
516 [-]: GETTABLE  R36 R3 K101  ; R36 := R3["ParentBundles"]
517 [-]: GETTABLE  R36 R36 R32  ; R36 := R36[R32]
518 [-]: SETTABLE  R35 K63 R36  ; R35["StoreItem"] := R36
519 [-]: GETUPVAL  R36 U15      ; R36 := U15
520 [-]: GETTABLE  R36 R36 K106 ; R36 := R36["0x1B75557F"]
521 [-]: GETGLOBAL R37 K4       ; R37 := mMovie
522 [-]: GETTABLE  R38 R3 K101  ; R38 := R3["ParentBundles"]
523 [-]: GETTABLE  R38 R38 R32  ; R38 := R38[R32]
524 [-]: LOADNIL   R39 R41      ; R39 := R40 := R41 := nil
525 [-]: MOVE      R42 R1       ; R42 := R1
526 [-]: CALL      R36 7 2      ; R36 := R36(R37,R38,R39,R40,R41,R42)
527 [-]: SETTABLE  R35 K105 R36 ; R35["Info"] := R36
528 [-]: MOVE      R36 R1       ; R36 := R1
529 [-]: CALL      R33 4 1      ; R33(R34,R35,R36)
530 [-]: FORLOOP   R29 513      ; R29 += R31; if R29 <= R30 then begin PC := 513; R32 := R29 end
531 [-]: GETUPVAL  R33 U14      ; R33 := U14
532 [-]: SELF      R33 R33 K107 ; R34 := R33; R33 := R33["0x6470BAF4"]
533 [-]: CALL      R33 2 1      ; R33(R34)
534 [-]: GETGLOBAL R33 K4       ; R33 := mMovie
535 [-]: SELF      R33 R33 K32  ; R34 := R33; R33 := R33["0x880196A7"]
536 [-]: MOVE      R35 R1       ; R35 := R1
537 [-]: LOADK     R36 K101     ; R36 := "ParentBundles"
538 [-]: LOADK     R37 K35      ; R37 := "_y"
539 [-]: ADD       R38 R2 K54   ; R38 := R2 + 10
540 [-]: CALL      R33 6 1      ; R33(R34,R35,R36,R37,R38)
541 [-]: GETUPVAL  R33 U14      ; R33 := U14
542 [-]: GETTABLE  R33 R33 K108 ; R33 := R33["mInitialY"]
543 [-]: ADD       R33 R2 R33   ; R33 := R2 + R33
544 [-]: GETUPVAL  R34 U14      ; R34 := U14
545 [-]: SELF      R34 R34 K99  ; R35 := R34; R34 := R34["0xC51A5C9D"]
546 [-]: CALL      R34 2 2      ; R34 := R34(R35)
547 [-]: GETUPVAL  R35 U14      ; R35 := U14
548 [-]: GETTABLE  R35 R35 K100 ; R35 := R35["mForcedVerticalSeparation"]
549 [-]: MUL       R34 R34 R35  ; R34 := R34 * R35
550 [-]: ADD       R2 R33 R34   ; R2 := R33 + R34
551 [-]: GETTABLE  R33 R3 K63   ; R33 := R3["StoreItem"]
552 [-]: SELF      R33 R33 K109 ; R34 := R33; R33 := R33["0xC5349ED"]
553 [-]: CALL      R33 2 2      ; R33 := R33(R34)
554 [-]: GETTABLE  R34 R3 K110  ; R34 := R3["Compatibles"]
555 [-]: EQ        1 R34 K61    ; if R34 == nil then PC := 561
556 [-]: JMP       561          ; PC := 561
557 [-]: GETTABLE  R34 R3 K110  ; R34 := R3["Compatibles"]
558 [-]: LEN       R34 R34      ; R34 := # R34
559 [-]: LT        1 K1 R34     ; if 0 < R34 then PC := 562
560 [-]: JMP       562          ; PC := 562
561 [-]: MOVE      R34 R0       ; R34 := R0
562 [-]: MOVE      R34 R1       ; R34 := R1
563 [-]: GETGLOBAL R35 K4       ; R35 := mMovie
564 [-]: SELF      R35 R35 K32  ; R36 := R35; R35 := R35["0x880196A7"]
565 [-]: MOVE      R37 R1       ; R37 := R1
566 [-]: LOADK     R38 K111     ; R38 := "Compatible"
567 [-]: LOADK     R39 K7       ; R39 := "_visible"
568 [-]: TESTSET   R40 R34 0    ; if not R34 then PC := 577 else R40 := R34
569 [-]: JMP       577          ; PC := 577
570 [-]: GETUPVAL  R40 U12      ; R40 := U12
571 [-]: GETUPVAL  R41 U13      ; R41 := U13
572 [-]: GETTABLE  R41 R41 K102 ; R41 := R41["BASE"]
573 [-]: EQ        1 R40 R41    ; if R40 == R41 then PC := 576
574 [-]: JMP       576          ; PC := 576
575 [-]: MOVE      R40 R0       ; R40 := R0
576 [-]: MOVE      R40 R1       ; R40 := R1
577 [-]: CALL      R35 6 1      ; R35(R36,R37,R38,R39,R40)
578 [-]: TEST      R34 0        ; if not R34 then PC := 649
579 [-]: JMP       649          ; PC := 649
580 [-]: GETGLOBAL R35 K4       ; R35 := mMovie
581 [-]: SELF      R35 R35 K40  ; R36 := R35; R35 := R35["0x17028E8F"]
582 [-]: LOADK     R37 K112     ; R37 := "DetailedView.Compatible.Title.text"
583 [-]: LOADK     R38 K113     ; R38 := "/Lotus/Language/Menu/"
584 [-]: GETUPVAL  R39 U5       ; R39 := U5
585 [-]: GETTABLE  R39 R39 K72  ; R39 := R39["0xF81722A2"]
586 [-]: MOVE      R40 R33      ; R40 := R33
587 [-]: LOADK     R41 K114     ; R41 := "DetailedPurchase_PackageCompatibleGeneric"
588 [-]: LOADK     R42 K115     ; R42 := "DetailedPurchase_CompatibleGeneric"
589 [-]: CALL      R39 4 2      ; R39 := R39(R40,R41,R42)
590 [-]: CONCAT    R38 R38 R39  ; R38 := R38 .. R39
591 [-]: CALL      R35 4 1      ; R35(R36,R37,R38)
592 [-]: GETUPVAL  R35 U16      ; R35 := U16
593 [-]: SELF      R35 R35 K116 ; R36 := R35; R35 := R35["0xC4965E8F"]
594 [-]: CALL      R35 2 1      ; R35(R36)
595 [-]: GETUPVAL  R35 U16      ; R35 := U16
596 [-]: SELF      R35 R35 K103 ; R36 := R35; R35 := R35["0x7CF71D03"]
597 [-]: MOVE      R37 R1       ; R37 := R1
598 [-]: MOVE      R38 R1       ; R38 := R1
599 [-]: CALL      R35 4 1      ; R35(R36,R37,R38)
600 [-]: LOADK     R35 K22      ; R35 := 1
601 [-]: GETTABLE  R36 R3 K110  ; R36 := R3["Compatibles"]
602 [-]: LEN       R36 R36      ; R36 := # R36
603 [-]: LOADK     R37 K22      ; R37 := 1
604 [-]: FORPREP   R35 628      ; R35 -= R37; PC := 628
605 [-]: GETUPVAL  R39 U16      ; R39 := U16
606 [-]: SELF      R39 R39 K104 ; R40 := R39; R39 := R39["0xA77DA8EE"]
607 [-]: NEWTABLE  R41 0 3      ; R41 := {}
608 [-]: GETTABLE  R42 R3 K110  ; R42 := R3["Compatibles"]
609 [-]: GETTABLE  R42 R42 R38  ; R42 := R42[R38]
610 [-]: GETTABLE  R42 R42 K63  ; R42 := R42["StoreItem"]
611 [-]: SETTABLE  R41 K63 R42  ; R41["StoreItem"] := R42
612 [-]: GETTABLE  R42 R3 K110  ; R42 := R3["Compatibles"]
613 [-]: GETTABLE  R42 R42 R38  ; R42 := R42[R38]
614 [-]: GETTABLE  R42 R42 K117 ; R42 := R42["LocTag"]
615 [-]: SETTABLE  R41 K117 R42 ; R41["LocTag"] := R42
616 [-]: GETUPVAL  R42 U15      ; R42 := U15
617 [-]: GETTABLE  R42 R42 K106 ; R42 := R42["0x1B75557F"]
618 [-]: GETGLOBAL R43 K4       ; R43 := mMovie
619 [-]: GETTABLE  R44 R3 K110  ; R44 := R3["Compatibles"]
620 [-]: GETTABLE  R44 R44 R38  ; R44 := R44[R38]
621 [-]: GETTABLE  R44 R44 K63  ; R44 := R44["StoreItem"]
622 [-]: LOADNIL   R45 R47      ; R45 := R46 := R47 := nil
623 [-]: MOVE      R48 R1       ; R48 := R1
624 [-]: CALL      R42 7 2      ; R42 := R42(R43,R44,R45,R46,R47,R48)
625 [-]: SETTABLE  R41 K105 R42 ; R41["Info"] := R42
626 [-]: MOVE      R42 R1       ; R42 := R1
627 [-]: CALL      R39 4 1      ; R39(R40,R41,R42)
628 [-]: FORLOOP   R35 605      ; R35 += R37; if R35 <= R36 then begin PC := 605; R38 := R35 end
629 [-]: GETUPVAL  R39 U16      ; R39 := U16
630 [-]: SELF      R39 R39 K107 ; R40 := R39; R39 := R39["0x6470BAF4"]
631 [-]: CALL      R39 2 1      ; R39(R40)
632 [-]: GETGLOBAL R39 K4       ; R39 := mMovie
633 [-]: SELF      R39 R39 K32  ; R40 := R39; R39 := R39["0x880196A7"]
634 [-]: MOVE      R41 R1       ; R41 := R1
635 [-]: LOADK     R42 K111     ; R42 := "Compatible"
636 [-]: LOADK     R43 K35      ; R43 := "_y"
637 [-]: ADD       R44 R2 K54   ; R44 := R2 + 10
638 [-]: CALL      R39 6 1      ; R39(R40,R41,R42,R43,R44)
639 [-]: GETUPVAL  R39 U16      ; R39 := U16
640 [-]: GETTABLE  R39 R39 K108 ; R39 := R39["mInitialY"]
641 [-]: ADD       R39 R2 R39   ; R39 := R2 + R39
642 [-]: GETUPVAL  R40 U16      ; R40 := U16
643 [-]: SELF      R40 R40 K99  ; R41 := R40; R40 := R40["0xC51A5C9D"]
644 [-]: CALL      R40 2 2      ; R40 := R40(R41)
645 [-]: GETUPVAL  R41 U16      ; R41 := U16
646 [-]: GETTABLE  R41 R41 K100 ; R41 := R41["mForcedVerticalSeparation"]
647 [-]: MUL       R40 R40 R41  ; R40 := R40 * R41
648 [-]: ADD       R2 R39 R40   ; R2 := R39 + R40
649 [-]: GETTABLE  R39 R3 K118  ; R39 := R3["ShowCoupon"]
650 [-]: TEST      R39 0        ; if not R39 then PC := 657
651 [-]: JMP       657          ; PC := 657
652 [-]: GETGLOBAL R39 K119     ; R39 := _T
653 [-]: GETTABLE  R39 R39 K120 ; R39 := R39["GiftParams"]
654 [-]: GETTABLE  R40 R3 K122  ; R40 := R3["SalePriceInfo"]
655 [-]: GETTABLE  R40 R40 K123 ; R40 := R40["Price"]
656 [-]: SETTABLE  R39 K121 R40 ; R39["CouponPrice"] := R40
657 [-]: GETGLOBAL R39 K119     ; R39 := _T
658 [-]: GETTABLE  R39 R39 K120 ; R39 := R39["GiftParams"]
659 [-]: GETTABLE  R40 R3 K124  ; R40 := R3["GiftingPrice"]
660 [-]: SETTABLE  R39 K123 R40 ; R39["Price"] := R40
661 [-]: SETTABLE  R0 K125 K61  ; R0["PrevContentHeight"] := nil
662 [-]: SETTABLE  R0 K126 R2   ; R0["ContentHeight"] := R2
663 [-]: GETUPVAL  R39 U17      ; R39 := U17
664 [-]: GETTABLE  R39 R39 K127 ; R39 := R39["HIDE_ITEM_GRID"]
665 [-]: TEST      R39 0        ; if not R39 then PC := 681
666 [-]: JMP       681          ; PC := 681
667 [-]: GETGLOBAL R39 K4       ; R39 := mMovie
668 [-]: SELF      R39 R39 K5   ; R40 := R39; R39 := R39["0x1C19D966"]
669 [-]: LOADK     R41 K128     ; R41 := "ItemGrid"
670 [-]: LOADK     R42 K7       ; R42 := "_visible"
671 [-]: MOVE      R43 R0       ; R43 := R0
672 [-]: CALL      R39 5 1      ; R39(R40,R41,R42,R43)
673 [-]: GETUPVAL  R39 U18      ; R39 := U18
674 [-]: SETTABLE  R39 K129 K130; R39["mVisible"] := "0x0"
675 [-]: GETUPVAL  R39 U18      ; R39 := U18
676 [-]: SELF      R39 R39 K103 ; R40 := R39; R39 := R39["0x7CF71D03"]
677 [-]: MOVE      R41 R1       ; R41 := R1
678 [-]: MOVE      R42 R1       ; R42 := R1
679 [-]: CALL      R39 4 1      ; R39(R40,R41,R42)
680 [-]: JMP       692          ; PC := 692
681 [-]: GETUPVAL  R39 U18      ; R39 := U18
682 [-]: SETTABLE  R39 K129 R33 ; R39["mVisible"] := R33
683 [-]: GETUPVAL  R39 U19      ; R39 := U19
684 [-]: GETTABLE  R40 R3 K63   ; R40 := R3["StoreItem"]
685 [-]: CALL      R39 2 1      ; R39(R40)
686 [-]: GETUPVAL  R39 U18      ; R39 := U18
687 [-]: SELF      R39 R39 K131 ; R40 := R39; R39 := R39["0x26174AC9"]
688 [-]: GETUPVAL  R41 U18      ; R41 := U18
689 [-]: GETTABLE  R41 R41 K132 ; R41 := R41["Mode"]
690 [-]: GETTABLE  R41 R41 K133 ; R41 := R41["PACKAGE"]
691 [-]: CALL      R39 3 1      ; R39(R40,R41)
692 [-]: GETUPVAL  R39 U18      ; R39 := U18
693 [-]: SELF      R39 R39 K107 ; R40 := R39; R39 := R39["0x6470BAF4"]
694 [-]: CALL      R39 2 1      ; R39(R40)
695 [-]: GETUPVAL  R39 U20      ; R39 := U20
696 [-]: CALL      R39 1 1      ; R39()
697 [-]: GETUPVAL  R39 U7       ; R39 := U7
698 [-]: SELF      R39 R39 K134 ; R40 := R39; R39 := R39["0xB7CBA6A1"]
699 [-]: CALL      R39 2 1      ; R39(R40)
