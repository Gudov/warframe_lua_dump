...
; Command line was: -dis C:\wlua_dump\path\Lotus\Interface\PhotoboothUtilities.lua 
...
; Max Stack Size:  15
 ...
 67 [-]: GETGLOBAL R8 K3        ; R8 := _T
 68 [-]: CLOSURE   R9 0         ; R9 := closure(Function #5.1)
 69 [-]: SETTABLE  R8 K22 R9    ; R8["ValidateTile"] := R9
 70 [-]: SELF      R8 R7 K12    ; R9 := R7; R8 := R7["0x458F27A9"]
 71 [-]: LOADK     R10 K23      ; R10 := "SetValidationFunction"
 72 [-]: LOADK     R11 K22      ; R11 := "ValidateTile"
 73 [-]: CALL      R8 4 1       ; R8(R9,R10,R11)
 74 [-]: GETGLOBAL R8 K3        ; R8 := _T
 75 [-]: CLOSURE   R9 1         ; R9 := closure(Function #5.2)
 76 [-]: MOVE      R0 R4        ; R0 := R4
 77 [-]: MOVE      R0 R5        ; R0 := R5
 ...
 84 [-]: SETTABLE  R8 K24 R9    ; R8["BrowseDone"] := R9
 85 [-]: SELF      R8 R7 K12    ; R9 := R7; R8 := R7["0x458F27A9"]
 86 [-]: LOADK     R10 K25      ; R10 := "SetCallBack"
 87 [-]: LOADK     R11 K24      ; R11 := "BrowseDone"
 88 [-]: CALL      R8 4 1       ; R8(R9,R10,R11)
 89 [-]: GETGLOBAL R8 K3        ; R8 := _T
 90 [-]: CLOSURE   R9 2         ; R9 := closure(Function #5.3)
 91 [-]: SETTABLE  R8 K26 R9    ; R8["GetTileSorting"] := R9
 92 [-]: SELF      R8 R7 K12    ; R9 := R7; R8 := R7["0x458F27A9"]
 93 [-]: LOADK     R10 K27      ; R10 := "SetSortByFunction"
 94 [-]: LOADK     R11 K26      ; R11 := "GetTileSorting"
 95 [-]: CALL      R8 4 1       ; R8(R9,R10,R11)
 96 [-]: GETGLOBAL R8 K3        ; R8 := _T
 97 [-]: CLOSURE   R9 3         ; R9 := closure(Function #5.4)
 98 [-]: MOVE      R0 R6        ; R0 := R6
 99 [-]: MOVE      R0 R3        ; R0 := R3
100 [-]: GETUPVAL  R0 U5        ; R0 := U5
101 [-]: SETTABLE  R8 K28 R9    ; R8["GetAllTiles"] := R9
102 [-]: SELF      R8 R7 K12    ; R9 := R7; R8 := R7["0x458F27A9"]
103 [-]: LOADK     R10 K29      ; R10 := "SetElementsFunction"
104 [-]: LOADK     R11 K28      ; R11 := "GetAllTiles"
...
112 [-]: TEST      R30 1        ; if R30 then PC := 153
113 [-]: JMP       153          ; PC := 153
114 [-]: EQ        0 R22 K28    ; if R22 ~= nil then PC := 153
115 [-]: JMP       153          ; PC := 153
...
121 [-]: JMP       124          ; PC := 124
122 [-]: TEST      R16 0        ; if not R16 then PC := 153
123 [-]: JMP       153          ; PC := 153
124 [-]: TEST      R23 0        ; if not R23 then PC := 153
125 [-]: JMP       153          ; PC := 153
...
141 [-]: GETTABLE  R31 R30 K35  ; R31 := R30["Locked"]
142 [-]: TEST      R31 0        ; if not R31 then PC := 147
143 [-]: JMP       147          ; PC := 147
144 [-]: GETTABLE  R31 R30 K38  ; R31 := R30["LockedMsg"]
145 [-]: SETTABLE  R30 K41 R31  ; R30["Description"] := R31
146 [-]: JMP       148          ; PC := 148
147 [-]: SETTABLE  R30 K41 K42  ; R30["Description"] := "/Lotus/Language/CapturaScenes/PhotoboothTileOwnedDesc"
148 [-]: GETGLOBAL R31 K10      ; R31 := table
149 [-]: GETTABLE  R31 R31 K11  ; R31 := R31["0xE6450C9D"]
150 [-]: MOVE      R32 R0       ; R32 := R0
151 [-]: MOVE      R33 R30      ; R33 := R30
152 [-]: CALL      R31 3 1      ; R31(R32,R33)
153 [-]: FORLOOP   R10 52       ; R10 += R12; if R10 <= R11 then begin PC := 52; R13 := R10 end
154 [-]: RETURN    R0 2         ; return R0
