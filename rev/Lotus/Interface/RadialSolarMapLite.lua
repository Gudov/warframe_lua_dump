...
; Command line was: -dis C:\wlua_dump\path\Lotus\Interface\RadialSolarMapLite.lua 
...
; Max Stack Size:  5
 ...
 10 [-]: SELF      R0 R0 K1     ; R1 := R0; R0 := R0["0x5DB0BD4"]
 11 [-]: LOADK     R2 K4        ; R2 := "<CHECKMARK_OUTLINE>"
 12 [-]: MOVE      R3 R1        ; R3 := R1
 ...
 18 [-]: SELF      R0 R0 K5     ; R1 := R0; R0 := R0["0xD6A79FE9"]
 19 [-]: LOADK     R2 K6        ; R2 := "RobotoLoader"
 20 [-]: LOADK     R3 K7        ; R3 := "text"
 21 [-]: LOADK     R4 K8        ; R4 := ""
 22 [-]: CALL      R0 5 1       ; R0(R1,R2,R3,R4)
 23 [-]: GETGLOBAL R0 K0        ; R0 := mMovie
 24 [-]: SELF      R0 R0 K9     ; R1 := R0; R0 := R0["0xFD29439A"]
 25 [-]: GETGLOBAL R2 K10       ; R2 := _G
 26 [-]: GETTABLE  R2 R2 K11    ; R2 := R2["UIMaterial_Diegetic"]
 27 [-]: CALL      R0 3 1       ; R0(R1,R2)
 28 [-]: GETUPVAL  R0 U2        ; R0 := U2
 29 [-]: CALL      R0 1 1       ; R0()
 30 [-]: GETGLOBAL R0 K12       ; R0 := 0x400E7765
 31 [-]: GETGLOBAL R1 K13       ; R1 := gGameRules
