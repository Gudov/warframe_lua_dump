...
; Command line was: -dis C:\wlua_dump\path\Lotus\Weapons\Tenno\HackingDevices\TnHackingDevice\TnHackingDevice.lua 
...
; Max Stack Size:  8
 ...
 16 [-]: SELF      R4 R3 K4     ; R5 := R3; R4 := R3["0xD425D6BD"]
 ...
 25 [-]: SELF      R4 R4 K5     ; R5 := R4; R4 := R4["0xAF85565F"]
 26 [-]: MOVE      R6 R0        ; R6 := R0
 27 [-]: MOVE      R7 R1        ; R7 := R1
