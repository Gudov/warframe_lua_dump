...
; Command line was: -dis C:\wlua_dump\path\Lotus\Scripts\Effects\BulletJump.lua 
...
; Max Stack Size:  15
 ...
 17 [-]: LT        0 K2 R5      ; if 0 >= R5 then PC := 74
 18 [-]: JMP       74           ; PC := 74
 19 [-]: LT        0 R4 R3      ; if R4 >= R3 then PC := 64
 20 [-]: JMP       64           ; PC := 64
 21 [-]: GETUPVAL  R6 U1        ; R6 := U1
 22 [-]: GETGLOBAL R7 K7        ; R7 := math
 23 [-]: GETTABLE  R7 R7 K8     ; R7 := R7["0x865961F7"]
 24 [-]: LOADK     R8 K4        ; R8 := 1
 ...
 30 [-]: SELF      R8 R1 K9     ; R9 := R1; R8 := R1["0xA2B01604"]
 31 [-]: MOVE      R10 R6       ; R10 := R6
 32 [-]: CALL      R8 3 0       ; R8,... := R8(R9,R10)
 33 [-]: CALL      R7 0 2       ; R7 := R7(R8,...)
 34 [-]: GETGLOBAL R8 K10       ; R8 := ZERO_VECTOR
 35 [-]: EQ        1 R7 R8      ; if R7 == R8 then PC := 58
 36 [-]: JMP       58           ; PC := 58
 37 [-]: SELF      R8 R1 K11    ; R9 := R1; R8 := R1["0xAB436EF2"]
 38 [-]: GETGLOBAL R10 K12      ; R10 := beamType
 39 [-]: MOVE      R11 R6       ; R11 := R6
 40 [-]: GETGLOBAL R12 K10      ; R12 := ZERO_VECTOR
 ...
 48 [-]: JMP       58           ; PC := 58
 49 [-]: SELF      R9 R8 K14    ; R10 := R8; R9 := R8["0x4E2CBDCF"]
 50 [-]: MOVE      R11 R7       ; R11 := R7
 51 [-]: CALL      R9 3 1       ; R9(R10,R11)
 52 [-]: GETGLOBAL R9 K15       ; R9 := gRegion
 53 [-]: SELF      R9 R9 K16    ; R10 := R9; R9 := R9["0xBDD34CC6"]
 54 [-]: GETGLOBAL R11 K17      ; R11 := beamEndPointType
 55 [-]: MOVE      R12 R7       ; R12 := R7
 56 [-]: GETGLOBAL R13 K13      ; R13 := ZERO_ROTATION
 57 [-]: CALL      R9 5 1       ; R9(R10,R11,R12,R13)
 58 [-]: LOADK     R3 K2        ; R3 := 0
 59 [-]: GETGLOBAL R9 K18       ; R9 := 0x8C4A6742
 60 [-]: LOADK     R10 K19      ; R10 := 0.079999998211861
 61 [-]: LOADK     R11 K20      ; R11 := 0.11999999731779
 62 [-]: CALL      R9 3 2       ; R9 := R9(R10,R11)
 63 [-]: DIV       R4 R9 R2     ; R4 := R9 / R2
 64 [-]: GETGLOBAL R9 K21       ; R9 := 0x201191EA
 65 [-]: LOADK     R10 K2       ; R10 := 0
 66 [-]: CALL      R9 2 1       ; R9(R10)
 67 [-]: GETGLOBAL R9 K22       ; R9 := 0x4CDEF9FF
 68 [-]: CALL      R9 1 2       ; R9 := R9()
 69 [-]: SUB       R5 R5 R9     ; R5 := R5 - R9
 70 [-]: GETGLOBAL R9 K22       ; R9 := 0x4CDEF9FF
 71 [-]: CALL      R9 1 2       ; R9 := R9()
 72 [-]: ADD       R3 R3 R9     ; R3 := R3 + R9
 73 [-]: JMP       17           ; PC := 17
 74 [-]: RETURN    R0 1         ; return 
