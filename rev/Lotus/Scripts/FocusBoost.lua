...
; Command line was: -dis C:\wlua_dump\path\Lotus\Scripts\FocusBoost.lua 
...
; Max Stack Size:  12
  ...
  3 [-]: SELF      R4 R4 K1     ; R5 := R4; R4 := R4["0xB8613F53"]
  4 [-]: CALL      R4 2 2       ; R4 := R4(R5)
  5 [-]: TEST      R4 0         ; if not R4 then PC := 43
  6 [-]: JMP       43           ; PC := 43
 ...
 13 [-]: SELF      R4 R4 K4     ; R5 := R4; R4 := R4["0xBDD34CC6"]
 14 [-]: GETGLOBAL R6 K5        ; R6 := boostPickUpFx
 15 [-]: SELF      R7 R3 K6     ; R8 := R3; R7 := R3["0x6DA72501"]
 16 [-]: CALL      R7 2 2       ; R7 := R7(R8)
 17 [-]: GETGLOBAL R8 K7        ; R8 := ZERO_ROTATION
 18 [-]: CALL      R4 5 1       ; R4(R5,R6,R7,R8)
 19 [-]: GETGLOBAL R4 K3        ; R4 := gRegion
 20 [-]: SELF      R4 R4 K8     ; R5 := R4; R4 := R4["0xA559F558"]
 21 [-]: CALL      R4 2 2       ; R4 := R4(R5)
 22 [-]: TEST      R4 0         ; if not R4 then PC := 41
 23 [-]: JMP       41           ; PC := 41
 24 [-]: SELF      R4 R3 K9     ; R5 := R3; R4 := R3["0x9514F127"]
 25 [-]: CALL      R4 2 2       ; R4 := R4(R5)
 26 [-]: LOADK     R5 K10       ; R5 := 1
 27 [-]: LEN       R6 R4        ; R6 := # R4
 28 [-]: LOADK     R7 K10       ; R7 := 1
 29 [-]: FORPREP   R5 39        ; R5 -= R7; PC := 39
 30 [-]: GETTABLE  R9 R4 R8     ; R9 := R4[R8]
 31 [-]: GETTABLE  R9 R9 K11    ; R9 := R9["mInstance"]
 32 [-]: GETGLOBAL R10 K2       ; R10 := 0x400E7765
 33 [-]: MOVE      R11 R9       ; R11 := R9
 34 [-]: CALL      R10 2 2      ; R10 := R10(R11)
 35 [-]: TEST      R10 1        ; if R10 then PC := 39
 36 [-]: JMP       39           ; PC := 39
 37 [-]: SELF      R10 R9 K12   ; R11 := R9; R10 := R9["0xD4C2743F"]
 38 [-]: CALL      R10 2 1      ; R10(R11)
 39 [-]: FORLOOP   R5 30        ; R5 += R7; if R5 <= R6 then begin PC := 30; R8 := R5 end
 40 [-]: JMP       43           ; PC := 43
 41 [-]: SELF      R10 R3 K12   ; R11 := R3; R10 := R3["0xD4C2743F"]
