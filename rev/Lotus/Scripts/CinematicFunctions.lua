...
; Command line was: -dis C:\wlua_dump\path\Lotus\Scripts\CinematicFunctions.lua 
...
; Max Stack Size:  2
 ...
 63 [-]: SETGLOBAL R1 K40       ; ToWhite := R1
 64 [-]: SETGLOBAL R1 K41       ; 0x4501524C := R1
 65 [-]: CLOSURE   R1 20        ; R1 := closure(Function #21)
 66 [-]: SETGLOBAL R1 K42       ; SwapPostFxMaterial := R1
 67 [-]: SETGLOBAL R1 K43       ; 0xB2DF97D1 := R1
 68 [-]: CLOSURE   R1 21        ; R1 := closure(Function #22)
 69 [-]: SETGLOBAL R1 K44       ; HunhowTalkingSword := R1
 70 [-]: SETGLOBAL R1 K45       ; 0x65A535FC := R1
 71 [-]: CLOSURE   R1 22        ; R1 := closure(Function #23)
 72 [-]: SETGLOBAL R1 K46       ; OperatorCrawl := R1
 73 [-]: SETGLOBAL R1 K47       ; 0xA0F5B4D7 := R1
 74 [-]: CLOSURE   R1 23        ; R1 := closure(Function #24)
 75 [-]: SETGLOBAL R1 K48       ; DipToBlack := R1
 76 [-]: SETGLOBAL R1 K49       ; 0x855017E1 := R1
 77 [-]: CLOSURE   R1 24        ; R1 := closure(Function #25)
 78 [-]: SETGLOBAL R1 K50       ; DipToHeldBlack := R1
 79 [-]: SETGLOBAL R1 K51       ; 0xA161BC0E := R1
 80 [-]: CLOSURE   R1 25        ; R1 := closure(Function #26)
 81 [-]: SETGLOBAL R1 K52       ; RadialBoff := R1
 82 [-]: SETGLOBAL R1 K53       ; 0x2C85BD99 := R1
 83 [-]: CLOSURE   R1 26        ; R1 := closure(Function #27)
 84 [-]: SETGLOBAL R1 K54       ; CreateSplash := R1
 85 [-]: SETGLOBAL R1 K55       ; 0x92458FB6 := R1
 86 [-]: CLOSURE   R1 27        ; R1 := closure(Function #28)
 87 [-]: SETGLOBAL R1 K56       ; JunctionLights := R1
 88 [-]: SETGLOBAL R1 K57       ; 0x3A3C33FA := R1
 89 [-]: CLOSURE   R1 28        ; R1 := closure(Function #29)
 90 [-]: SETGLOBAL R1 K58       ; OperatorMemoryStart := R1
 91 [-]: SETGLOBAL R1 K59       ; 0xF5BC9EB3 := R1
 92 [-]: CLOSURE   R1 29        ; R1 := closure(Function #30)
 93 [-]: SETGLOBAL R1 K60       ; OperatorMemoryEnd := R1
 94 [-]: SETGLOBAL R1 K61       ; 0x155FA32D := R1
 95 [-]: CLOSURE   R1 30        ; R1 := closure(Function #31)
 96 [-]: SETGLOBAL R1 K62       ; ShowMemoryDecos := R1
 97 [-]: SETGLOBAL R1 K63       ; 0x980CD9CC := R1
 98 [-]: CLOSURE   R1 31        ; R1 := closure(Function #32)
 99 [-]: SETGLOBAL R1 K64       ; HideMemoryDecos := R1
100 [-]: SETGLOBAL R1 K65       ; 0x241FF8E3 := R1
101 [-]: CLOSURE   R1 32        ; R1 := closure(Function #33)
102 [-]: SETGLOBAL R1 K66       ; NeewaImages := R1
103 [-]: SETGLOBAL R1 K67       ; 0xD539AC6B := R1
104 [-]: CLOSURE   R1 33        ; R1 := closure(Function #34)
105 [-]: SETGLOBAL R1 K68       ; EidolonEmerge := R1
106 [-]: SETGLOBAL R1 K69       ; 0x9BB87CC := R1
107 [-]: CLOSURE   R1 34        ; R1 := closure(Function #35)
108 [-]: SETGLOBAL R1 K70       ; EidolonStep := R1
109 [-]: SETGLOBAL R1 K71       ; 0xE50FFED9 := R1
110 [-]: CLOSURE   R1 35        ; R1 := closure(Function #36)
111 [-]: SETGLOBAL R1 K72       ; VocalEmissiveAtten := R1
112 [-]: SETGLOBAL R1 K73       ; 0xBBC3271A := R1
