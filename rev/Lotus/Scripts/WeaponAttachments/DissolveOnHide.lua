...
; Command line was: -dis C:\wlua_dump\path\Lotus\Scripts\WeaponAttachments\DissolveOnHide.lua 
...
103 [-]: TEST      R18 1        ; if R18 then PC := 119
104 [-]: JMP       119          ; PC := 119
105 [-]: SELF      R18 R16 K29  ; R19 := R16; R18 := R16["0xD124E361"]
106 [-]: GETUPVAL  R20 U2       ; R20 := U2
107 [-]: MOVE      R21 R14      ; R21 := R14
108 [-]: CALL      R18 4 1      ; R18(R19,R20,R21)
109 [-]: SELF      R18 R16 K29  ; R19 := R16; R18 := R16["0xD124E361"]
110 [-]: GETUPVAL  R20 U3       ; R20 := U3
111 [-]: MOVE      R21 R14      ; R21 := R14
112 [-]: CALL      R18 4 1      ; R18(R19,R20,R21)
113 [-]: SELF      R18 R16 K29  ; R19 := R16; R18 := R16["0xD124E361"]
114 [-]: GETUPVAL  R20 U4       ; R20 := U4
115 [-]: GETTABLE  R21 R15 K30  ; R21 := R15["x"]
116 [-]: GETTABLE  R22 R15 K31  ; R22 := R15["y"]
117 [-]: GETTABLE  R23 R15 K32  ; R23 := R15["z"]
118 [-]: CALL      R18 6 1      ; R18(R19,R20,R21,R22,R23)
119 [-]: GETGLOBAL R18 K33      ; R18 := dissolveInTime
120 [-]: MUL       R18 R18 R11  ; R18 := R18 * R11
121 [-]: TEST      R13 0        ; if not R13 then PC := 127
122 [-]: JMP       127          ; PC := 127
123 [-]: GETGLOBAL R19 K34      ; R19 := overrideInstantToOff
124 [-]: TEST      R19 1        ; if R19 then PC := 127
125 [-]: JMP       127          ; PC := 127
126 [-]: LOADK     R18 K5       ; R18 := 0
127 [-]: GETGLOBAL R19 K35      ; R19 := 0x221C9700
128 [-]: CALL      R19 1 2      ; R19 := R19()
129 [-]: LT        0 K5 R18     ; if 0 >= R18 then PC := 195
130 [-]: JMP       195          ; PC := 195
131 [-]: GETGLOBAL R20 K17      ; R20 := 0x400E7765
132 [-]: MOVE      R21 R0       ; R21 := R0
133 [-]: CALL      R20 2 2      ; R20 := R20(R21)
134 [-]: TEST      R20 1        ; if R20 then PC := 195
135 [-]: JMP       195          ; PC := 195
136 [-]: GETGLOBAL R20 K33      ; R20 := dissolveInTime
137 [-]: DIV       R20 R18 R20  ; R20 := R18 / R20
138 [-]: SUB       R20 K2 R20   ; R20 := 1 - R20
139 [-]: MUL       R20 K3 R20   ; R20 := 0.5 * R20
140 [-]: SELF      R21 R0 K29   ; R22 := R0; R21 := R0["0xD124E361"]
141 [-]: GETUPVAL  R23 U0       ; R23 := U0
142 [-]: SUB       R24 K2 R20   ; R24 := 1 - R20
143 [-]: CALL      R21 4 1      ; R21(R22,R23,R24)
144 [-]: LOADK     R21 K2       ; R21 := 1
145 [-]: LEN       R22 R5       ; R22 := # R5
146 [-]: LOADK     R23 K2       ; R23 := 1
147 [-]: FORPREP   R21 158      ; R21 -= R23; PC := 158
148 [-]: GETGLOBAL R25 K17      ; R25 := 0x400E7765
149 [-]: GETTABLE  R26 R5 R24   ; R26 := R5[R24]
150 [-]: CALL      R25 2 2      ; R25 := R25(R26)
151 [-]: TEST      R25 1        ; if R25 then PC := 158
152 [-]: JMP       158          ; PC := 158
153 [-]: GETTABLE  R25 R5 R24   ; R25 := R5[R24]
154 [-]: SELF      R25 R25 K13  ; R26 := R25; R25 := R25["0xD610586B"]
155 [-]: GETGLOBAL R27 K33      ; R27 := dissolveInTime
156 [-]: DIV       R27 R18 R27  ; R27 := R18 / R27
157 [-]: CALL      R25 3 1      ; R25(R26,R27)
158 [-]: FORLOOP   R21 148      ; R21 += R23; if R21 <= R22 then begin PC := 148; R24 := R21 end
159 [-]: GETGLOBAL R25 K17      ; R25 := 0x400E7765
160 [-]: MOVE      R26 R16      ; R26 := R16
161 [-]: CALL      R25 2 2      ; R25 := R25(R26)
162 [-]: TEST      R25 1        ; if R25 then PC := 168
163 [-]: JMP       168          ; PC := 168
164 [-]: SELF      R25 R16 K29  ; R26 := R16; R25 := R16["0xD124E361"]
165 [-]: GETUPVAL  R27 U0       ; R27 := U0
166 [-]: SUB       R28 K2 R20   ; R28 := 1 - R20
167 [-]: CALL      R25 4 1      ; R25(R26,R27,R28)
168 [-]: GETGLOBAL R25 K17      ; R25 := 0x400E7765
169 [-]: MOVE      R26 R17      ; R26 := R17
170 [-]: CALL      R25 2 2      ; R25 := R25(R26)
171 [-]: TEST      R25 1        ; if R25 then PC := 188
172 [-]: JMP       188          ; PC := 188
173 [-]: MUL       R25 R14 R20  ; R25 := R14 * R20
174 [-]: MUL       R20 R25 K36  ; R20 := R25 * 2.4000000953674
175 [-]: GETTABLE  R25 R15 K30  ; R25 := R15["x"]
176 [-]: MUL       R25 R20 R25  ; R25 := R20 * R25
177 [-]: SETTABLE  R19 K30 R25  ; R19["x"] := R25
178 [-]: GETTABLE  R25 R15 K31  ; R25 := R15["y"]
179 [-]: MUL       R25 R20 R25  ; R25 := R20 * R25
180 [-]: SETTABLE  R19 K31 R25  ; R19["y"] := R25
181 [-]: GETTABLE  R25 R15 K32  ; R25 := R15["z"]
182 [-]: MUL       R25 R20 R25  ; R25 := R20 * R25
183 [-]: SETTABLE  R19 K32 R25  ; R19["z"] := R25
184 [-]: SELF      R25 R17 K37  ; R26 := R17; R25 := R17["0xA78B7FA7"]
185 [-]: MOVE      R27 R19      ; R27 := R19
186 [-]: GETGLOBAL R28 K27      ; R28 := ZERO_ROTATION
187 [-]: CALL      R25 4 1      ; R25(R26,R27,R28)
188 [-]: GETGLOBAL R25 K38      ; R25 := 0x201191EA
189 [-]: LOADK     R26 K5       ; R26 := 0
190 [-]: CALL      R25 2 1      ; R25(R26)
191 [-]: GETGLOBAL R25 K39      ; R25 := 0x4CDEF9FF
192 [-]: CALL      R25 1 2      ; R25 := R25()
193 [-]: SUB       R18 R18 R25  ; R18 := R18 - R25
194 [-]: JMP       129          ; PC := 129
195 [-]: GETGLOBAL R25 K17      ; R25 := 0x400E7765
196 [-]: MOVE      R26 R0       ; R26 := R0
197 [-]: CALL      R25 2 2      ; R25 := R25(R26)
198 [-]: TEST      R25 1        ; if R25 then PC := 207
199 [-]: JMP       207          ; PC := 207
200 [-]: SELF      R25 R0 K29   ; R26 := R0; R25 := R0["0xD124E361"]
201 [-]: GETUPVAL  R27 U0       ; R27 := U0
202 [-]: LOADK     R28 K3       ; R28 := 0.5
203 [-]: CALL      R25 4 1      ; R25(R26,R27,R28)
204 [-]: SELF      R25 R0 K13   ; R26 := R0; R25 := R0["0xD610586B"]
205 [-]: LOADK     R27 K5       ; R27 := 0
