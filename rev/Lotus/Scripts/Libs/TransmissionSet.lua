...
; Command line was: -dis C:\wlua_dump\path\Lotus\Scripts\Libs\TransmissionSet.lua 
...
; Max Stack Size:  3
 ...
 48 [-]: MOVE      R0 R0        ; R0 := R0
 49 [-]: SETGLOBAL R2 K19       ; PlayGlobalOperatorTransmission := R2
 50 [-]: SETGLOBAL R2 K20       ; 0xB1028EE6 := R2
 51 [-]: CLOSURE   R2 11        ; R2 := closure(Function #12)
 52 [-]: MOVE      R0 R0        ; R0 := R0
 53 [-]: SETGLOBAL R2 K21       ; PlayGlobalOperatorConvoTransmissions := R2
 54 [-]: SETGLOBAL R2 K22       ; 0x6D6E217C := R2
 55 [-]: CLOSURE   R2 12        ; R2 := closure(Function #13)
 56 [-]: SETGLOBAL R2 K23       ; WaitForTransmissionsToComplete := R2
 57 [-]: SETGLOBAL R2 K24       ; 0xE12A8682 := R2
...
; Max Stack Size:  18
  ...
  7 [-]: JMP       53           ; PC := 53
  8 [-]: SELF      R7 R6 K3     ; R8 := R6; R7 := R6["0x30BDE7F"]
  9 [-]: CALL      R7 2 2       ; R7 := R7(R8)
 10 [-]: GETGLOBAL R8 K4        ; R8 := 0x400E7765
 11 [-]: MOVE      R9 R7        ; R9 := R7
 12 [-]: CALL      R8 2 2       ; R8 := R8(R9)
 13 [-]: TEST      R8 1         ; if R8 then PC := 53
 14 [-]: JMP       53           ; PC := 53
 15 [-]: GETTABLE  R8 R7 K5     ; R8 := R7["mOperatorCustomization"]
 16 [-]: SELF      R9 R8 K6     ; R10 := R8; R9 := R8["0x907521D4"]
 17 [-]: GETGLOBAL R11 K7       ; R11 := Lotus_Game
 18 [-]: GETTABLE  R11 R11 K8   ; R11 := R11["TOSS_VOICE"]
 19 [-]: CALL      R9 3 2       ; R9 := R9(R10,R11)
 20 [-]: GETGLOBAL R10 K4       ; R10 := 0x400E7765
 21 [-]: GETTABLE  R11 R9 K9    ; R11 := R9["mItemType"]
 22 [-]: CALL      R10 2 2      ; R10 := R10(R11)
 23 [-]: TEST      R10 1        ; if R10 then PC := 43
 24 [-]: JMP       43           ; PC := 43
 25 [-]: GETGLOBAL R10 K10      ; R10 := 0x7C282057
 26 [-]: GETTABLE  R11 R9 K9    ; R11 := R9["mItemType"]
 27 [-]: CALL      R10 2 2      ; R10 := R10(R11)
 28 [-]: GETGLOBAL R11 K4       ; R11 := 0x400E7765
 29 [-]: MOVE      R12 R10      ; R12 := R10
 30 [-]: CALL      R11 2 2      ; R11 := R11(R12)
 31 [-]: TEST      R11 1        ; if R11 then PC := 53
 32 [-]: JMP       53           ; PC := 53
 33 [-]: SELF      R11 R10 K11  ; R12 := R10; R11 := R10["0xA17B8750"]
 34 [-]: CALL      R11 2 2      ; R11 := R11(R12)
 35 [-]: GETUPVAL  R12 U0       ; R12 := U0
 36 [-]: MOVE      R13 R11      ; R13 := R11
 37 [-]: MOVE      R14 R0       ; R14 := R0
 38 [-]: SELF      R15 R6 K12   ; R16 := R6; R15 := R6["0x93E76705"]
 39 [-]: CALL      R15 2 2      ; R15 := R15(R16)
 40 [-]: MOVE      R16 R0       ; R16 := R0
 41 [-]: CALL      R12 5 1      ; R12(R13,R14,R15,R16)
 42 [-]: JMP       53           ; PC := 53
 43 [-]: GETGLOBAL R12 K10      ; R12 := 0x7C282057
 44 [-]: LOADK     R13 K13      ; R13 := "/Lotus/Upgrades/Skins/Voices/OperatorVoiceCTransmissionSet"
 45 [-]: CALL      R12 2 2      ; R12 := R12(R13)
 46 [-]: GETUPVAL  R13 U0       ; R13 := U0
 47 [-]: MOVE      R14 R12      ; R14 := R12
 48 [-]: MOVE      R15 R0       ; R15 := R0
 49 [-]: SELF      R16 R6 K12   ; R17 := R6; R16 := R6["0x93E76705"]
...
; Max Stack Size:  28
 ...
 10 [-]: LOADK     R10 K4       ; R10 := "/Lotus/Upgrades/Skins/Voices/OperatorVoiceATransmissionSet"
...
; Max Stack Size:  9
 ...
 11 [-]: SELF      R3 R3 K5     ; R4 := R3; R3 := R3["0xD015CBDC"]
 12 [-]: MOVE      R5 R2        ; R5 := R2
 13 [-]: MOVE      R6 R0        ; R6 := R0
 ...
 17 [-]: JMP       39           ; PC := 39
 18 [-]: LOADK     R4 K7        ; R4 := 10
 19 [-]: GETGLOBAL R5 K2        ; R5 := 0x400E7765
 20 [-]: GETGLOBAL R6 K8        ; R6 := _T
 21 [-]: GETTABLE  R6 R6 K9     ; R6 := R6["curTransmission"]
 22 [-]: CALL      R5 2 2       ; R5 := R5(R6)
 23 [-]: TEST      R5 0         ; if not R5 then PC := 39
 24 [-]: JMP       39           ; PC := 39
 25 [-]: GETGLOBAL R5 K10       ; R5 := 0x4CDEF9FF
 26 [-]: CALL      R5 1 2       ; R5 := R5()
 27 [-]: SUB       R4 R4 R5     ; R4 := R4 - R5
 28 [-]: LE        0 R4 K6      ; if R4 > 0 then PC := 34
 29 [-]: JMP       34           ; PC := 34
 30 [-]: GETGLOBAL R6 K11       ; R6 := 0x93B1256B
 31 [-]: LOADK     R7 K12       ; R7 := "WaitForTransmissions timed out"
 ...
 41 [-]: GETTABLE  R7 R7 K9     ; R7 := R7["curTransmission"]
 ...
 48 [-]: JMP       39           ; PC := 39
 49 [-]: GETGLOBAL R6 K4        ; R6 := gGameRules
 50 [-]: SELF      R6 R6 K14    ; R7 := R6; R6 := R6["0xAB29CC03"]
 51 [-]: MOVE      R8 R2        ; R8 := R2
