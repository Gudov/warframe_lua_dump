...
; Command line was: -dis C:\wlua_dump\path\Lotus\Scripts\Quests\ChimeraPlayerShip.lua 
...
; Max Stack Size:  4
  ...
  7 [-]: LOADK     R3 K5        ; R3 := "LotusHelmetMarker"
 ...
 14 [-]: JMP       17           ; PC := 17
 15 [-]: SELF      R1 R0 K7     ; R2 := R0; R1 := R0["0xC5E91BA6"]
