...
; Command line was: -dis C:\wlua_dump\path\Lotus\Powersuits\PowersuitAbilities\Shield.lua 
...
116 [-]: SELF      R18 R17 K39  ; R19 := R17; R18 := R17["0x9F1DC568"]
117 [-]: GETGLOBAL R20 K40      ; R20 := gElementType
118 [-]: CALL      R18 3 2      ; R18 := R18(R19,R20)
119 [-]: GETGLOBAL R19 K41      ; R19 := 0x400E7765
120 [-]: MOVE      R20 R18      ; R20 := R18
121 [-]: CALL      R19 2 2      ; R19 := R19(R20)
122 [-]: TEST      R19 1        ; if R19 then PC := 143
123 [-]: JMP       143          ; PC := 143
124 [-]: SELF      R19 R18 K42  ; R20 := R18; R19 := R18["0x85DAD235"]
125 [-]: MOVE      R21 R0       ; R21 := R0
126 [-]: CALL      R19 3 1      ; R19(R20,R21)
127 [-]: SELF      R19 R18 K43  ; R20 := R18; R19 := R18["0xE321B4BD"]
128 [-]: MOVE      R21 R1       ; R21 := R1
129 [-]: CALL      R19 3 1      ; R19(R20,R21)
130 [-]: GETGLOBAL R19 K44      ; R19 := _T
131 [-]: GETTABLE  R19 R19 K45  ; R19 := R19["VoltShieldElements"]
132 [-]: EQ        0 R19 K46    ; if R19 ~= nil then PC := 137
133 [-]: JMP       137          ; PC := 137
134 [-]: GETGLOBAL R19 K44      ; R19 := _T
135 [-]: NEWTABLE  R20 0 0      ; R20 := {}
136 [-]: SETTABLE  R19 K45 R20  ; R19["VoltShieldElements"] := R20
137 [-]: GETGLOBAL R19 K47      ; R19 := table
138 [-]: GETTABLE  R19 R19 K48  ; R19 := R19["0xE6450C9D"]
139 [-]: GETGLOBAL R20 K44      ; R20 := _T
140 [-]: GETTABLE  R20 R20 K45  ; R20 := R20["VoltShieldElements"]
141 [-]: MOVE      R21 R18      ; R21 := R18
142 [-]: CALL      R19 3 1      ; R19(R20,R21)
143 [-]: GETGLOBAL R19 K6       ; R19 := Lotus_Game
144 [-]: GETTABLE  R19 R19 K9   ; R19 := R19["PowerSuit_AUGMENT_PVP_ONE"]
145 [-]: EQ        0 R9 R19     ; if R9 ~= R19 then PC := 193
146 [-]: JMP       193          ; PC := 193
147 [-]: SELF      R19 R1 K49   ; R20 := R1; R19 := R1["0x6B4CBCD7"]
148 [-]: GETGLOBAL R21 K37      ; R21 := gRegion
149 [-]: SELF      R21 R21 K50  ; R22 := R21; R21 := R21["0x3E2F6BF"]
150 [-]: CALL      R21 2 0      ; R21,... := R21(R22)
151 [-]: CALL      R19 0 2      ; R19 := R19(R20,...)
152 [-]: TEST      R19 0        ; if not R19 then PC := 193
153 [-]: JMP       193          ; PC := 193
154 [-]: GETGLOBAL R19 K37      ; R19 := gRegion
155 [-]: SELF      R19 R19 K38  ; R20 := R19; R19 := R19["0xBDD34CC6"]
156 [-]: GETGLOBAL R21 K51      ; R21 := augmentPvpTriggerType
157 [-]: ADD       R22 R11 R15  ; R22 := R11 + R15
158 [-]: ADD       R22 R22 R14  ; R22 := R22 + R14
159 [-]: MOVE      R23 R12      ; R23 := R12
160 [-]: MOVE      R24 R1       ; R24 := R1
161 [-]: MOVE      R25 R17      ; R25 := R17
162 [-]: CALL      R19 7 2      ; R19 := R19(R20,R21,R22,R23,R24,R25)
163 [-]: GETGLOBAL R20 K41      ; R20 := 0x400E7765
164 [-]: MOVE      R21 R19      ; R21 := R19
165 [-]: CALL      R20 2 2      ; R20 := R20(R21)
166 [-]: TEST      R20 1        ; if R20 then PC := 193
167 [-]: JMP       193          ; PC := 193
168 [-]: SELF      R20 R17 K52  ; R21 := R17; R20 := R17["0xD124E361"]
169 [-]: GETGLOBAL R22 K23      ; R22 := 0xEC274B1A
170 [-]: LOADK     R23 K53      ; R23 := "Scalar2"
171 [-]: CALL      R22 2 2      ; R22 := R22(R23)
172 [-]: LOADK     R23 K54      ; R23 := 0.60000002384186
173 [-]: CALL      R20 4 1      ; R20(R21,R22,R23)
174 [-]: SELF      R20 R17 K39  ; R21 := R17; R20 := R17["0x9F1DC568"]
175 [-]: GETGLOBAL R22 K55      ; R22 := gLotusHitProxyShieldType
176 [-]: CALL      R20 3 2      ; R20 := R20(R21,R22)
177 [-]: SELF      R21 R19 K56  ; R22 := R19; R21 := R19["0xC41536D7"]
178 [-]: MOVE      R23 R17      ; R23 := R17
179 [-]: GETGLOBAL R24 K57      ; R24 := EMPTY_SYMBOL
180 [-]: CALL      R21 4 1      ; R21(R22,R23,R24)
181 [-]: SELF      R21 R19 K58  ; R22 := R19; R21 := R19["0x29B47C50"]
182 [-]: GETUPVAL  R23 U4       ; R23 := U4
183 [-]: CALL      R21 3 1      ; R21(R22,R23)
184 [-]: GETGLOBAL R21 K41      ; R21 := 0x400E7765
185 [-]: MOVE      R22 R20      ; R22 := R20
186 [-]: CALL      R21 2 2      ; R21 := R21(R22)
187 [-]: TEST      R21 1        ; if R21 then PC := 193
188 [-]: JMP       193          ; PC := 193
189 [-]: SELF      R21 R19 K59  ; R22 := R19; R21 := R19["0xAFFF6D6"]
190 [-]: SELF      R23 R20 K60  ; R24 := R20; R23 := R20["0x11FF52EA"]
191 [-]: CALL      R23 2 0      ; R23,... := R23(R24)
192 [-]: CALL      R21 0 1      ; R21(R22,...)
...
737 [-]: GETTABLE  R54 R54 K62  ; R54 := R54["0x18B9D30B"]
738 [-]: MOVE      R55 R16      ; R55 := R16
739 [-]: MOVE      R56 R1       ; R56 := R1
740 [-]: LOADK     R57 K1       ; R57 := 0
741 [-]: MOVE      R58 R35      ; R58 := R35
742 [-]: CALL      R54 5 1      ; R54(R55,R56,R57,R58)
743 [-]: GETGLOBAL R54 K3       ; R54 := 0x400E7765
744 [-]: MOVE      R55 R0       ; R55 := R0
745 [-]: CALL      R54 2 2      ; R54 := R54(R55)
746 [-]: TEST      R54 1        ; if R54 then PC := 750
747 [-]: JMP       750          ; PC := 750
748 [-]: SELF      R54 R0 K106  ; R55 := R0; R54 := R0["0x5AB2AAEF"]
749 [-]: CALL      R54 2 1      ; R54(R55)
