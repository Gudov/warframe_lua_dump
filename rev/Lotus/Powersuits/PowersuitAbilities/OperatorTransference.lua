...
; Command line was: -dis C:\wlua_dump\path\Lotus\Powersuits\PowersuitAbilities\OperatorTransference.lua 
...
117 [-]: SELF      R12 R1 K28   ; R13 := R1; R12 := R1["0x545CF343"]
118 [-]: CALL      R12 2 2      ; R12 := R12(R13)
119 [-]: SELF      R13 R9 K26   ; R14 := R9; R13 := R9["0xA3F6069B"]
120 [-]: CALL      R13 2 2      ; R13 := R13(R14)
121 [-]: SELF      R13 R13 K29  ; R14 := R13; R13 := R13["0xA95C2173"]
122 [-]: MOVE      R15 R11      ; R15 := R11
123 [-]: CALL      R13 3 1      ; R13(R14,R15)
124 [-]: SELF      R13 R9 K30   ; R14 := R9; R13 := R9["0xA06DA4CD"]
125 [-]: MOVE      R15 R12      ; R15 := R12
126 [-]: CALL      R13 3 1      ; R13(R14,R15)
127 [-]: TEST      R2 0         ; if not R2 then PC := 136
128 [-]: JMP       136          ; PC := 136
129 [-]: GETGLOBAL R13 K4       ; R13 := gRegion
130 [-]: SELF      R13 R13 K31  ; R14 := R13; R13 := R13["0x9B0A3887"]
131 [-]: MOVE      R15 R1       ; R15 := R1
132 [-]: CALL      R13 3 1      ; R13(R14,R15)
133 [-]: SELF      R13 R0 K32   ; R14 := R0; R13 := R0["0x2050825B"]
134 [-]: MOVE      R15 R9       ; R15 := R9
135 [-]: CALL      R13 3 1      ; R13(R14,R15)
136 [-]: SELF      R13 R9 K33   ; R14 := R9; R13 := R9["0x9487625"]
137 [-]: LOADK     R15 K3       ; R15 := 0
138 [-]: CALL      R13 3 1      ; R13(R14,R15)
139 [-]: GETGLOBAL R13 K18      ; R13 := _T
140 [-]: GETTABLE  R13 R13 K34  ; R13 := R13["HideTransferenceFx"]
141 [-]: TEST      R13 1        ; if R13 then PC := 160
142 [-]: JMP       160          ; PC := 160
143 [-]: GETGLOBAL R13 K6       ; R13 := 0x400E7765
144 [-]: GETGLOBAL R14 K18      ; R14 := _T
145 [-]: GETTABLE  R14 R14 K35  ; R14 := R14["InstantRevive"]
146 [-]: CALL      R13 2 2      ; R13 := R13(R14)
147 [-]: TEST      R13 1        ; if R13 then PC := 153
148 [-]: JMP       153          ; PC := 153
149 [-]: GETGLOBAL R13 K18      ; R13 := _T
150 [-]: GETTABLE  R13 R13 K35  ; R13 := R13["InstantRevive"]
151 [-]: TEST      R13 1        ; if R13 then PC := 160
152 [-]: JMP       160          ; PC := 160
153 [-]: SELF      R13 R9 K36   ; R14 := R9; R13 := R9["0x25992394"]
...
721 [-]: TEST      R5 1         ; if R5 then PC := 726
722 [-]: JMP       726          ; PC := 726
723 [-]: SELF      R24 R2 K39   ; R25 := R2; R24 := R2["0x2ADE4CFD"]
724 [-]: MOVE      R26 R0       ; R26 := R0
725 [-]: CALL      R24 3 1      ; R24(R25,R26)
726 [-]: GETGLOBAL R24 K8       ; R24 := 0x400E7765
727 [-]: MOVE      R25 R1       ; R25 := R1
728 [-]: CALL      R24 2 2      ; R24 := R24(R25)
729 [-]: TEST      R24 0        ; if not R24 then PC := 732
730 [-]: JMP       732          ; PC := 732
731 [-]: RETURN    R0 1         ; return 
732 [-]: GETGLOBAL R24 K0       ; R24 := gRegion
733 [-]: SELF      R24 R24 K1   ; R25 := R24; R24 := R24["0xA559F558"]
734 [-]: CALL      R24 2 2      ; R24 := R24(R25)
735 [-]: TEST      R24 0        ; if not R24 then PC := 756
736 [-]: JMP       756          ; PC := 756
737 [-]: TEST      R5 0         ; if not R5 then PC := 748
738 [-]: JMP       748          ; PC := 748
739 [-]: GETGLOBAL R24 K8       ; R24 := 0x400E7765
740 [-]: MOVE      R25 R1       ; R25 := R1
741 [-]: CALL      R24 2 2      ; R24 := R24(R25)
742 [-]: TEST      R24 1        ; if R24 then PC := 756
743 [-]: JMP       756          ; PC := 756
744 [-]: SELF      R24 R1 K109  ; R25 := R1; R24 := R1["0x321C7FB1"]
745 [-]: MOVE      R26 R1       ; R26 := R1
746 [-]: CALL      R24 3 1      ; R24(R25,R26)
747 [-]: JMP       756          ; PC := 756
748 [-]: GETGLOBAL R24 K8       ; R24 := 0x400E7765
749 [-]: MOVE      R25 R2       ; R25 := R2
750 [-]: CALL      R24 2 2      ; R24 := R24(R25)
751 [-]: TEST      R24 1        ; if R24 then PC := 756
752 [-]: JMP       756          ; PC := 756
753 [-]: SELF      R24 R2 K109  ; R25 := R2; R24 := R2["0x321C7FB1"]
754 [-]: MOVE      R26 R0       ; R26 := R0
755 [-]: CALL      R24 3 1      ; R24(R25,R26)
756 [-]: SELF      R24 R1 K86   ; R25 := R1; R24 := R1["0xD536546E"]
757 [-]: CALL      R24 2 2      ; R24 := R24(R25)
758 [-]: TEST      R24 0        ; if not R24 then PC := 770
759 [-]: JMP       770          ; PC := 770
760 [-]: TEST      R5 0         ; if not R5 then PC := 770
761 [-]: JMP       770          ; PC := 770
762 [-]: SELF      R24 R1 K28   ; R25 := R1; R24 := R1["0x6DA72501"]
763 [-]: CALL      R24 2 2      ; R24 := R24(R25)
764 [-]: GETTABLE  R25 R24 K110 ; R25 := R24["y"]
765 [-]: ADD       R25 R25 K63  ; R25 := R25 + 1.5
766 [-]: SETTABLE  R24 K110 R25 ; R24["y"] := R25
767 [-]: SELF      R25 R1 K111  ; R26 := R1; R25 := R1["0x39D7F449"]
768 [-]: MOVE      R27 R24      ; R27 := R24
769 [-]: CALL      R25 3 1      ; R25(R26,R27)
770 [-]: GETGLOBAL R25 K8       ; R25 := 0x400E7765
771 [-]: MOVE      R26 R6       ; R26 := R6
772 [-]: CALL      R25 2 2      ; R25 := R25(R26)
773 [-]: TEST      R25 1        ; if R25 then PC := 788
774 [-]: JMP       788          ; PC := 788
775 [-]: SELF      R25 R6 K112  ; R26 := R6; R25 := R6["0x80B14403"]
776 [-]: CALL      R25 2 2      ; R25 := R25(R26)
777 [-]: GETGLOBAL R26 K8       ; R26 := 0x400E7765
778 [-]: MOVE      R27 R25      ; R27 := R25
779 [-]: CALL      R26 2 2      ; R26 := R26(R27)
780 [-]: TEST      R26 1        ; if R26 then PC := 788
781 [-]: JMP       788          ; PC := 788
782 [-]: EQ        1 R25 R1     ; if R25 == R1 then PC := 788
783 [-]: JMP       788          ; PC := 788
784 [-]: GETUPVAL  R26 U13      ; R26 := U13
785 [-]: GETTABLE  R26 R26 K113 ; R26 := R26["0xA14B7721"]
786 [-]: MOVE      R27 R25      ; R27 := R25
787 [-]: CALL      R26 2 1      ; R26(R27)
