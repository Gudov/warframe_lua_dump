...
; Command line was: -dis C:\wlua_dump\path\Lotus\Powersuits\Operator\OperatorLib.lua 
...
; Max Stack Size:  6
 ...
 22 [-]: SELF      R3 R0 K2     ; R4 := R0; R3 := R0["0xBC9B028A"]
 23 [-]: CALL      R3 2 2       ; R3 := R3(R4)
 24 [-]: TEST      R3 1         ; if R3 then PC := 38
 25 [-]: JMP       38           ; PC := 38
 26 [-]: SELF      R3 R2 K3     ; R4 := R2; R3 := R2["0x8F7453D9"]
 ...
 37 [-]: JMP       41           ; PC := 41
 38 [-]: GETGLOBAL R4 K5        ; R4 := 0x93B1256B
 39 [-]: LOADK     R5 K6        ; R5 := "Error: Transference instigated by operator should be evaluated via OperatorTransference, not OperatorLib"
